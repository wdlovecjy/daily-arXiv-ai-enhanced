...
### [5] [ActionEngine: From Reactive to Programmatic GUI Agents via State Machine Memory](https://arxiv.org/abs/2602.20502)
...
### [6] [CausalReasoningBenchmark: A Real-World Benchmark for Disentangled Evaluation of Causal Identification and Estimation](https://arxiv.org/abs/2602.20571)
...
### [7] [When can we trust untrusted monitoring? A safety case sketch across collusion strategies](https://arxiv.org/abs/2602.20628)
...
### [8] [Identifying two piecewise linear additive value functions from anonymous preference information](https://arxiv.org/abs/2602.20638)
...
### [9] [Grounding LLMs in Scientific Discovery via Embodied Actions](https://arxiv.org/abs/2602.20639)
...
### [10] [Recursive Belief Vision Language Model](https://arxiv.org/abs/2602.20659)
...
### [12] [Online Algorithms with Unreliable Guidance](https://arxiv.org/abs/2602.20706)
...
### [13] [CHESS: Context-aware Hierarchical Efficient Semantic Selection for Long-Context LLM Inference](https://arxiv.org/abs/2602.20732)
...
### [15] [POMDPPlanners: Open-Source Package for POMDP Planning](https://arxiv.org/abs/2602.20810)
...
### [16] [Pressure Reveals Character: Behavioural Alignment Evaluation at Depth](https://arxiv.org/abs/2602.20813)
...
### [17] [Diagnosing Causal Reasoning in Vision-Language Models via Structured Relevance Graphs](https://arxiv.org/abs/2602.20878)
...
### [18] [Architecting AgentOS: From Token-Level Context to Emergent System-Level Intelligence](https://arxiv.org/abs/2602.20934)
...
### [19] [Motivation is Something You Need](https://arxiv.org/abs/2602.21064)
...
### [20] [A Benchmark for Deep Information Synthesis](https://arxiv.org/abs/2602.21143)
...
### [22] [Gap-Dependent Bounds for Nearly Minimax Optimal Reinforcement Learning with Linear Function Approximation](https://arxiv.org/abs/2602.20297)
...
### [23] [Amortized Bayesian inference for actigraph time sheet data from mobile devices](https://arxiv.org/abs/2602.20611)
...
### [24] [DANCE: Doubly Adaptive Neighborhood Conformal Estimation](https://arxiv.org/abs/2602.20652)
...
### [25] [An Enhanced Projection Pursuit Tree Classifier with Visual Methods for Assessing Algorithmic Improvements](https://arxiv.org/abs/2602.21130)
...
### [26] [Not Just How Much, But Where: Decomposing Epistemic Uncertainty into Per-Class Contributions](https://arxiv.org/abs/2602.21160)
...
### [27] [On the non-uniformity of the 2026 FIFA World Cup draw](https://arxiv.org/abs/2602.21029)
...
### [28] [Sparse Bayesian Deep Functional Learning with Structured Region Selection](https://arxiv.org/abs/2602.20651)
...
### [31] [Oracle-Robust Online Alignment for Large Language Models](https://arxiv.org/abs/2602.20457)
...
### [33] [Upper-Linearizability of Online Non-Monotone DR-Submodular Maximization over Down-Closed Convex Sets](https://arxiv.org/abs/2602.20578)
...
### [34] [Statistical Query Lower Bounds for Smoothed Agnostic Learning](https://arxiv.org/abs/2602.21191)
...
### [36] [Emergent Manifold Separability during Reasoning in Large Language Models](https://arxiv.org/abs/2602.20338)
...
### [37] [Scaling Vision Transformers: Evaluating DeepSpeed for Image-Centric Workloads](https://arxiv.org/abs/2602.21081)
...
### [38] [$κ$-Explorer: A Unified Framework for Active Model Estimation in MDPs](https://arxiv.org/abs/2602.20404)
...
### [39] [CITED: A Decision Boundary-Aware Signature for GNNs Towards Model Extraction Defense](https://arxiv.org/abs/2602.20418)
...
### [40] [CREDIT: Certified Ownership Verification of Deep Neural Networks Against Model Extraction Attacks](https://arxiv.org/abs/2602.20419)
...
### [41] [GauS: Differentiable Scheduling Optimization via Gaussian Reparameterization](https://arxiv.org/abs/2602.20427)
...
### [42] [Nonparametric Teaching of Attention Learners](https://arxiv.org/abs/2602.20461)
...
### [44] [Sample-efficient evidence estimation of score based priors for model selection](https://arxiv.org/abs/2602.20549)
...
### [45] [GATES: Self-Distillation under Privileged Context with Consensus Gating](https://arxiv.org/abs/2602.20574)
...
### [46] [WeirNet: A Large-Scale 3D CFD Benchmark for Geometric Surrogate Modeling of Piano Key Weirs](https://arxiv.org/abs/2602.20714)
...
### [47] [Fuz-RL: A Fuzzy-Guided Robust Framework for Safe Reinforcement Learning under Uncertainty](https://arxiv.org/abs/2602.20729)
...
### [48] [Rethink Efficiency Side of Neural Combinatorial Solver: An Offline and Self-Play Paradigm](https://arxiv.org/abs/2602.20730)
...
### [49] [On Electric Vehicle Energy Demand Forecasting and the Effect of Federated Learning](https://arxiv.org/abs/2602.20782)
...
### [50] [Regret-Guided Search Control for Efficient Learning in AlphaZero](https://arxiv.org/abs/2602.20809)
...
### [51] [Transcoder Adapters for Reasoning-Model Diffing](https://arxiv.org/abs/2602.20904)
...
### [52] [From Isolation to Integration: Building an Adaptive Expert Forest for Pre-Trained Model-based Class-Incremental Learning](https://arxiv.org/abs/2602.20911)
...
### [53] [Localized Dynamics-Aware Domain Adaption for Off-Dynamics Offline Reinforcement Learning](https://arxiv.org/abs/2602.21072)
...
### [54] [Extending $μ$P: Spectral Conditions for Feature Learning Across Optimizers](https://arxiv.org/abs/2602.20937)
...
### [55] [Estimation of Confidence Bounds in Binary Classification using Wilson Score Kernel Density Estimation](https://arxiv.org/abs/2602.20947)
...
### [56] [Test-Time Training with KV Binding Is Secretly Linear Attention](https://arxiv.org/abs/2602.21204)
...
### [57] [MAST: A Multi-fidelity Augmented Surrogate model via Spatial Trust-weighting](https://arxiv.org/abs/2602.20974)
...
### [58] [PIME: Prototype-based Interpretable MCTS-Enhanced Brain Network Analysis for Disorder Diagnosis](https://arxiv.org/abs/2602.21046)
...
### [61] [Untied Ulysses: Memory-Efficient Context Parallelism via Headwise Chunking](https://arxiv.org/abs/2602.21196)
...
### [62] [The Sim-to-Real Gap in MRS Quantification: A Systematic Deep Learning Validation for GABA](https://arxiv.org/abs/2602.20289)
...
### [63] [Cooperative ISAC for Joint Localization and Velocity Estimation in Cell-Free MIMO Systems](https://arxiv.org/abs/2602.20319)
...
### [64] [Waveform Design for Partial-Time Superimposed ISAC Systems](https://arxiv.org/abs/2602.20353)
...
### [65] [Comparing Implicit Neural Representations and B-Splines for Continuous Function Fitting from Sparse Samples](https://arxiv.org/abs/2602.20535)
...
### [66] [Functional Continuous Decomposition](https://arxiv.org/abs/2602.20857)
*Teymur Aghayev*
...
### [67] [Symbol-Aware Precoder Design for Physical-Layer Anonymous Communications](https://arxiv.org/abs/2602.20874)
...
### [68] [Synapse-Inspired Energy Networks: A Neuromorphic Approach to Microgrid Protection without Communication Links](https://arxiv.org/abs/2602.20944)
...
### [69] [Timing Recovery and Sequence Detection for Integrate-and-Fire Time Encoding Receivers](https://arxiv.org/abs/2602.20953)
*Neil Irwin Bernardo*
...
### [70] [Optimal QAM Constellation for Over-the-Air Computation in the Presence of Heavy-Tailed Channel Noise](https://arxiv.org/abs/2602.21027)
...
### [71] [BRISC: A Dataset of Channel Measurements at 5 GHz With a Reflective Intelligent Surface](https://arxiv.org/abs/2602.21102)
...
### [72] [Attention-Based SINR Estimation in User-Centric Non-Terrestrial Networks](https://arxiv.org/abs/2602.21116)
