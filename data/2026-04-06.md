...
### [1] [I must delete the evidence: AI Agents Explicitly Cover up Fraud and Violent Crime](https://arxiv.org/abs/2604.02500)
...
### [2] [A Comprehensive Framework for Long-Term Resiliency Investment Planning under Extreme Weather Uncertainty for Electric Utilities](https://arxiv.org/abs/2604.02504)
*Emma Benjaminson*
...
### [3] [OntoKG: Ontology-Oriented Knowledge Graph Construction with Intrinsic-Relational Routing](https://arxiv.org/abs/2604.02618)
...
### [4] [DeltaLogic: Minimal Premise Edits Reveal Belief-Revision Failures in Logical Reasoning Models](https://arxiv.org/abs/2604.02733)
*Amit Dhanda*
...
### [5] [Aligning Progress and Feasibility: A Neuro-Symbolic Dual Memory Framework for Long-Horizon LLM Agents](https://arxiv.org/abs/2604.02734)
...
### [6] [Improving Role Consistency in Multi-Agent Collaboration via Quantitative Role Clarity](https://arxiv.org/abs/2604.02770)
...
### [7] [ESL-Bench: An Event-Driven Synthetic Longitudinal Benchmark for Health Agents](https://arxiv.org/abs/2604.02834)
...
### [8] [EMS: Multi-Agent Voting via Efficient Majority-then-Stopping](https://arxiv.org/abs/2604.02863)
...
### [9] [FoE: Forest of Errors Makes the First Solution the Best in Large Reasoning Models](https://arxiv.org/abs/2604.02967)
...
### [10] [Agentic-MME: What Agentic Capability Really Brings to Multimodal Intelligence?](https://arxiv.org/abs/2604.03016)
...
### [11] [Automatic Textbook Formalization](https://arxiv.org/abs/2604.03071)
...
### [13] [Coupled Control, Structured Memory, and Verifiable Action in Agentic AI (SCRAT -- Stochastic Control with Retrieval and Auditable Trajectories): A Comparative Perspective from Squirrel Locomotion and Scatter-Hoarding](https://arxiv.org/abs/2604.03201)
...
### [15] [On the Sensitivity of Active RIS Systems to CSI Errors: Joint Optimization and Performance Trade-off](https://arxiv.org/abs/2604.02515)
...
### [16] [Low-Complexity Algorithm for Stackelberg Prediction Games with Global Optimality](https://arxiv.org/abs/2604.02676)
...
### [17] [MIMO OFDM-Enabled ISAC for Low-Altitude Non-Cooperative UAV Surveillance: A Survey](https://arxiv.org/abs/2604.02680)
...
### [18] [Ground Reflection-Aided TomoSAR Imaging with 5G NR Signals](https://arxiv.org/abs/2604.02897)
...
### [19] [Learning interacting particle systems from unlabeled data](https://arxiv.org/abs/2604.02581)
*Viska Wei,Fei Lu*
...
### [20] [Lipschitz bounds for integral kernels](https://arxiv.org/abs/2604.02887)
...
### [21] [Inversion-Free Natural Gradient Descent on Riemannian Manifolds](https://arxiv.org/abs/2604.02969)
...
### [22] [Varying risk exposure in auto insurance: a weighted tweedie framework for experience rating an cancellation penalties](https://arxiv.org/abs/2604.02400)
...
### [23] [LLM Reasoning with Process Rewards for Outcome-Guided Steps](https://arxiv.org/abs/2604.02341)
...
### [24] [Homophily-aware Supervised Contrastive Counterfactual Augmented Fair Graph Neural Network](https://arxiv.org/abs/2604.02342)
...
### [25] [Low-Rank Compression of Pretrained Models via Randomized Subspace Iteration](https://arxiv.org/abs/2604.02659)
...
### [27] [FTimeXer: Frequency-aware Time-series Transformer with Exogenous variables for Robust Carbon Footprint Forecasting](https://arxiv.org/abs/2604.02347)
...
### [28] [OPRIDE: Offline Preference-based Reinforcement Learning via In-Dataset Exploration](https://arxiv.org/abs/2604.02349)
...
### [30] [YC Bench: a Live Benchmark for Forecasting Startup Outperformance in Y Combinator Batches](https://arxiv.org/abs/2604.02378)
*Mostapha Benhenda*
...
### [31] [Dynamical structure of vanishing gradient and overfitting in multi-layer perceptrons](https://arxiv.org/abs/2604.02393)
...
### [32] [Self-Directed Task Identification](https://arxiv.org/abs/2604.02430)
...
### [33] [Matrix Profile for Time-Series Anomaly Detection: A Reproducible Open-Source Benchmark on TSB-AD](https://arxiv.org/abs/2604.02445)
...
### [35] [Re-analysis of the Human Transcription Factor Atlas Recovers TF-Specific Signatures from Pooled Single-Cell Screens with Missing Controls](https://arxiv.org/abs/2604.02511)
...
### [36] [AdaHOP: Fast and Accurate Low-Precision Training via Outlier-Pattern-Aware Rotation](https://arxiv.org/abs/2604.02525)
...
### [37] [A Spectral Framework for Multi-Scale Nonlinear Dimensionality Reduction](https://arxiv.org/abs/2604.02535)
...
### [38] [Fast NF4 Dequantization Kernels for Large Language Model Inference](https://arxiv.org/abs/2604.02556)
...
### [39] [Communication-Efficient Distributed Learning with Differential Privacy](https://arxiv.org/abs/2604.02558)
...
### [40] [ROMAN: A Multiscale Routing Operator for Convolutional Time Series Models](https://arxiv.org/abs/2604.02577)
*Gonzalo Uribarri*
...
### [41] [Steerable but Not Decodable: Function Vectors Operate Beyond the Logit Lens](https://arxiv.org/abs/2604.02608)
...
### [42] [Conditional Sampling via Wasserstein Autoencoders and Triangular Transport](https://arxiv.org/abs/2604.02644)
...
### [43] [Communication-free Sampling and 4D Hybrid Parallelism for Scalable Mini-batch GNN Training](https://arxiv.org/abs/2604.02651)
...
### [44] [Mitigating Reward Hacking in RLHF via Advantage Sign Robustness](https://arxiv.org/abs/2604.02986)
...
### [45] [Adaptive Semantic Communication for Wireless Image Transmission Leveraging Mixture-of-Experts Mechanism](https://arxiv.org/abs/2604.02691)
...
### [46] [Understanding the Role of Hallucination in Reinforcement Post-Training of Multimodal Reasoning Models](https://arxiv.org/abs/2604.03179)
...
### [47] [FluxMoE: Decoupling Expert Residency for High-Performance MoE Serving](https://arxiv.org/abs/2604.02715)
...
### [48] [Gradient Boosting within a Single Attention Layer](https://arxiv.org/abs/2604.03190)
*Saleh Sargolzaei*
...
### [49] [Understanding Latent Diffusability via Fisher Geometry](https://arxiv.org/abs/2604.02751)
...
### [50] [Enhancing Robustness of Federated Learning via Server Learning](https://arxiv.org/abs/2604.03226)
...
### [51] [STDDN: A Physics-Guided Deep Learning Framework for Crowd Simulation](https://arxiv.org/abs/2604.02756)
...
### [52] [Towards Realistic Class-Incremental Learning with Free-Flow Increments](https://arxiv.org/abs/2604.02765)
...
### [53] [Toward an Operational GNN-Based Multimesh Surrogate for Fast Flood Forecasting](https://arxiv.org/abs/2604.02876)
...
### [54] [Extracting Money Laundering Transactions from Quasi-Temporal Graph Representation](https://arxiv.org/abs/2604.02899)
...
### [55] [Efficient Logistic Regression with Mixture of Sigmoids](https://arxiv.org/abs/2604.02920)
...
### [56] [Towards Near-Real-Time Telemetry-Aware Routing with Neural Routing Algorithms](https://arxiv.org/abs/2604.02927)
...
### [57] [Self-Distilled RLVR](https://arxiv.org/abs/2604.03128)
...
### [58] [HyperFitS -- Hypernetwork Fitting Spectra for metabolic quantification of ${}^1$H MR spectroscopic imaging](https://arxiv.org/abs/2604.03150)
...
### [59] [DSBD: Dual-Aligned Structural Basis Distillation for Graph Domain Adaptation](https://arxiv.org/abs/2604.03154)
