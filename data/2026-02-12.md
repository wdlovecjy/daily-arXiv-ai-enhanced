...
### [1] [RadarEye: Robust Liquid Level Tracking Using mmWave Radar in Robotic Pouring](https://arxiv.org/abs/2602.10417)
*Hongyu Deng,He Chen*
...
### [2] [Nonparametric Variational Bayesian Learning for Channel Estimation with OTFS Modulation](https://arxiv.org/abs/2602.10438)
...
### [3] [Stochastic Design of Active RIS-Assisted Satellite Downlinks under Interference, Folded Noise, and EIRP Constraints](https://arxiv.org/abs/2602.10742)
...
### [4] [Constellation Design for Robust Interference Mitigation](https://arxiv.org/abs/2602.10767)
...
### [5] [Bayesian Signal Component Decomposition via Diffusion-within-Gibbs Sampling](https://arxiv.org/abs/2602.10792)
...
### [6] [Physically Consistent Evaluation of Commonly Used Near-Field Models](https://arxiv.org/abs/2602.10976)
...
### [7] [Dissecting Performative Prediction: A Comprehensive Survey](https://arxiv.org/abs/2602.10176)
...
### [8] [A Gibbs posterior sampler for inverse problem based on prior diffusion model](https://arxiv.org/abs/2602.11059)
...
### [9] [Statistical Inference and Learning for Shapley Additive Explanations (SHAP)](https://arxiv.org/abs/2602.10532)
...
### [10] [Why Agentic Theorem Prover Works: A Statistical Provability Theory of Mathematical Reasoning Models](https://arxiv.org/abs/2602.10538)
...
### [11] [Bayesian Inference of Contextual Bandit Policies via Empirical Likelihood](https://arxiv.org/abs/2602.10608)
...
### [12] [Highly Adaptive Principal Component Regression](https://arxiv.org/abs/2602.10613)
...
### [13] [Beyond Kemeny Medians: Consensus Ranking Distributions Definition, Properties and Statistical Learning](https://arxiv.org/abs/2602.10640)
...
### [14] [Convergence Rates for Distribution Matching with Sliced Optimal Transport](https://arxiv.org/abs/2602.10691)
...
### [15] [Deep Learning of Compositional Targets with Hierarchical Spectral Methods](https://arxiv.org/abs/2602.10867)
...
### [16] [Optimal Initialization in Depth: Lyapunov Initialization and Limit Theorems for Deep Leaky ReLU Networks](https://arxiv.org/abs/2602.10949)
...
### [19] [Experimental Demonstration of Online Learning-Based Concept Drift Adaptation for Failure Detection in Optical Networks](https://arxiv.org/abs/2602.10401)
...
### [20] [LOREN: Low Rank-Based Code-Rate Adaptation in Neural Receivers](https://arxiv.org/abs/2602.10770)
...
### [21] [Linear-LLM-SCM: Benchmarking LLMs for Coefficient Elicitation in Linear-Gaussian Causal Models](https://arxiv.org/abs/2602.10282)
...
### [23] [On the Role of Consistency Between Physics and Data in Physics-Informed Neural Networks](https://arxiv.org/abs/2602.10611)
...
### [24] [Hardware Co-Design Scaling Laws via Roofline Modelling for On-Device LLMs](https://arxiv.org/abs/2602.10377)
...
### [25] [Deep learning outperforms traditional machine learning methods in predicting childhood malnutrition: evidence from survey data](https://arxiv.org/abs/2602.10381)
...
### [26] [Natural Hypergradient Descent: Algorithm Design, Convergence Analysis, and Parallel Implementation](https://arxiv.org/abs/2602.10905)
...
### [27] [Time-to-Event Transformer to Capture Timing Attention of Events in EHR Time Series](https://arxiv.org/abs/2602.10385)
...
### [28] [Affordances Enable Partial World Modeling with LLMs](https://arxiv.org/abs/2602.10390)
...
### [29] [Colorful Talks with Graphs: Human-Interpretable Graph Encodings for Large Language Models](https://arxiv.org/abs/2602.10386)
...
### [30] [OSIL: Learning Offline Safe Imitation Policies with Safety Inferred from Non-preferred Trajectories](https://arxiv.org/abs/2602.11018)
...
### [31] [AI-rithmetic](https://arxiv.org/abs/2602.10416)
...
### [32] [Equivariant Evidential Deep Learning for Interatomic Potentials](https://arxiv.org/abs/2602.10419)
...
### [33] [LUCID: Attention with Preconditioned Representations](https://arxiv.org/abs/2602.10410)
...
### [34] [Learning Adaptive Distribution Alignment with Neural Characteristic Function for Graph Domain Adaptation](https://arxiv.org/abs/2602.10489)
...
### [35] [Low-Dimensional Execution Manifolds in Transformer Learning Dynamics: Evidence from Modular Arithmetic Tasks](https://arxiv.org/abs/2602.10496)
*Yongzhong Xu*
...
### [36] [QTALE: Quantization-Robust Token-Adaptive Layer Execution for LLMs](https://arxiv.org/abs/2602.10431)
...
### [37] [Chamfer-Linkage for Hierarchical Agglomerative Clustering](https://arxiv.org/abs/2602.10444)
...
### [38] [VESPO: Variational Sequence-Level Soft Policy Optimization for Stable Off-Policy LLM Training](https://arxiv.org/abs/2602.10693)
...
### [39] [Interpretable Graph-Level Anomaly Detection via Contrast with Normal Prototypes](https://arxiv.org/abs/2602.10708)
...
### [40] [Kill it with FIRE: On Leveraging Latent Space Directions for Runtime Backdoor Mitigation in Deep Neural Networks](https://arxiv.org/abs/2602.10780)
...
### [41] [Time Series Foundation Models for Energy Load Forecasting on Consumer Hardware: A Multi-Dimensional Zero-Shot Benchmark](https://arxiv.org/abs/2602.10848)
*Luigi Simeone*
...
### [42] [ICA: Information-Aware Credit Assignment for Visually Grounded Long-Horizon Information-Seeking Agents](https://arxiv.org/abs/2602.10863)
...
### [43] [What Makes Value Learning Efficient in Residual Reinforcement Learning?](https://arxiv.org/abs/2602.10539)
...
### [44] [Resource-Efficient Model-Free Reinforcement Learning for Board Games](https://arxiv.org/abs/2602.10894)
...
### [45] [Rotary Positional Embeddings as Phase Modulation: Theoretical Bounds on the RoPE Base for Long-Context Transformers](https://arxiv.org/abs/2602.10959)
*Feilong Liu*
...
### [46] [RiemannGL: Riemannian Geometry Changes Graph Deep Learning](https://arxiv.org/abs/2602.10982)
...
### [47] [ROCKET: Rapid Optimization via Calibration-guided Knapsack Enhanced Truncation for Efficient Model Compression](https://arxiv.org/abs/2602.11008)
...
### [48] [Gauss-Newton Unlearning for the LLM Era](https://arxiv.org/abs/2602.10568)
...
### [49] [In-the-Wild Model Organisms: Mitigating Undesirable Emergent Behaviors in Production LLM Post-Training via Data Attribution](https://arxiv.org/abs/2602.11079)
...
### [50] [When Gradient Clipping Becomes a Control Mechanism for Differential Privacy in Deep Learning](https://arxiv.org/abs/2602.10584)
...
### [51] [GRASP: group-Shapley feature selection for patients](https://arxiv.org/abs/2602.11084)
...
### [52] [Direct Learning of Calibration-Aware Uncertainty for Neural PDE Surrogates](https://arxiv.org/abs/2602.11090)
*Carlos Stein Brito*
...
### [53] [Weight Decay Improves Language Model Plasticity](https://arxiv.org/abs/2602.11137)
...
### [54] [Learning Mixture Density via Natural Gradient Expectation Maximization](https://arxiv.org/abs/2602.10602)
...
### [55] [Pupillometry and Brain Dynamics for Cognitive Load in Working Memory](https://arxiv.org/abs/2602.10614)
...
### [56] [Reducing Estimation Uncertainty Using Normalizing Flows and Stratification](https://arxiv.org/abs/2602.10706)
...
### [57] [Rising Multi-Armed Bandits with Known Horizons](https://arxiv.org/abs/2602.10727)
...
### [58] [Collaborative Threshold Watermarking](https://arxiv.org/abs/2602.10765)
...
### [59] [Semi-Supervised Cross-Domain Imitation Learning](https://arxiv.org/abs/2602.10793)
...
### [60] [Tuning the burn-in phase in training recurrent neural networks improves their performance](https://arxiv.org/abs/2602.10911)
...
### [61] [Near-Constant Strong Violation and Last-Iterate Convergence for Online CMDPs via Decaying Safety Margins](https://arxiv.org/abs/2602.10917)
...
### [62] [Token-Efficient Change Detection in LLM APIs](https://arxiv.org/abs/2602.11083)
...
### [63] [From Circuits to Dynamics: Understanding and Stabilizing Failure in 3D Diffusion Transformers](https://arxiv.org/abs/2602.11130)
...
### [64] [Diffusion-Pretrained Dense and Contextual Embeddings](https://arxiv.org/abs/2602.11151)
...
### [65] [The Dataset of Daily Air Quality for the Years 2013-2023 in Italy](https://arxiv.org/abs/2602.10749)
...
### [66] [Discovering Differences in Strategic Behavior Between Humans and LLMs](https://arxiv.org/abs/2602.10324)
...
### [67] [LiveMedBench: A Contamination-Free Medical Benchmark for LLMs with Automated Rubric Evaluation](https://arxiv.org/abs/2602.10367)
...
### [68] [Found-RL: foundation model-enhanced reinforcement learning for autonomous driving](https://arxiv.org/abs/2602.10458)
...
### [69] [MERIT Feedback Elicits Better Bargaining in LLM Negotiators](https://arxiv.org/abs/2602.10467)
...
### [70] [Neuro-symbolic Action Masking for Deep Reinforcement Learning](https://arxiv.org/abs/2602.10598)
...
### [71] [To Think or Not To Think, That is The Question for Large Reasoning Models in Theory of Mind Tasks](https://arxiv.org/abs/2602.10625)
...
### [73] [Reinforcing Chain-of-Thought Reasoning with Self-Evolving Rubrics](https://arxiv.org/abs/2602.10885)
...
### [74] [GameDevBench: Evaluating Agentic Capabilities Through Game Development](https://arxiv.org/abs/2602.11103)
