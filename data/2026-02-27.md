...
### [1] [Sharp Convergence Rates for Masked Diffusion Models](https://arxiv.org/abs/2602.22505)
...
### [2] [Orthogonal Weight Modification Enhances Learning Scalability and Convergence Efficiency without Gradient Backpropagation](https://arxiv.org/abs/2602.22259)
*Guoqing Ma,Shan Yu*
...
### [3] [Decentralized Ranking Aggregation: Gossip Algorithms for Borda and Copeland Consensus](https://arxiv.org/abs/2602.22847)
...
### [5] [X-REFINE: XAI-based RElevance input-Filtering and archItecture fiNe-tuning for channel Estimation](https://arxiv.org/abs/2602.22277)
...
### [10] [Positional-aware Spatio-Temporal Network for Large-Scale Traffic Prediction](https://arxiv.org/abs/2602.22274)
*Runfei Chen*
...
### [11] [Integrating Machine Learning Ensembles and Large Language Models for Heart Disease Prediction Using Voting Fusion](https://arxiv.org/abs/2602.22280)
...
### [12] [Early Risk Stratification of Dosing Errors in Clinical Trials Using Machine Learning](https://arxiv.org/abs/2602.22285)
...
### [13] [Reliable XAI Explanations in Sudden Cardiac Death Prediction for Chagas Cardiomyopathy](https://arxiv.org/abs/2602.22288)
...
### [14] [Manifold of Failure: Behavioral Attraction Basins in Language Models](https://arxiv.org/abs/2602.22291)
...
### [15] [AviaSafe: A Physics-Informed Data-Driven Model for Aviation Safety-Critical Cloud Forecasts](https://arxiv.org/abs/2602.22298)
...
### [16] [Learning geometry-dependent lead-field operators for forward ECG modeling](https://arxiv.org/abs/2602.22367)
...
### [20] [ECHO: Encoding Communities via High-order Operators](https://arxiv.org/abs/2602.22446)
*Emilio Ferrara*
...
### [24] [Predicting Tennis Serve directions with Machine Learning](https://arxiv.org/abs/2602.22527)
...
### [25] [Coarse-to-Fine Learning of Dynamic Causal Structures](https://arxiv.org/abs/2602.22532)
...
### [27] [Relatron: Automating Relational Machine Learning over Relational Databases](https://arxiv.org/abs/2602.22552)
...
### [28] [Operationalizing Fairness: Post-Hoc Threshold Optimization Under Hard Resource Limits](https://arxiv.org/abs/2602.22560)
...
### [29] [S2O: Early Stopping for Sparse Attention via Online Permutation](https://arxiv.org/abs/2602.22575)
...
### [30] [IBCircuit: Towards Holistic Circuit Discovery with Information Bottleneck](https://arxiv.org/abs/2602.22581)
...
### [31] [pQuant: Towards Effective Low-Bit Language Models via Decoupled Linear Quantization-Aware Training](https://arxiv.org/abs/2602.22592)
...
### [32] [$φ$-DPO: Fairness Direct Preference Optimization Approach to Continual Learning in Large Multimodal Models](https://arxiv.org/abs/2602.22601)
...
### [33] [Compress the Easy, Explore the Hard: Difficulty-Aware Entropy Regularization for Efficient LLM Reasoning](https://arxiv.org/abs/2602.22642)
...
### [34] [Switch-Hurdle: A MoE Encoder with AR Hurdle Decoder for Intermittent Demand Forecasting](https://arxiv.org/abs/2602.22685)
...
### [35] [Accelerating Local LLMs on Resource-Constrained Edge Devices via Distributed Prompt Caching](https://arxiv.org/abs/2602.22812)
...
### [36] [Hierarchy-of-Groups Policy Optimization for Long-Horizon Agentic Tasks](https://arxiv.org/abs/2602.22817)
...
### [37] [Moral Preferences of LLMs Under Directed Contextual Influence](https://arxiv.org/abs/2602.22831)
...
### [38] [Fair feature attribution for multi-output prediction: a Shapley-based perspective](https://arxiv.org/abs/2602.22882)
...
### [39] [A Data-Driven Approach to Support Clinical Renal Replacement Therapy](https://arxiv.org/abs/2602.22902)
...
### [40] [MSINO: Curvature-Aware Sobolev Optimization for Manifold Neural Networks](https://arxiv.org/abs/2602.22937)
*Suresan Pareth*
...
### [41] [Scaling Laws of Global Weather Models](https://arxiv.org/abs/2602.22962)
...
### [42] [Physics-informed neural particle flow for the Bayesian update step](https://arxiv.org/abs/2602.23089)
...
### [43] [PRAC: Principal-Random Subspace for LLM Activation Compression and Memory-Efficient Training](https://arxiv.org/abs/2602.23111)
...
### [44] [DyGnROLE: Modeling Asymmetry in Dynamic Graphs with Node-Role-Oriented Latent Encoding](https://arxiv.org/abs/2602.23135)
...
### [45] [Prediction of Diffusion Coefficients in Mixtures with Tensor Completion](https://arxiv.org/abs/2602.23142)
...
### [46] [Partial recovery of meter-scale surface weather](https://arxiv.org/abs/2602.23146)
...
### [47] [Closing the gap on tabular data with Fourier and Implicit Categorical Features](https://arxiv.org/abs/2602.23182)
...
### [48] [FlashOptim: Optimizers for Memory Efficient Training](https://arxiv.org/abs/2602.23349)
...
### [49] [Physics Informed Viscous Value Representations](https://arxiv.org/abs/2602.23280)
...
### [50] [SOTAlign: Semi-Supervised Alignment of Unimodal Vision and Language Models via Optimal Transport](https://arxiv.org/abs/2602.23353)
...
### [51] [Full Waveform Inversion using the Wasserstein metric for ultrasound transducer array based NDT](https://arxiv.org/abs/2602.22378)
...
### [52] [CSI-RFF: Leveraging Micro-Signals on CSI for RF Fingerprinting of Commodity WiFi](https://arxiv.org/abs/2602.22738)
*Ruiqi Kong,He Chen*
...
### [53] [A guided residual search for nonlinear state-space identification](https://arxiv.org/abs/2602.22964)
...
### [54] [Digital Twin-Based Beamforming for Interference Mitigation in AF Relay MIMO Systems](https://arxiv.org/abs/2602.22991)
...
### [55] [A Scaling Law for Bandwidth Under Quantization](https://arxiv.org/abs/2602.23252)
...
### [56] [Analog Time Multiplexing for Digital-to-Analog Conversion](https://arxiv.org/abs/2602.23284)
...
### [57] [CubeSounder: Low SWaP-C 180 GHz Radiometer for Atmospheric Sensing Tested on High Altitude Balloons](https://arxiv.org/abs/2602.23338)
...
### [58] [LoBoost: Fast Model-Native Local Conformal Prediction for Gradient-Boosted Trees](https://arxiv.org/abs/2602.22432)
...
### [59] [Beyond NNGP: Large Deviations and Feature Learning in Bayesian Neural Networks](https://arxiv.org/abs/2602.22925)
...
### [60] [Robust optimal reconciliation for hierarchical time series forecasting with M-estimation](https://arxiv.org/abs/2602.22694)
...
### [61] [The Counterfactual Combine: A Causal Framework for Player Evaluation](https://arxiv.org/abs/2602.23233)
...
### [62] [FIRE: A Comprehensive Benchmark for Financial Intelligence and Reasoning Evaluation](https://arxiv.org/abs/2602.22273)
...
### [63] [Decomposing Physician Disagreement in HealthBench](https://arxiv.org/abs/2602.22758)
...
### [64] [Agent Behavioral Contracts: Formal Specification and Runtime Enforcement for Reliable Autonomous AI Agents](https://arxiv.org/abs/2602.22302)
...
### [65] [Vibe Researching as Wolf Coming: Can AI Agents with Skills Replace or Augment Social Scientists?](https://arxiv.org/abs/2602.22401)
*Yongjun Zhang*
...
### [66] [A Framework for Assessing AI Agent Decisions and Outcomes in AutoML Pipelines](https://arxiv.org/abs/2602.22442)
...
### [67] [Agentic AI for Intent-driven Optimization in Cell-free O-RAN](https://arxiv.org/abs/2602.22539)
...
### [73] [Correcting Human Labels for Rater Effects in AI Evaluation: An Item Response Theory Approach](https://arxiv.org/abs/2602.22585)
...
### [74] [SideQuest: Model-Driven KV Cache Management for Long-Horizon Agentic Reasoning](https://arxiv.org/abs/2602.22603)
...
### [75] [MobilityBench: A Benchmark for Evaluating Route-Planning Agents in Real-World Mobility Scenarios](https://arxiv.org/abs/2602.22638)
...
### [76] [Knob: A Physics-Inspired Gating Interface for Interpretable and Controllable Neural Dynamics](https://arxiv.org/abs/2602.22702)
...
### [77] [RLHFless: Serverless Computing for Efficient RLHF](https://arxiv.org/abs/2602.22718)
...
### [79] [When Should an AI Act? A Human-Centered Model of Scene, Context, and Behavior for Agentic AI Design](https://arxiv.org/abs/2602.22814)
...
### [82] [Mitigating Legibility Tax with Decoupled Prover-Verifier Games](https://arxiv.org/abs/2602.23248)
*Yegon Kim,Juho Lee*
...
### [83] [The logic of KM belief update is contained in the logic of AGM belief revision](https://arxiv.org/abs/2602.23302)
*Giacomo Bonanno*
...
### [84] [Invariant Transformation and Resampling based Epistemic-Uncertainty Reduction](https://arxiv.org/abs/2602.23315)
*Sha Hu*
