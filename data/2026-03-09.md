...
### [1] [IntSeqBERT: Learning Arithmetic Structure in OEIS via Modulo-Spectrum Embeddings](https://arxiv.org/abs/2603.05556)
*Kazuhisa Nakasho*
...
### [3] [Towards Efficient and Stable Ocean State Forecasting: A Continuous-Time Koopman Approach](https://arxiv.org/abs/2603.05560)
...
### [4] [Design Experiments to Compare Multi-armed Bandit Algorithms](https://arxiv.org/abs/2603.05919)
...
### [5] [Topological descriptors of foot clearance gait dynamics improve differential diagnosis of Parkinsonism](https://arxiv.org/abs/2603.06212)
...
### [6] [Agnostic learning in (almost) optimal time via Gaussian surface area](https://arxiv.org/abs/2603.06027)
...
### [7] [Aligning the True Semantics: Constrained Decoupling and Distribution Sampling for Cross-Modal Alignment](https://arxiv.org/abs/2603.05566)
...
### [8] [Gradient Flow Polarizes Softmax Outputs towards Low-Entropy Solutions](https://arxiv.org/abs/2603.06248)
...
### [9] [Why Depth Matters in Parallelizable Sequence Models: A Lie Algebraic View](https://arxiv.org/abs/2603.05573)
...
### [10] [A Novel Hybrid Heuristic-Reinforcement Learning Optimization Approach for a Class of Railcar Shunting Problems](https://arxiv.org/abs/2603.05579)
...
### [11] [Bias In, Bias Out? Finding Unbiased Subnetworks in Vanilla Models](https://arxiv.org/abs/2603.05582)
...
### [15] [Reinforcement Learning for Power-Flow Network Analysis](https://arxiv.org/abs/2603.05673)
...
### [18] [First-Order Softmax Weighted Switching Gradient Method for Distributed Stochastic Minimax Optimization with Stochastic Constraints](https://arxiv.org/abs/2603.05774)
...
### [19] [MoE Lens -- An Expert Is All You Need](https://arxiv.org/abs/2603.05806)
...
### [20] [Stock Market Prediction Using Node Transformer Architecture Integrated with BERT Sentiment Analysis](https://arxiv.org/abs/2603.05917)
...
### [21] [Self-Auditing Parameter-Efficient Fine-Tuning for Few-Shot 3D Medical Image Segmentation](https://arxiv.org/abs/2603.05822)
...
### [22] [Partial Policy Gradients for RL in LLMs](https://arxiv.org/abs/2603.06138)
...
### [23] [Stochastic Event Prediction via Temporal Motif Transitions](https://arxiv.org/abs/2603.05874)
...
### [25] [Stem: Rethinking Causal Information Flow in Sparse Attention](https://arxiv.org/abs/2603.06274)
...
### [26] [Omni-Masked Gradient Descent: Memory-Efficient Optimization via Mask Traversal with Improved Convergence](https://arxiv.org/abs/2603.05960)
...
### [27] [CLAIRE: Compressed Latent Autoencoder for Industrial Representation and Evaluation -- A Deep Learning Framework for Smart Manufacturing](https://arxiv.org/abs/2603.06361)
...
### [28] [Preventing Learning Stagnation in PPO by Scaling to 1 Million Parallel Environments](https://arxiv.org/abs/2603.06009)
...
### [29] [COLD-Steer: Steering Large Language Models via In-Context One-step Learning Dynamics](https://arxiv.org/abs/2603.06495)
...
### [30] [Improved high-dimensional estimation with Langevin dynamics and stochastic weight averaging](https://arxiv.org/abs/2603.06028)
...
### [32] [DQE: A Semantic-Aware Evaluation Metric for Time Series Anomaly Detection](https://arxiv.org/abs/2603.06131)
...
### [33] [DC-Merge: Improving Model Merging with Directional Consistency](https://arxiv.org/abs/2603.06242)
...
### [34] [Causal Interpretation of Neural Network Computations with Contribution Decomposition](https://arxiv.org/abs/2603.06557)
...
### [35] [Frequency Response of Windowed DFT Phasor Estimation: Impact on Oscillation Observability](https://arxiv.org/abs/2603.05746)
...
### [36] [Ill-Posedness Analysis of CSI-Based Electromagnetic Inverse Scattering for Material Reconstruction in ISAC Systems](https://arxiv.org/abs/2603.05918)
...
### [37] [Channel Estimation for Reconfigurable Intelligent Surface Assisted Upper Mid-Band MIMO Systems](https://arxiv.org/abs/2603.06017)
...
### [38] [Reinforcement Learning for Secrecy Optimization in Underwater Energy Harvesting Relay Network](https://arxiv.org/abs/2603.06046)
...
### [39] [A Retrieval-Assisted Framework for Wireless Localization](https://arxiv.org/abs/2603.06158)
...
### [40] [MAD: A Multimodal and Multi-perspective Affective Dataset with Hierarchical Annotations](https://arxiv.org/abs/2603.06206)
...
### [41] [Set-Prediction-Based J-Peak Detection for Pillow-Based Ballistocardiography](https://arxiv.org/abs/2603.06221)
...
### [42] [The DCT Model as a Novel Regression Framework within a Lagrangian Formulation](https://arxiv.org/abs/2603.06418)
...
### [43] [Codebook Design and Baseband Precoding for Pragmatic Array-Fed RIS Hybrid Multiuser MIMO](https://arxiv.org/abs/2603.06541)
...
### [44] [Learning Optimal Distributionally Robust Individualized Treatment Rules Integrating Multi-Source Data](https://arxiv.org/abs/2603.05568)
...
### [45] [Prediction-Powered Conditional Inference](https://arxiv.org/abs/2603.05575)
...
### [46] [Preoperative Decline and Postoperative Recovery of Wearable-Derived Physical Activity Over a Four-Year Perioperative Period in Total Knee and Hip Arthroplasty: Evidence from the All of Us Research Program](https://arxiv.org/abs/2603.05741)
...
### [47] [Modeling Animal Communication Using Multivariate Hawkes Processes with Additive Excitation and Multiplicative Inhibition](https://arxiv.org/abs/2603.05938)
...
### [48] [A Tutorial on Bayesian Analysis of Linear Shock Compression Data](https://arxiv.org/abs/2603.05961)
...
### [49] [Estimating Residential Displacement in the Central Puget Sound Region using Household Survey Data](https://arxiv.org/abs/2603.06437)
...
### [50] [A mixed-frequency approach for exchange rates predictions](https://arxiv.org/abs/2106.00283)
...
### [54] [Boosting deep Reinforcement Learning using pretraining with Logical Options](https://arxiv.org/abs/2603.06565)
