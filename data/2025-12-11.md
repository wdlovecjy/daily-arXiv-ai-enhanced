...
### [4] [Visual Categorization Across Minds and Models: Cognitive Analysis of Human Labeling and Neuro-Symbolic Integration](https://arxiv.org/abs/2512.09340)
...
### [5] [Gaussian Process Aggregation for Root-Parallel Monte Carlo Tree Search with Continuous Actions](https://arxiv.org/abs/2512.09727)
...
### [6] [Bayesian Networks, Markov Networks, Moralisation, Triangulation: a Categorical Perspective](https://arxiv.org/abs/2512.09908)
...
### [7] [Optimizing Algorithms for Mobile Health Interventions with Active Querying Optimization](https://arxiv.org/abs/2512.08950)
*Aseel Rawashdeh*
...
### [8] [Learning When to Ask: Simulation-Trained Humanoids for Mental-Health Diagnosis](https://arxiv.org/abs/2512.08952)
...
### [11] [HPM-KD: Hierarchical Progressive Multi-Teacher Framework for Knowledge Distillation and Efficient Model Compression](https://arxiv.org/abs/2512.09886)
...
### [12] [Resolving Conflicts in Lifelong Learning via Aligning Updates in Subspaces](https://arxiv.org/abs/2512.08960)
...
### [13] [SEA: Spectral Edge Attacks on Graph Neural Networks](https://arxiv.org/abs/2512.08964)
*Yongyu Wang*
...
### [15] [Financial Instruction Following Evaluation (FIFE)](https://arxiv.org/abs/2512.08965)
...
### [16] [Beyond the Hype: Comparing Lightweight and Deep Learning Models for Air Quality Forecasting](https://arxiv.org/abs/2512.09076)
...
### [17] [CluCERT: Certifying LLM Robustness via Clustering-Guided Denoising Smoothing](https://arxiv.org/abs/2512.08967)
...
### [23] [Spectral Embedding via Chebyshev Bases for Robust DeepONet Approximation](https://arxiv.org/abs/2512.09165)
...
### [24] [Goal inference with Rao-Blackwellized Particle Filters](https://arxiv.org/abs/2512.09269)
...
### [25] [Branching Strategies Based on Subgraph GNNs: A Study on Theoretical Promise versus Practical Reality](https://arxiv.org/abs/2512.09355)
...
### [26] [Towards Resilient Transportation: A Conditional Transformer for Accident-Informed Traffic Forecasting](https://arxiv.org/abs/2512.09398)
...
### [27] [Improved Physics-Driven Neural Network to Solve Inverse Scattering Problems](https://arxiv.org/abs/2512.09333)
...
### [28] [A Granular Framework for Construction Material Price Forecasting: Econometric and Machine-Learning Approaches](https://arxiv.org/abs/2512.09360)
...
### [29] [Are Hypervectors Enough? Single-Call LLM Reasoning over Knowledge Graphs](https://arxiv.org/abs/2512.09369)
...
### [30] [Federated Distillation Assisted Vehicle Edge Caching Scheme Based on Lightweight DDPM](https://arxiv.org/abs/2512.09378)
...
### [31] [Semantic-Aware Cooperative Communication and Computation Framework in Vehicular Networks](https://arxiv.org/abs/2512.09621)
...
### [32] [Incorporating Fairness in Neighborhood Graphs for Fair Spectral Clustering](https://arxiv.org/abs/2512.09810)
...
### [33] [Predicting the Containment Time of California Wildfires Using Machine Learning](https://arxiv.org/abs/2512.09835)
*Shashank Bhardwaj*
...
### [34] [Conformal Bandits: Bringing statistical validity and reward efficiency to the small-gap regime](https://arxiv.org/abs/2512.09850)
...
### [35] [Analysis of Dirichlet Energies as Over-smoothing Measures](https://arxiv.org/abs/2512.09890)
...
### [36] [Access to healthcare for people with Alzheimer's Diseases and related dementias](https://arxiv.org/abs/2512.09217)
...
### [37] [Group Cooperation Diverges onto Durable Low versus High Paths: Public Goods Experiments in 134 Honduran Villages](https://arxiv.org/abs/2512.09316)
...
### [38] [Bayesian Model Selection with an Application to Cosmology](https://arxiv.org/abs/2512.09724)
*Nikoloz Gigiberia*
...
### [39] [Network Meta Analysis of Mean Survival](https://arxiv.org/abs/2512.09732)
...
### [40] [New Algorithm for Structured OFDM Channel Estimation using Subgroup Duality](https://arxiv.org/abs/2512.08947)
...
### [41] [A New Particle Filter for Target Tracking in MIMO OFDM Integrated Sensing and Communications](https://arxiv.org/abs/2512.09098)
...
### [42] [A Hybrid Residue Floating Numerical Architecture for High Precision Arithmetic on FPGAs](https://arxiv.org/abs/2512.09155)
*Mostafa Darvishi*
...
### [43] [Secure Wireless Communication Using Distributed Coherent Transmission and Spatial Signal Decomposition](https://arxiv.org/abs/2512.09194)
...
### [44] [Joint Channel Estimation and Localization in Pinching-Antenna OFDM Systems: The Blessing of Multipath](https://arxiv.org/abs/2512.09432)
...
### [45] [Analytical and DNN-Aided Performance Evaluation of IRS-Assisted THz Communication Systems](https://arxiv.org/abs/2512.09515)
...
### [46] [CKM-Enabled Joint Spatial-Doppler Domain Clutter Suppression for Low-Altitude UAV ISAC](https://arxiv.org/abs/2512.09560)
...
### [47] [Flexible Reconfigurable Intelligent Surface-Aided Covert Communications in UAV Networks](https://arxiv.org/abs/2512.09714)
...
### [48] [Energy-Efficient Federated Learning with Relay-Assisted Aggregation in IIoT Networks](https://arxiv.org/abs/2512.09827)
...
### [49] [WTNN: Weibull-Tailored Neural Networks for survival analysis](https://arxiv.org/abs/2512.09163)
...
### [50] [Robust and Sparse Estimation of Unbounded Density Ratio under Heavy Contamination](https://arxiv.org/abs/2512.09266)
