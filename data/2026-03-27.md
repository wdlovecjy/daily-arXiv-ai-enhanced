...
### [1] [Analog Computing with Hybrid Couplers and Phase Shifters](https://arxiv.org/abs/2603.24604)
...
### [3] [Challenge-Response Authentication for LEO Satellite Channels: Exploiting Orbit-Specific Uniqueness](https://arxiv.org/abs/2603.25576)
...
### [4] [Intelligent Reflection as a Service (IRaaS): System Architecture, Enabling Technologies, and Deployment Strategy](https://arxiv.org/abs/2603.25593)
...
### [5] [A Ray-Based Characterization of Satellite-to-Urban Propagation](https://arxiv.org/abs/2603.25621)
...
### [6] [A Bayesian Gamma-power-mixture survival regression model: predicting the recurrence of prostate cancer post-prostatectomy](https://arxiv.org/abs/2603.25455)
...
### [10] [ReLope: KL-Regularized LoRA Probes for Multimodal LLM Routing](https://arxiv.org/abs/2603.24787)
...
### [11] [Resisting Humanization: Ethical Front-End Design Choices in AI for Sensitive Contexts](https://arxiv.org/abs/2603.24853)
...
### [22] [Distribution and Clusters Approximations as Abstract Domains in Probabilistic Abstract Interpretation to Neural Network Analysis](https://arxiv.org/abs/2603.25273)
...
### [24] [DAGverse: Building Document-Grounded Semantic DAGs from Scientific Papers](https://arxiv.org/abs/2603.25293)
...
### [25] [4OPS: Structural Difficulty Modeling in Integer Arithmetic Puzzles](https://arxiv.org/abs/2603.25356)
*Yunus E. Zeytuncu*
...
### [26] [Beyond Content Safety: Real-Time Monitoring for Reasoning Vulnerabilities in Large Language Models](https://arxiv.org/abs/2603.25412)
...
### [27] [Retraining as Approximate Bayesian Inference](https://arxiv.org/abs/2603.25480)
*Harrison Katz*
...
### [29] [Back to Basics: Revisiting ASR in the Age of Voice Agents](https://arxiv.org/abs/2603.25727)
...
### [30] [Learning Mesh-Free Discrete Differential Operators with Self-Supervised Graph Neural Networks](https://arxiv.org/abs/2603.24641)
...
### [31] [Can LLMs Beat Classical Hyperparameter Optimization Algorithms? A Study on autoresearch](https://arxiv.org/abs/2603.24647)
...
### [32] [Energy-Efficient Hierarchical Federated Anomaly Detection for the Internet of Underwater Things via Selective Cooperative Aggregation](https://arxiv.org/abs/2603.24648)
...
### [34] [Light Cones For Vision: Simple Causal Priors For Visual Hierarchy](https://arxiv.org/abs/2603.24753)
...
### [35] [CVA: Context-aware Video-text Alignment for Video Temporal Grounding](https://arxiv.org/abs/2603.24934)
...
### [36] [Epistemic Compression: The Case for Deliberate Ignorance in High-Stakes AI](https://arxiv.org/abs/2603.25033)
*Steffen Lukas*
...
### [37] [Layer-Specific Lipschitz Modulation for Fault-Tolerant Multimodal Representation Learning](https://arxiv.org/abs/2603.25103)
...
### [46] [Anchored-Branched Steady-state WInd Flow Transformer (AB-SWIFT): a metamodel for 3D atmospheric flow in urban environments](https://arxiv.org/abs/2603.25635)
...
### [47] [A Unified Memory Perspective for Probabilistic Trustworthy AI](https://arxiv.org/abs/2603.25692)
...
### [48] [Improving Infinitely Deep Bayesian Neural Networks with Nesterov's Accelerated Gradient Method](https://arxiv.org/abs/2603.25024)
...
### [49] [Fair regression under localized demographic parity constraints](https://arxiv.org/abs/2603.25224)
...
### [50] [Practical Efficient Global Optimization is No-regret](https://arxiv.org/abs/2603.25311)
...
### [51] [A Distribution-to-Distribution Neural Probabilistic Forecasting Framework for Dynamical Systems](https://arxiv.org/abs/2603.25370)
...
### [52] [Adaptive Subspace Modeling With Functional Tucker Decomposition](https://arxiv.org/abs/2603.25530)
