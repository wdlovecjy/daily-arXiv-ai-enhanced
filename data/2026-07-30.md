...
### [1] [Conformalized Rate-Adaptive Sensing](https://arxiv.org/abs/2607.26887)
...
### [2] [Origins and mitigation of double descent in reduced order modeling](https://arxiv.org/abs/2607.26414)
...
### [3] [Breaking the Curse with BAND: Nonparametric Distribution Estimation in High Dimensions](https://arxiv.org/abs/2607.26955)
...
### [4] [PIKS: Universal Physics-Informed Kernel Methods](https://arxiv.org/abs/2607.27062)
...
### [5] [Statistical Learning of Pediatric Mental Health-Related Emergency Department Visits Across COVID-19 Pandemic Periods](https://arxiv.org/abs/2607.26210)
...
### [6] [SWIPT-Enhanced Cell-Free Massive MIMO Networks](https://arxiv.org/abs/2607.26303)
...
### [7] [Joint Beamforming, Energy Management, and Trajectory Optimization for Figure-Eight Loitering in Solar-Powered HAPS-Enabled ISAC Systems](https://arxiv.org/abs/2607.26325)
...
### [8] [MVLA-GR: A Phase-Free Multipath-Based Geometry Reconstruction Method via Multi-View Likelihood Accumulation for ISAC](https://arxiv.org/abs/2607.26421)
...
### [9] [A Data-Driven Vibration Analysis Framework for Micro-Motor Fault Diagnosis and Quality Control](https://arxiv.org/abs/2607.26519)
...
### [10] [Stay or Switch: Online Conformal Bayesian Optimization Guided Fluid Antenna Configuration](https://arxiv.org/abs/2607.26547)
...
### [11] [Efficient Channel Prediction based on Gram-Square-Root Factorization using GMMs](https://arxiv.org/abs/2607.26959)
...
### [12] [Probabilistic Denoising-Enhanced ISAC for Stochastic Cluttered Mobile Environments](https://arxiv.org/abs/2607.26994)
...
### [13] [Two-Filter Adaptive Gaussian Mixture Smoothing for Nonlinear Systems](https://arxiv.org/abs/2607.27151)
...
### [14] [Probing the Origins of Reasoning Performance: Representational Quality for Mathematical Problem-Solving in RL vs. SFT Fine-Tuned Models](https://arxiv.org/abs/2607.26119)
...
### [15] [Even More Deception: Objective Misalignment in Mixed-Motive LLM Multi-Agent Systems](https://arxiv.org/abs/2607.26120)
...
### [17] [Position: Evaluation Scores Are Perishable Knowledge Claims](https://arxiv.org/abs/2607.26191)
...
### [18] [Exploring Structures in Physics Problems: Can AI Agents Discover Statistical Mechanical Mappings?](https://arxiv.org/abs/2607.26367)
...
### [19] [MultivationBench: A Benchmark for Multimodal Sequential Motivation Reasoning](https://arxiv.org/abs/2607.26465)
...
### [20] [Belief-Guided Decision Making with Uncertainty Gating in the Game of Go](https://arxiv.org/abs/2607.26946)
...
### [21] [On-Policy Distillation for LLM Safety: A Routing Approach to Template-Robust Realignment](https://arxiv.org/abs/2607.27081)
...
### [22] [AgentMap: Joint Equivalence and Subsumption Discovery for Ontology Matching](https://arxiv.org/abs/2607.27130)
...
### [23] [Linguistic Monoculture in LLM-Assisted Language Use](https://arxiv.org/abs/2607.27134)
...
### [26] [Emergent Sparsity in Frozen Random CNN Feature Extractors for Deep Reinforcement Learning](https://arxiv.org/abs/2607.26059)
*Scott M. Norton*
...
### [27] [Top-$k$ Pareto Bandits: Hypervolume Regret for Multi-Objective Slate Selection](https://arxiv.org/abs/2607.26273)
...
### [28] [High-Order Markov Blanket Discovery via a k-Order Relaxation of the Faithfulness Assumption](https://arxiv.org/abs/2607.26357)
...
### [29] [Meta-Learned Reward Shaping for Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2607.26094)
*Yunpeng Chu*
...
### [30] [Single-Beat Cuffless Blood Pressure Estimation Using Ear-PPG and ECG with a Lightweight Hybrid Learning Framework](https://arxiv.org/abs/2607.27076)
...
### [31] [Universality and Approximation Rates of Graph Neural Networks with Random Features](https://arxiv.org/abs/2607.26699)
...
### [32] [Weak-to-Strong On-Policy Distillation](https://arxiv.org/abs/2607.26246)
...
### [33] [Between Gradient and Natural Gradient: A Continuum of LoRA Initializations](https://arxiv.org/abs/2607.26247)
...
### [34] [Learning Implicit Causal World Models from Multi-Agent Demonstrations](https://arxiv.org/abs/2607.26336)
*Jasorsi Ghosh*
...
### [35] [MetaKoopman: Bayesian Meta-Learning of Koopman Operators for Modeling Structured Dynamics under Distribution Shifts](https://arxiv.org/abs/2607.26345)
...
### [36] [Post-Training at the Edge of Detectability: A Game-Theoretic Approach to Fine-Tuning](https://arxiv.org/abs/2607.26358)
...
### [37] [Flow Map Learning via Nongradient Vector Flow](https://arxiv.org/abs/2607.26398)
...
### [38] [SCOUT: Per-Context Reset Curricula for Sparse-Reward Reinforcement Learning](https://arxiv.org/abs/2607.26417)
...
### [39] [Learning Dynamic User Personas from Implicit Interaction Streams via Iterative Refinement](https://arxiv.org/abs/2607.26473)
*Haifeng Wu*
...
### [40] [From Conceptual Hydrologic Models to Conceptually Interpretable Neural Networks: A Snow-Water Mass-Conserving-Perceptron Framework for Discovering Catchment-Scale Precipitation-Storage-Runoff Representations](https://arxiv.org/abs/2607.26492)
...
### [41] [Collaborative Weighting with Pessimistic Critic for Mitigating Overestimation in Off-Policy Reinforcement Learning](https://arxiv.org/abs/2607.26509)
...
### [42] [HiFloat4 Format for End-To-End Reinforcement Learning Post-Training of Large Language Models](https://arxiv.org/abs/2607.26515)
...
### [43] [AgentGFM: A Graph Foundation Model with Node-Agent Information-Flow Control](https://arxiv.org/abs/2607.26533)
...
### [44] [Benchmarking ConvLSTM for One-Day-Ahead IMDAA Rainfall-Field Prediction across Four Indian Cities](https://arxiv.org/abs/2607.26581)
...
### [45] [Understanding Context Sampling in TabPFN on Small Tabular Datasets](https://arxiv.org/abs/2607.26628)
*Mohammed Abdullah*
...
### [46] [Mixture-of-experts for handwriting trajectory reconstruction from IMU sensors](https://arxiv.org/abs/2607.26708)
...
### [47] [Domain adaptation for handwriting trajectory reconstruction from IMU sensors](https://arxiv.org/abs/2607.26736)
...
### [48] [SkillRise: Agentic Reinforcement Learning for Cross-Task Skill Evolution](https://arxiv.org/abs/2607.26784)
...
### [49] [CalTwin: Towards Calibrated, Shift-Robust Medical World Models via Fisher-Information Regularisation](https://arxiv.org/abs/2607.26752)
...
### [50] [Budget-Aware LLM Discovery via Cost-Calibrated Frontier Utility](https://arxiv.org/abs/2607.26828)
...
### [51] [Forecasting Trajectory-Level Safety Risks in Black-Box Multi-Turn Interactions](https://arxiv.org/abs/2607.26820)
...
### [53] [Kairos: Numerically Robust News Recommendation under Item Cold-Start via Cholesky-based LinUCB](https://arxiv.org/abs/2607.26832)
*Finn Hertsch*
...
### [54] [Thinking Under Uncertainty: Evidence Use and Information-Seeking in Language Models](https://arxiv.org/abs/2607.26845)
...
### [55] [Parameter-Free Dynamic Regret for Online Convex Optimization under Heavy-Tailed Noise](https://arxiv.org/abs/2607.27073)
*Vaneet Aggarwal*
...
### [56] [TREA-Net: A Transferable Residual Epidemiological Adaptation Network for Dengue Incidence Forecasting](https://arxiv.org/abs/2607.26854)
...
### [57] [Cost-Sensitive Conformal Prediction and Human-in-the-Loop Abstention for Imbalanced High-Stakes Decision Support: A Multi-Domain Benchmark](https://arxiv.org/abs/2607.27143)
...
### [58] [Two Calls Beat Five Agents: Evaluating Multi-Agent Pipelines Against Self-Refinement for Local Language Models](https://arxiv.org/abs/2607.26922)
...
### [59] [Temporally Centered SIGReg Improves Multi-Task LeWorldModel Learning: From Analysis to Method](https://arxiv.org/abs/2607.26924)
...
### [60] [Surrogate assisted diversity estimation in neural ensemble search](https://arxiv.org/abs/2607.26940)
...
### [61] [What Can Latent World Models Know? Physical Parameter Identifiability in Multimodal Predictive Representations](https://arxiv.org/abs/2607.27017)
...
### [62] [TreeCCA: Canonical Correlation Analysis via Gradient-Boosted Trees](https://arxiv.org/abs/2607.27027)
*James Chapman*
...
### [63] [Sky sphere representation in language models](https://arxiv.org/abs/2607.27092)
...
### [64] [Voronoi Histograms for Adaptive Vectorization of Expected Persistence Diagrams](https://arxiv.org/abs/2607.27126)
...
### [65] [Skillful forecasting of offshore winds from satellite scatterometer constellations](https://arxiv.org/abs/2607.27152)
...
### [66] [When Do Learned Diffusion Proposals Help Constraint Solving? A Controlled Study on Continuous Algebraic Systems](https://arxiv.org/abs/2607.27169)
...
### [67] [Inverse Learning of Latent Risk-Neutral Densities from Irregular Option Quotes](https://arxiv.org/abs/2607.27188)
...
### [68] [Do You Really Need to Pretrain Q-Functions for Online RL Fine-Tuning?](https://arxiv.org/abs/2607.27203)
