...
### [3] [Neural Bayesian Sequential Routing](https://arxiv.org/abs/2605.26147)
*Yongchao Huang*
...
### [4] [Transfer Learning using 66 Diseases for Disease Forecasting Applications](https://arxiv.org/abs/2605.27269)
...
### [5] [Beyond Coefficients: Forecast-Necessity Testing for Interpretable Causal Discovery in Nonlinear Time-Series Models](https://arxiv.org/abs/2604.18751)
...
### [6] [When Rule Violations Are Rare: Chimera Training for Logical Anomaly Detection](https://arxiv.org/abs/2605.26171)
...
### [7] [Function-Valued Causal Influence in Nonlinear Time Series](https://arxiv.org/abs/2605.26408)
...
### [10] [More Expressive Feedforward Layers: Part I. Token-Adaptive Mixing of Activations](https://arxiv.org/abs/2605.26647)
...
### [11] [Max-Window Scale Estimation for Near-Lossless HiF8 W8A8 Quantization-Aware Training](https://arxiv.org/abs/2605.26189)
...
### [12] [Bilevel Optimization over Saddle Points of Zero-Sum Markov Games](https://arxiv.org/abs/2605.26654)
...
### [13] [HRVConformer: Neonatal Hypoxic-Ischemic Encephalopathy Classification from the Heart Rate signals](https://arxiv.org/abs/2605.26190)
...
### [14] [Model Merging on Loss Landscape: A Geometry Perspective](https://arxiv.org/abs/2605.26693)
...
### [15] [Modeling Dynamic Mixtures of Time-Delay Systems from Streaming Time Series](https://arxiv.org/abs/2605.26191)
...
### [16] [Agile Online Model Selection: Resolving Adaptation Lag via Safeguarded Large Learning Rates](https://arxiv.org/abs/2605.26919)
...
### [17] [Sampling Data with Chains of Forward-Backward Diffusion Steps](https://arxiv.org/abs/2605.27006)
...
### [18] [Mildly Overparameterized ReLU Networks on Orthogonal Data: Incremental Learning and Implicit Bias](https://arxiv.org/abs/2605.27097)
...
### [19] [Energy-Gated Attention and Wavelet Positional Encoding: Complementary Inductive Biases for Transformer Attention](https://arxiv.org/abs/2605.26355)
*Athanasios Zeris*
...
### [20] [The Role of Causal Features in Strategic Classification for Robustness and Alignment](https://arxiv.org/abs/2605.27163)
...
### [21] [Provably Communication-Efficient and Privacy-Preserving Federated Graph Neural Networks](https://arxiv.org/abs/2605.26243)
...
### [22] [Nonlinear Data Integration via Kernel Methods for Data Collaboration Analysis](https://arxiv.org/abs/2605.27219)
...
### [23] [Unified Neural Scaling Laws](https://arxiv.org/abs/2605.26248)
...
### [24] [Causal Risk Minimization for High-Dimensional Treatments](https://arxiv.org/abs/2605.27281)
...
### [25] [Detectability in Diversity: Improved Canary Crafting for Privacy Auditing in One Run](https://arxiv.org/abs/2605.27292)
...
### [27] [BASIS: Batchwise Advantage Estimation from Single-Rollout Information Sharing for LLM Reasoning](https://arxiv.org/abs/2605.27293)
...
### [29] [Classification and detection of multiple UAVs using rational Gaussian wavelet neural networks](https://arxiv.org/abs/2605.26310)
...
### [30] [Semigroup Consistency as a Diagnostic for Learned Physics Simulators](https://arxiv.org/abs/2605.26324)
*Lennon J. Shikhman*
...
### [31] [Reparametrizing Shampoo and SOAP for Subspace Basis Updates and BFloat16 Storage](https://arxiv.org/abs/2605.26327)
...
### [32] [QAM-W: Joint 2D Codebook Quantization for LLM Weights via Hadamard Rotation and Activation-Aware Scaling](https://arxiv.org/abs/2605.26339)
...
### [33] [When Correct Demonstrations Hurt: Rethinking the Role of Exemplars in In-Context Learning](https://arxiv.org/abs/2605.26350)
...
### [34] [Balancing Plasticity and Stability with Fast and Slow Successor Features](https://arxiv.org/abs/2605.26357)
...
### [35] [DDGAD: Trajectory Dynamics for Diffusion-Based Graph Anomaly Detection](https://arxiv.org/abs/2605.26446)
...
### [36] [MuCon: Clipped Muon Updates for LLM Training](https://arxiv.org/abs/2605.26459)
*Albert Yi*
...
### [37] [The Stability of Singular Distribution: A Spectral Perspective on the Two-Phase Dynamics of Language Model Pre-training](https://arxiv.org/abs/2605.26489)
...
### [39] [SIKA-GP: Accelerating Gaussian Process Inference with Sparse Inducing Kernel Approximations for Bayesian Deep Learning](https://arxiv.org/abs/2605.26509)
...
### [40] [Open-Weight LLM Fine-Tuning Defenses are Susceptible to Simple Attacks](https://arxiv.org/abs/2605.26526)
...
### [41] [Linear and Neural Dueling Bandits with Delayed Feedback](https://arxiv.org/abs/2605.26554)
...
### [43] [Beyond Holistic Models: Systematic Component-level Benchmarking of Deep Multivariate Time-Series Forecasting](https://arxiv.org/abs/2605.26562)
...
### [44] [Near-Optimal Regret in Adversarial Kernel Bandits](https://arxiv.org/abs/2605.26585)
...
### [45] [Geometry-Aware Contrastive Learning for Few-Shot Automatic Modulation Recognition](https://arxiv.org/abs/2605.26600)
...
### [46] [WINDQuant: Weight-Informed Neural Decision-Making for Global Mixed-Precision LLM Quantization](https://arxiv.org/abs/2605.26660)
...
### [47] [Beyond Trajectory-Level Attribution: Graph-Based Credit Assignment for Agentic Reinforcement Learning](https://arxiv.org/abs/2605.26684)
...
### [48] [SL-BiLEM: Structured Learnable Behavior-in-the-Loop Epidemic Modeling for Forecasting and Policy Evaluation](https://arxiv.org/abs/2605.26704)
...
### [49] [MTL-FNO: A Lightweight Multi-Task Fourier Neural Operator for Sparse Field Reconstruction](https://arxiv.org/abs/2605.26718)
...
### [50] [Stabilizing Recurrent Dynamics for Test-Time Scalable Latent Reasoning in Looped Language Models](https://arxiv.org/abs/2605.26733)
...
### [51] [Adversarial Training for Robust Coverage Network under Worst-case Facility Losses](https://arxiv.org/abs/2605.26763)
...
### [52] [Latent Recurrent Transformer: Architecture Exploration, Training Strategies, and Scaling Behavior](https://arxiv.org/abs/2605.26797)
...
### [53] [Innovation: An Almost Characterization of Hallucination](https://arxiv.org/abs/2605.26808)
...
### [54] [Not All Disagreement Is Learnable: Token Teachability in On-Policy Distillation](https://arxiv.org/abs/2605.26844)
...
### [55] [EEG-FM-Audit: A Systematic Evaluation and Analysis Pipeline for EEG Foundation Models](https://arxiv.org/abs/2605.26910)
...
### [56] [RLVR Datasets and Where to Find Them: Tracing Data Lineage for Better Training Data](https://arxiv.org/abs/2605.26971)
...
### [57] [Convergence of Spectral Descent for Non-smooth Optimization](https://arxiv.org/abs/2605.26977)
...
### [58] [Learning Dynamic Graph Representations through Timespan View Contrasts](https://arxiv.org/abs/2605.27063)
...
### [59] [Trust Region Q Adjoint Matching](https://arxiv.org/abs/2605.27079)
...
### [60] [ReMoE: Boosting Expert Reuse through Router Fine-Tuning in Memory-Constrained MoE LLM Inference](https://arxiv.org/abs/2605.27081)
...
### [61] [Explainable Comparison of Feature-Based and Deep Learning Models for TROPOMI Methane Plume Screening](https://arxiv.org/abs/2605.27236)
...
### [62] [Guiding LLM Post-training Data Engineering with Model Internals from Sparse Autoencoders](https://arxiv.org/abs/2605.27354)
...
### [63] [MobileMoE: Scaling On-Device Mixture of Experts](https://arxiv.org/abs/2605.27358)
...
### [64] [Kan Extension Transformers: A Categorical Unification of Attention, Diffusion, and Predict-Detach Self-Conditioning](https://arxiv.org/abs/2605.27259)
*Sridhar Mahadevan*
...
### [65] [Normal Guidance is what Attention Needs](https://arxiv.org/abs/2605.27306)
...
### [66] [Greening AI Inference with Accuracy and Latency-aware User Incentives](https://arxiv.org/abs/2605.27309)
...
### [67] [Learning Nonlinear Factor Models with Unknown Monotone Links from Incomplete and Noisy Data](https://arxiv.org/abs/2605.26271)
...
### [68] [CART Random Forests as Sequential Allocation over Random Opportunity Sets: A Stochastic-Control Theory of Ensemble Risk](https://arxiv.org/abs/2605.26675)
...
### [69] [Constrained Bayesian Experimental Design via Online Planning](https://arxiv.org/abs/2605.26990)
...
### [70] [Gaussian Process-based learning with new MCMC-based implementation of Wishart prior on correlation matrix](https://arxiv.org/abs/2605.27093)
...
### [71] [Blind Channel Estimation and Data Detection for Near-Field XL-MIMO Systems](https://arxiv.org/abs/2605.26249)
...
### [72] [International Space Station operational modal analysis via iterative pole relocation](https://arxiv.org/abs/2605.26257)
...
### [73] [Unsupervised Learning for Scalable Downlink Power Control in Cell-Free Massive MIMO](https://arxiv.org/abs/2605.26301)
...
### [74] [Integrated Positioning and Communications for PASS: A Robust Approach](https://arxiv.org/abs/2605.26517)
...
### [75] [Receiver-Centric TDOA Localization Framework for DAB Signals under Synchronization Impairments](https://arxiv.org/abs/2605.26545)
...
### [76] [Multimodal Signal Restoration with Signed Twofold Graph Learning](https://arxiv.org/abs/2605.26760)
...
### [77] [Same Signal, Different Story: Demystifying Receiver Effects in Wi-Fi Channel State Information](https://arxiv.org/abs/2605.26836)
...
### [78] [Over-the-Air Successive Interference Cancellation for Efficient 5G NR and Wi-Fi Spectrum Reuse](https://arxiv.org/abs/2605.27005)
...
### [79] [Is Agent Memory a Database? Rethinking Data Foundations for Long-Term AI Agent Memory](https://arxiv.org/abs/2605.26252)
...
### [80] [Your Agents Are Aging Too: Agent Lifespan Engineering for Deployed Systems](https://arxiv.org/abs/2605.26302)
...
### [81] [OmniToM: Benchmarking Theory of Mind in LLMs via Explicit Belief Modeling](https://arxiv.org/abs/2605.26322)
...
### [83] [MobileExplorer: Accelerating On-Device Inference for Mobile GUI Agents via Online Exploration](https://arxiv.org/abs/2605.26546)
...
### [84] [Completion vs Optimality: Policy Gradient in Long-Horizon Cumulative-Damage Problems](https://arxiv.org/abs/2605.26657)
...
### [85] [MemFail: Stress-Testing Failure Modes of LLM Memory Systems](https://arxiv.org/abs/2605.26667)
...
### [86] [It's Not the Capability: Harness Sensitivity Is Non-Monotone Across LLM Agent Tiers](https://arxiv.org/abs/2605.26731)
*Yong-eun Cho*
...
### [87] [On the Detection of Commutative Factors in Factor Graphs: Necessary and Sufficient Conditions](https://arxiv.org/abs/2605.26908)
...
### [88] [Developing a Totally Unimodular Linear Program for Optimal Conformance Checking: When and Why It Complements A*](https://arxiv.org/abs/2605.26938)
*Izack Cohen*
...
### [89] [LELA: An End-to-end LLM-based Entity Linking Framework with Zero-shot Domain Adaptation](https://arxiv.org/abs/2605.26956)
...
### [91] [Position: AI Safety Requires Effective Controllability](https://arxiv.org/abs/2605.27117)
...
### [92] [Scaling, Benchmarking, and Reasoning of Vision-Language Agents for Mobile GUI Navigation](https://arxiv.org/abs/2605.27134)
...
### [93] [ICCU: In-Context Continual Unlearning via Pattern-Induced Refusal Rules](https://arxiv.org/abs/2605.27138)
...
### [95] [Modeling Agentic Technical Debt and Stochastic Tax: A Standalone Framework for Measurement, Simulation, and Dashboarding](https://arxiv.org/abs/2605.27320)
...
### [96] [2-ASP(Q) programs with weak constraints: Complexity and efficient implementation](https://arxiv.org/abs/2605.27338)
...
### [97] [Natural Language Query to Configuration for Retrieval Agents](https://arxiv.org/abs/2605.27361)
...
### [98] [MUSE-Autoskill: Self-Evolving Agents via Skill Creation, Memory, Management, and Evaluation](https://arxiv.org/abs/2605.27366)
...
### [99] [Small-Area Precipitation Forecasting and Drought--Flood Early Warning with Reverse-Martingale Regularized Recurrent Networks](https://arxiv.org/abs/2605.26401)
...
### [100] [Data-driven sparse identification of governing PDEs via knockoff filters and multi-criteria trade-offs](https://arxiv.org/abs/2605.26631)
...
### [101] [A warning system for risk prediction of metabolic syndrome in a healthy population of blood donors](https://arxiv.org/abs/2605.26843)
...
### [102] [Beyond average warming: Two-sample inference for dense-sparse functional data reveals changes in intraday temperature patterns](https://arxiv.org/abs/2605.27335)
