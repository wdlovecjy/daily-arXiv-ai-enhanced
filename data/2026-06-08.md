...
### [1] [An Integrated Roadside Sensing and Communication Framework for Vulnerable Road User Safety at Signalized Intersections](https://arxiv.org/abs/2606.07016)
*Parvez Anowar*
...
### [2] [Empirical Transfer Operators and Finite-Sample Change Detection for Noisy Expanding Interval Maps](https://arxiv.org/abs/2606.06785)
*Aparna Rajput*
...
### [5] [A Study of Parallel Continuous Local Search](https://arxiv.org/abs/2606.06656)
...
### [8] [Front-to-Attractors: Modifying the Front-to-Front Heuristic in Bidirectional Search](https://arxiv.org/abs/2606.07047)
...
### [9] [TOPSIS-RAD: Ranking According to Desires](https://arxiv.org/abs/2606.07253)
...
### [10] [Off-Policy Evaluation with Strategic Agents via Local Disclosure](https://arxiv.org/abs/2606.07308)
...
### [11] [How AI Agents Reshape Knowledge Work: Autonomy, Efficiency, and Scope](https://arxiv.org/abs/2606.07489)
...
### [12] [Variational Bayes Estimation for Affine-Precoded Superimposed Pilots in Partially Connected Dual-Wideband Tera-Hertz MU-MIMO Systems](https://arxiv.org/abs/2606.06672)
...
### [13] [Deep Learning Based Sparse Array Design with Pre-Steering for Adaptive Beamforming](https://arxiv.org/abs/2606.06723)
...
### [15] [TorchKM: A GPU-Oriented Library for Kernel Learning and Model Selection](https://arxiv.org/abs/2606.06742)
...
### [16] [Interpreting Learning Under Competing Models: Joint and Stepwise Approaches for Dynamic Cognitive Diagnosis](https://arxiv.org/abs/2606.06804)
...
### [17] [Explainable Runtime Dependency Tracking for AI-RAN Conflict Monitoring](https://arxiv.org/abs/2606.06663)
...
### [18] [Performance Variation in Deep Reinforcement Learning](https://arxiv.org/abs/2606.06746)
...
### [20] [Data-Constrained Language Model Pretraining: Improved Regularization and Scaling Laws](https://arxiv.org/abs/2606.06888)
...
### [21] [OffQ: Taming Structured Outliers in LLM Quantization by Offsetting](https://arxiv.org/abs/2606.07116)
...
### [22] [DEFINED: A Data-Efficient Computational Framework for Fine-Grained Creativity Assessment in Debate Scenarios](https://arxiv.org/abs/2606.07226)
...
### [23] [Beyond Linear and Overcomplete Regimes: A Mean-Field Analysis of Bottleneck Autoencoders](https://arxiv.org/abs/2606.07120)
...
### [24] [A Comprehensive Anatomy of Human and DeepSeek-R1 LLM Mathematical Reasoning](https://arxiv.org/abs/2606.07410)
...
### [25] [$α$-PFN: Fast Entropy Search via In-Context Learning](https://arxiv.org/abs/2606.07134)
...
### [26] [Sparse Subspace-to-Expert Sharing for Task-Agnostic Continual Learning](https://arxiv.org/abs/2606.07500)
...
### [27] [TabSwift: An Efficient Tabular Foundation Model with Row-Wise Attention](https://arxiv.org/abs/2606.07345)
...
### [28] [Sparsely gated tiny linear experts](https://arxiv.org/abs/2606.07414)
*Simon Schug*
...
### [29] [Second-Order Path Kernel Interpolation Formulas in Machine Learning](https://arxiv.org/abs/2606.07495)
...
### [30] [Accelerated Decentralized Stochastic Gradient Descent for Strongly Convex Optimization](https://arxiv.org/abs/2606.07496)
*Ming Sun,Kun Yuan*
