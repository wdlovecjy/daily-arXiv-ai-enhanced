...
### [1] [Pricing Global Macroeconomic Risk in Equity Markets: Evidence from Selected G20 Economies](https://arxiv.org/abs/2604.26198)
*Vivek Mishra*
...
### [2] [Improving Bias Correction Methods for Daily Rainfall Using a Markov Chain Approach](https://arxiv.org/abs/2604.26884)
...
### [7] [When to Vote, When to Rewrite: Disagreement-Guided Strategy Routing for Test-Time Scaling](https://arxiv.org/abs/2604.26644)
...
### [8] [Adversarial Robustness of NTK Neural Networks](https://arxiv.org/abs/2604.25965)
*Yuxuan Hou*
...
### [9] [Occam's Razor is Only as Sharp as Your ELBO](https://arxiv.org/abs/2604.25984)
...
### [10] [Probabilistic data quality assessment for structural monitoring data via outlier-resistant conditional diffusion model](https://arxiv.org/abs/2604.26366)
...
### [11] [Laplace Approximation for Bayesian Tensor Network Kernel Machines](https://arxiv.org/abs/2604.26673)
...
### [12] [Electricity price forecasting across Norway's five bidding zones in the post-crisis era](https://arxiv.org/abs/2604.26634)
...
### [13] [Open Problems in Frontier AI Risk Management](https://arxiv.org/abs/2604.25982)
...
### [14] [The Geometric Canary: Predicting Steerability and Detecting Drift via Representational Stability](https://arxiv.org/abs/2604.17698)
*Prashant C. Raju*
...
### [15] [RaMP: Runtime-Aware Megakernel Polymorphism for Mixture-of-Experts](https://arxiv.org/abs/2604.26039)
...
### [16] [Observable Neural ODEs for Identifiable Causal Forecasting in Continuous Time](https://arxiv.org/abs/2604.26070)
...
### [17] [A Note on How to Remove the $\ln\ln T$ Term from the Squint Bound](https://arxiv.org/abs/2604.26926)
*Francesco Orabona*
...
### [18] [Hyper Input Convex Neural Networks for Shape Constrained Learning and Optimal Transport](https://arxiv.org/abs/2604.26942)
...
### [21] [Super-resolution Multi-signal Direction-of-Arrival Estimation by Hankel-structured Sensing and Decomposition](https://arxiv.org/abs/2604.26793)
*Georgios I. Orfanidis,Dimitris A. Pados,George Sklivanitis,Elizabeth Serena Bentley*
...
### [22] [SWAN: World-Aware Adaptive Multimodal Networks for Runtime Variations](https://arxiv.org/abs/2604.26181)
...
### [28] [Layer-wise Lipschitz-Product Control for Deep Kolmogorov--Arnold Network Representations of Compositionally Structured Functions](https://arxiv.org/abs/2604.26444)
*Aleksander Tankman*
...
### [29] [Progressive Semantic Communication for Efficient Edge-Cloud Vision-Language Models](https://arxiv.org/abs/2604.26508)
...
### [30] [Understanding DNNs in Feature Interaction Models: A Dimensional Collapse Perspective](https://arxiv.org/abs/2604.26489)
...
### [31] [Random Cloud: Finding Minimal Neural Architectures Without Training](https://arxiv.org/abs/2604.26830)
*Javier Gil Blázquez*
...
### [32] [Large-scale semi-supervised learning with online spectral graph sparsification](https://arxiv.org/abs/2604.26550)
...
### [33] [PAINT: Partial-Solution Adaptive Interpolated Training for Self-Distilled Reasoners](https://arxiv.org/abs/2604.26573)
...
### [34] [Who Trains Matters: Federated Learning under Enrollment and Participation Selection Biases](https://arxiv.org/abs/2604.26604)
*Gota Morishita*
...
### [35] [A Multi-Dataset Benchmark of Multiple Instance Learning for 3D Neuroimage Classification](https://arxiv.org/abs/2604.26807)
...
### [37] [Planar Gaussian Splatting with Bilinear Spatial Transformer for Wireless Radiance Field Reconstruction](https://arxiv.org/abs/2604.25945)
...
### [38] [Blind OFDM-ISAC Relying on Asymmetric Modem Constellations](https://arxiv.org/abs/2604.26200)
...
### [39] [A Novel Reinforcement Learning Based Framework for Scalable MIMO Interference Alignment](https://arxiv.org/abs/2604.26414)
...
### [40] [SEP Analysis of Quantized SIMO Systems with M-PSK over Correlated Fading Channels](https://arxiv.org/abs/2604.26618)
...
### [41] [A New Location Estimator for Mixed LOS & NLOS scenarios](https://arxiv.org/abs/2604.26759)
...
### [42] [Multi-Modal Fiber Sensing for OffshoreEnvironmental and Infrastructure Monitoring](https://arxiv.org/abs/2604.26797)
...
### [43] [Optimizing Dynamic Metasurface Antenna Configurations for Direction-of-Arrival and Polarization Estimation Using an Experimentally Calibrated Multiport-Network Model](https://arxiv.org/abs/2604.26948)
