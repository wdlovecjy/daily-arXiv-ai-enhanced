...
### [1] [ADC-Aware End-to-End Optimization of a Dynamic Metasurface Antenna with Strong Mutual Coupling for Monostatic Scene Classification](https://arxiv.org/abs/2607.00253)
*Philipp del Hougne*
...
### [2] [B2X Networks: Joint Design of Communication and Control for Embodied Intelligence](https://arxiv.org/abs/2607.00537)
...
### [3] [Assessing Cardiac Dynamics through RF Sensing for Hemodynamic Monitoring in Pacemakers](https://arxiv.org/abs/2607.00791)
...
### [4] [Opportunistic Positioning with LEO Satellites based on SSB from NR NTN](https://arxiv.org/abs/2607.00967)
...
### [5] [Low-Complexity Sensing-Aware PAPR Reduction for AFDM-based ISAC Systems](https://arxiv.org/abs/2607.01064)
...
### [6] [Constructive Alignment: Governing Preference Dynamics in Human-AI Interaction](https://arxiv.org/abs/2607.00001)
...
### [7] [Bounded Morality: Defining the Space of Moral Computation](https://arxiv.org/abs/2607.00002)
...
### [8] [The MMM Data Model -- A Normative Specification for Knowledge Interoperability in a Decentralisable Knowledge Commons](https://arxiv.org/abs/2607.00032)
*Mathilde Noual*
...
### [9] [Solution space path planning for supporting en-route air traffic control](https://arxiv.org/abs/2607.00064)
...
### [11] [Seed2.0 Model Card: Towards Intelligence Frontier for Real-World Complexity](https://arxiv.org/abs/2607.00248)
*Bytedance Seed*
...
### [13] [PHREEQC-MCQ-200: A Diagnostic Benchmark for Tool-Augmented Scientific Simulator Agents](https://arxiv.org/abs/2607.00436)
...
### [14] [Multi-scale Mixture of World Models for Embodied Agents in Evolving Environments](https://arxiv.org/abs/2607.00457)
...
### [15] [AGI Maze as a Benchmark Framework for World-Modeling Agents](https://arxiv.org/abs/2607.00627)
*Alexey Potapov*
...
### [16] [Coachable agents for interactive gameplay](https://arxiv.org/abs/2607.00642)
...
### [17] [Self-GC: Self-Governing Context for Long-Horizon LLM Agents](https://arxiv.org/abs/2607.00692)
...
### [18] [Self-Evolving Agents with Anytime-Valid Certificates](https://arxiv.org/abs/2607.00871)
*Biswa Sengupta*
...
### [19] [PedNStream: Scalable Network Flow Simulation for Pedestrian Traffic Management](https://arxiv.org/abs/2607.01021)
...
### [21] [Theoria: Rewrite-Acceptability Verification over Informal Reasoning States](https://arxiv.org/abs/2607.01223)
...
### [22] [From Spectral Methods to Sample Complexity Bounds for Fourier Neural Operators](https://arxiv.org/abs/2607.00320)
...
### [23] [Hierarchical Variational Kalman Filtering](https://arxiv.org/abs/2607.00877)
...
### [24] [Characterizing and Identifying Separable Graphical Models](https://arxiv.org/abs/2607.01057)
...
### [25] [SemiScope: Disentangling Classifier Tuning and Joint Optimization in Semi-Supervised Security Classification](https://arxiv.org/abs/2607.00113)
...
### [26] [GRPO, Dr. GRPO, and DAPO Are Three Operations on One Number: The Group-Standard-Deviation Identity](https://arxiv.org/abs/2607.00152)
...
### [28] [Distributionally Robust Linear Regression With Block Lewis Weights](https://arxiv.org/abs/2607.00252)
...
### [29] [Verifiable Rewards for Calibrated Probabilistic Forecasting](https://arxiv.org/abs/2607.00164)
...
### [30] [Scaling Up Thermodynamic AI Models](https://arxiv.org/abs/2607.00170)
*Andrew G. Moore*
...
### [31] [TallyTrain: Communication-Efficient Federated Distillation](https://arxiv.org/abs/2607.00173)
...
### [32] [Which Metric Reflects the Spelling Rate Accuracy in Event-Related Potential-Based Brain-Computer Interfaces?](https://arxiv.org/abs/2607.00794)
...
### [33] [StateFlow: Dual-State Recurrent Modeling for Long-Horizon Time Series Forecasting](https://arxiv.org/abs/2607.00197)
...
### [34] [Learning dynamical systems from noisy data with Weak-form Kernel Ridge Regression](https://arxiv.org/abs/2607.00257)
...
### [35] [Testing Frontier Large Language Models' Physics Literacy in Parallel Physical Worlds](https://arxiv.org/abs/2607.00276)
*Dong Zhang*
...
### [36] [K-Inverse-RFM: A Modified RFM that Bridges the Gap to Neural Networks for Data-Corrupted Mathematical Tasks](https://arxiv.org/abs/2607.00329)
*Gil Pasternak*
...
### [37] [SAOT: Self-Supervised Continual Graph Learning with Structure-Aware Optimal Transport](https://arxiv.org/abs/2607.00377)
...
### [38] [Interpretable vs Learned Encoders for High-Cardinality Fraud Detection](https://arxiv.org/abs/2607.00477)
...
### [39] [PAPA: Online Personalized Active Preference Alignment](https://arxiv.org/abs/2607.00486)
...
### [40] [Decision-focused Sparse Tangent Portfolio Optimization](https://arxiv.org/abs/2607.00581)
...
### [41] [Loss Smoothing for Stable Adaptation Under Distribution Shift](https://arxiv.org/abs/2607.00634)
...
### [42] [Distributed Online Bandit Submodular Maximization with Bounded Sampling Violations](https://arxiv.org/abs/2607.00680)
...
### [43] [Detecting the Undetectable: Enhancing Unsupervised time series Anomaly Detection via Active Learning](https://arxiv.org/abs/2607.00720)
...
### [44] [MosaicKV: Serving Long-Context LLM with Dynamic Two-D KV Cache Compression](https://arxiv.org/abs/2607.00760)
...
### [45] [Valdi: Value Diffusion World Models](https://arxiv.org/abs/2607.00917)
...
### [46] [Local Motion Matters: A Deconstruct-Recompose Paradigm for Reinforcement Learning Pre-training from Videos](https://arxiv.org/abs/2607.00808)
...
### [47] [From Pixels to Temporal Correlations: Learning Informative Representations for Reinforcement Learning Pre-training](https://arxiv.org/abs/2607.00811)
...
### [48] [Spectroscopy Analysis with Machine Learning Regression for the Quantification of Carbon and Nitrogen Contents in Inceptisol and Oxisol Soil Types: Comparing Different Preprocessing and Validation methods as well as Feature Importance](https://arxiv.org/abs/2607.00834)
...
### [49] [Muon as a Residual Connection](https://arxiv.org/abs/2607.01124)
*Hao Huang*
...
### [50] [Language-Critique Imitation Learning from Suboptimal Demonstrations](https://arxiv.org/abs/2607.01225)
...
### [51] [Automatic Detection of Stress from Speech in the Trier Social Stress Test](https://arxiv.org/abs/2607.00986)
...
### [53] [ZO-Act: Efficient Zeroth-Order Fine-Tuning via One-Shot Activation-Informed Low-Rank Subspaces](https://arxiv.org/abs/2607.01125)
...
### [54] [GAIA: Geometry-Adaptive Operator Learning for Forward and Inverse Problems](https://arxiv.org/abs/2607.01128)
...
### [55] [Efficient Compression of Structured and Unstructured Volumes via Learned 3D Gaussian Representation](https://arxiv.org/abs/2607.01164)
...
### [56] [Spatio-Temporal Gaussian Process for Building Terrain-Incorporating Wind Power Curves](https://arxiv.org/abs/2607.00051)
...
### [57] [Waiting time analysis in a finite-capacity multi-server systems with dynamic priorities, dynamically evolving customer types, and abandonment](https://arxiv.org/abs/2607.00230)
...
### [58] [Economic Disparities and Their Relationship to Destructive Health Behaviors in Five Western U.S. States](https://arxiv.org/abs/2607.00317)
...
### [59] [Coupling Precipitation Forecasting and Early Warning with Reverse-Martingale Recurrent Neural Networks](https://arxiv.org/abs/2607.00331)
