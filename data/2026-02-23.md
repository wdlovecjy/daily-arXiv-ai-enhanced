...
### [1] [The Token Games: Evaluating Language Model Reasoning with Puzzle Duels](https://arxiv.org/abs/2602.17831)
...
### [2] [Alignment in Time: Peak-Aware Orchestration for Long-Horizon Agentic Systems](https://arxiv.org/abs/2602.17910)
...
### [3] [SOMtime the World Ain$'$t Fair: Violating Fairness Using Self-Organizing Maps](https://arxiv.org/abs/2602.18201)
...
### [4] [A context-specific causal model for estimating the effect of extended length of overnight stay on traveller's total expenditure](https://arxiv.org/abs/2602.18039)
...
### [5] [Box Thirding: Anytime Best Arm Identification under Insufficient Sampling](https://arxiv.org/abs/2602.18186)
...
### [6] [Driving-Over Detection in the Railway Environment](https://arxiv.org/abs/2602.17745)
...
### [7] [Learning While Transmitting: Pilotless Polar Coded Modulation for Short Packet Transmission](https://arxiv.org/abs/2602.17979)
...
### [8] [Joint Multi-User Tracking and Signal Detection in Reconfigurable Intelligent Surface-Assisted Cell-Free ISAC Systems](https://arxiv.org/abs/2602.18018)
...
### [11] [MD-AirComp+: Adaptive Quantization for Blind Massive Digital Over-the-Air Computation](https://arxiv.org/abs/2602.18332)
...
### [12] [Modeling UAV-aided Roadside Cell-Free Networks with Matérn Hard-Core Point Processes](https://arxiv.org/abs/2602.18408)
...
### [15] [Optimal Multi-Debris Mission Planning in LEO: A Deep Reinforcement Learning Approach with Co-Elliptic Transfers and Refueling](https://arxiv.org/abs/2602.17685)
...
### [16] [Provable Adversarial Robustness in In-Context Learning](https://arxiv.org/abs/2602.17743)
*Di Zhang*
...
### [17] [Robust Pre-Training of Medical Vision-and-Language Models with Domain-Invariant Multi-Modal Masked Reconstruction](https://arxiv.org/abs/2602.17689)
...
### [19] [Agentic Unlearning: When LLM Agent Meets Machine Unlearning](https://arxiv.org/abs/2602.17692)
...
### [20] [A Case Study of Selected PTQ Baselines for Reasoning LLMs on Ascend NPU](https://arxiv.org/abs/2602.17693)
...
### [25] [MantisV2: Closing the Zero-Shot Gap in Time Series Classification with Synthetic Data and Test-Time Strategies](https://arxiv.org/abs/2602.17868)
...
### [26] [Machine Learning Based Prediction of Surgical Outcomes in Chronic Rhinosinusitis from Clinical Data](https://arxiv.org/abs/2602.17888)
...
### [28] [Asking Forever: Universal Activations Behind Turn Amplification in Conversational LLMs](https://arxiv.org/abs/2602.17778)
...
### [30] [Optimizing Graph Causal Classification Models: Estimating Causal Effects and Addressing Confounders](https://arxiv.org/abs/2602.17941)
...
### [31] [Calibrated Adaptation: Bayesian Stiefel Manifold Priors for Reliable Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2602.17809)
...
### [33] [MePoly: Max Entropy Polynomial Policy Optimization](https://arxiv.org/abs/2602.17832)
...
### [34] [Influence-Preserving Proxies for Gradient-Based Data Selection in LLM Fine-tuning](https://arxiv.org/abs/2602.17835)
...
### [35] [Flow Actor-Critic for Offline Reinforcement Learning](https://arxiv.org/abs/2602.18015)
...
### [36] [Dual Length Codes for Lossless Compression of BFloat16](https://arxiv.org/abs/2602.17849)
...
### [38] [Neural Prior Estimation: Learning Class Priors from Latent Representations](https://arxiv.org/abs/2602.17853)
...
### [39] [JAX-Privacy: A library for differentially private machine learning](https://arxiv.org/abs/2602.17861)
...
### [41] [ADAPT: Hybrid Prompt Optimization for LLM Feature Visualization](https://arxiv.org/abs/2602.17867)
...
### [42] [Decoding as Optimisation on the Probability Simplex: From Top-K to Top-P (Nucleus) to Best-of-K Samplers](https://arxiv.org/abs/2602.18292)
...
### [45] [Bayesian Online Model Selection](https://arxiv.org/abs/2602.17958)
...
### [46] [Whole-Brain Connectomic Graph Model Enables Whole-Body Locomotion Control in Fruit Fly](https://arxiv.org/abs/2602.17997)
...
### [47] [Asynchronous Heavy-Tailed Optimization](https://arxiv.org/abs/2602.18002)
...
### [48] [Deepmechanics](https://arxiv.org/abs/2602.18060)
...
### [49] [Non-Stationary Online Resource Allocation: Learning from a Single Sample](https://arxiv.org/abs/2602.18114)
...
### [50] [Learning Long-Range Dependencies with Temporal Predictive Coding](https://arxiv.org/abs/2602.18131)
...
### [51] [Advection-Diffusion on Graphs: A Bakry-Emery Laplacian for Spectral Graph Neural Networks](https://arxiv.org/abs/2602.18141)
...
### [52] [Unifying Formal Explanations: A Complexity-Theoretic Perspective](https://arxiv.org/abs/2602.18160)
...
### [53] [RAT+: Train Dense, Infer Sparse -- Recurrence Augmented Attention for Dilated Inference](https://arxiv.org/abs/2602.18196)
...
### [54] [Parameter-Efficient Domain Adaptation of Physics-Informed Self-Attention based GNNs for AC Power Flow Prediction](https://arxiv.org/abs/2602.18227)
...
### [55] [MEG-to-MEG Transfer Learning and Cross-Task Speech/Silence Detection with Limited Data](https://arxiv.org/abs/2602.18253)
...
### [57] [Assigning Confidence: K-partition Ensembles](https://arxiv.org/abs/2602.18435)
