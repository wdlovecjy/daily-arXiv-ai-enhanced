...
### [3] [Variance Computation for Weighted Model Counting with Knowledge Compilation Approach](https://arxiv.org/abs/2601.03523)
...
### [4] [STAR-S: Improving Safety Alignment through Self-Taught Reasoning on Safety Rules](https://arxiv.org/abs/2601.03537)
...
### [5] [SCRIBE: Structured Mid-Level Supervision for Tool-Using Language Models](https://arxiv.org/abs/2601.03555)
...
### [6] [Controllable LLM Reasoning via Sparse Autoencoder-Based Steering](https://arxiv.org/abs/2601.03595)
...
### [7] [Architecting Agentic Communities using Design Patterns](https://arxiv.org/abs/2601.03624)
...
### [10] [EntroCoT: Enhancing Chain-of-Thought via Adaptive Entropy-Guided Segmentation](https://arxiv.org/abs/2601.03769)
...
### [12] [Investigating the Grounding Bottleneck for a Large-Scale Configuration Problem: Existing Tools and Constraint-Aware Guessing](https://arxiv.org/abs/2601.03850)
...
### [13] [Agent Drift: Quantifying Behavioral Degradation in Multi-Agent LLM Systems Over Extended Interactions](https://arxiv.org/abs/2601.04170)
*Abhishek Rath*
...
### [14] [Microeconomic Foundations of Multi-Agent Learning](https://arxiv.org/abs/2601.03451)
*Nassim Helou*
...
### [15] [Online Learning with Limited Information in the Sliding Window Model](https://arxiv.org/abs/2601.03533)
...
### [16] [A Theoretical and Empirical Taxonomy of Imbalance in Binary Classification](https://arxiv.org/abs/2601.04149)
...
### [18] [Ratio-Variance Regularized Policy Optimization for Efficient LLM Fine-tuning](https://arxiv.org/abs/2601.03320)
...
### [19] [A Gap Between Decision Trees and Neural Networks](https://arxiv.org/abs/2601.03919)
*Akash Kumar*
...
### [20] [LUT-KAN: Segment-wise LUT Quantization for Fast KAN Inference](https://arxiv.org/abs/2601.03332)
*Oleksandr Kuznetsov*
...
### [21] [Sensor to Pixels: Decentralized Swarm Gathering via Image-Based Reinforcement Learning](https://arxiv.org/abs/2601.03413)
...
### [26] [Variational Inference, Entropy, and Orthogonality: A Unified Theory of Mixture-of-Experts](https://arxiv.org/abs/2601.03577)
*Ye Su,Yong Liu*
...
### [27] [ALERT: Zero-shot LLM Jailbreak Detection via Internal Discrepancy Amplification](https://arxiv.org/abs/2601.03600)
...
### [28] [Learning Shortest Paths When Data is Scarce](https://arxiv.org/abs/2601.03629)
...
### [29] [Kantorovich-Type Stochastic Neural Network Operators for the Mean-Square Approximation of Certain Second-Order Stochastic Processes](https://arxiv.org/abs/2601.03634)
...
### [30] [ReLA: Representation Learning and Aggregation for Job Scheduling with Reinforcement Learning](https://arxiv.org/abs/2601.03646)
...
### [31] [In Search of Grandmother Cells: Tracing Interpretable Neurons in Tabular Representations](https://arxiv.org/abs/2601.03657)
...
### [32] [Group and Exclusive Sparse Regularization-based Continual Learning of CNNs](https://arxiv.org/abs/2601.03658)
...
### [33] [AMIR-GRPO: Inducing Implicit Preference Signals into GRPO](https://arxiv.org/abs/2601.03661)
...
### [34] [Stochastic Voronoi Ensembles for Anomaly Detection](https://arxiv.org/abs/2601.03664)
*Yang Cao*
...
### [35] [Rethinking Recurrent Neural Networks for Time Series Forecasting: A Reinforced Recurrent Encoder with Prediction-Oriented Proximal Policy Optimization](https://arxiv.org/abs/2601.03683)
...
### [36] [The Geometry of the Pivot: A Note on Lazy Pivoted Cholesky and Farthest Point Sampling](https://arxiv.org/abs/2601.03706)
*Gil Shabat*
...
### [37] [R$^3$L: Reflect-then-Retry Reinforcement Learning with Language-Guided Exploration, Pivotal Credit, and Positive Amplification](https://arxiv.org/abs/2601.03715)
...
### [38] [Probabilistic Transformers for Joint Modeling of Global Weather Dynamics and Decision-Centric Variables](https://arxiv.org/abs/2601.03753)
...
### [39] [Improving Compactness and Reducing Ambiguity of CFIRE Rule-Based Explanations](https://arxiv.org/abs/2601.03776)
...
### [40] [FOREVER: Forgetting Curve-Inspired Memory Replay for Language Model Continual Learning](https://arxiv.org/abs/2601.03938)
...
### [41] [Stage-specific cancer survival prediction enriched by explainable machine learning](https://arxiv.org/abs/2601.03977)
...
### [42] [Modeling Behavioral Patterns in News Recommendations Using Fuzzy Neural Networks](https://arxiv.org/abs/2601.04019)
...
### [43] [Clinical Data Goes MEDS? Let's OWL make sense of it](https://arxiv.org/abs/2601.04164)
...
### [44] [Agentic Rubrics as Contextual Verifiers for SWE Agents](https://arxiv.org/abs/2601.04171)
...
### [45] [Lightweight Test-Time Adaptation for EMG-Based Gesture Recognition](https://arxiv.org/abs/2601.04181)
...
### [46] [Intensity Fluctuation Dynamics in XPM](https://arxiv.org/abs/2601.03527)
...
### [47] [Zak-OTFS ISAC with Bistatic Sensing via Semi-Blind Atomic Norm Denoising Scheme](https://arxiv.org/abs/2601.03639)
...
### [48] [Cramer-Rao Bound for Angle of Arrival Estimates in True-Time-Delay Systems](https://arxiv.org/abs/2601.03735)
