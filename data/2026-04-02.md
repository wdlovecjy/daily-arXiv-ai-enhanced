...
### [1] [A Rank-Based Information Fusion Framework for Comparing Clustered Multivariate Socioeconomic Outcomes](https://arxiv.org/abs/2604.00330)
*Dhrubajyoti Ghosh*
...
### [2] [Feature Reconstruction and Monitoring of Load Test Data under Varying Environmental Conditions](https://arxiv.org/abs/2604.00662)
...
### [3] [Inverse-Free Sparse Variational Gaussian Processes](https://arxiv.org/abs/2604.00697)
...
### [4] [Learning Compact Terrain-Context Representations for Feasibility-Aware Offline Reinforcement Learning in UAV Relaying Networks](https://arxiv.org/abs/2604.00224)
...
### [10] [Unsupervised End-to-End Array Calibration for Multi-Target Integrated Sensing and Communication](https://arxiv.org/abs/2604.00806)
...
### [11] [Novel Single Clad Ho-doped Fiber with High Slope Efficiency and Low Ion Pairing](https://arxiv.org/abs/2604.00823)
...
### [12] [Spatial Upper Bound of Radiated Power in Active Antenna Systems](https://arxiv.org/abs/2604.00846)
...
### [13] [DOA Estimation for Low-Altitude Networks: HAD Architectures, Methods, and Challenges](https://arxiv.org/abs/2604.00864)
...
### [14] [Open, Reliable, and Collective: A Community-Driven Framework for Tool-Using AI Agents](https://arxiv.org/abs/2604.00137)
...
### [15] [A Safety-Aware Role-Orchestrated Multi-Agent LLM Framework for Behavioral Health Communication Simulation](https://arxiv.org/abs/2604.00249)
*Ha Na Cho*
...
### [16] [Improvisational Games as a Benchmark for Social Intelligence of AI Agents: The Case of Connections](https://arxiv.org/abs/2604.00284)
...
### [17] [Signals: Trajectory Sampling and Triage for Agentic Interactions](https://arxiv.org/abs/2604.00356)
...
### [18] [In harmony with gpt-oss](https://arxiv.org/abs/2604.00362)
*Borislav Mavrin*
...
### [22] [Ontology-Constrained Neural Reasoning in Enterprise Agentic Systems: A Neurosymbolic Architecture for Domain-Grounded AI Agents](https://arxiv.org/abs/2604.00555)
*Thanh Luong Tuan*
...
### [23] [CircuitProbe: Predicting Reasoning Circuits in Transformers via Stability Zone Detection](https://arxiv.org/abs/2604.00716)
*Rajkiran Panuganti*
...
### [24] [UK AISI Alignment Evaluation Case-Study](https://arxiv.org/abs/2604.00788)
...
### [26] [OmniMem: Autoresearch-Guided Discovery of Lifelong Multimodal Agent Memory](https://arxiv.org/abs/2604.01007)
...
### [27] [Detecting Multi-Agent Collusion Through Multi-Agent Interpretability](https://arxiv.org/abs/2604.01151)
...
### [31] [ParetoBandit: Budget-Paced Adaptive Routing for Non-Stationary LLM Serving](https://arxiv.org/abs/2604.00136)
...
### [32] [Epileptic Seizure Detection in Separate Frequency Bands Using Feature Analysis and Graph Convolutional Neural Network (GCN) from Electroencephalogram (EEG) Signals](https://arxiv.org/abs/2604.00163)
...
### [34] [Lévy-Flow Models: Heavy-Tail-Aware Normalizing Flows for Financial Risk Management](https://arxiv.org/abs/2604.00195)
*Rachid Drissi*
...
### [35] [Lead Zirconate Titanate Reservoir Computing for Classification of Written and Spoken Digits](https://arxiv.org/abs/2604.00207)
...
### [36] [Measuring the Representational Alignment of Neural Systems in Superposition](https://arxiv.org/abs/2604.00208)
...
### [37] [Diversity-Aware Reverse Kullback-Leibler Divergence for Large Language Model Distillation](https://arxiv.org/abs/2604.00223)
...
### [38] [Hierarchical Apprenticeship Learning from Imperfect Demonstrations with Evolving Rewards](https://arxiv.org/abs/2604.00258)
...
### [39] [Learning to Shuffle: Block Reshuffling and Reversal Schemes for Stochastic Optimization](https://arxiv.org/abs/2604.00260)
...
### [40] [The Persistent Vulnerability of Aligned AI Systems](https://arxiv.org/abs/2604.00324)
*Aengus Lynch*
...
### [42] [Convergence of Byzantine-Resilient Gradient Tracking via Probabilistic Edge Dropout](https://arxiv.org/abs/2604.00449)
...
### [44] [MF-QAT: Multi-Format Quantization-Aware Training for Elastic Inference](https://arxiv.org/abs/2604.00529)
...
### [45] [Learning Shared Representations for Multi-Task Linear Bandits](https://arxiv.org/abs/2604.00531)
...
### [46] [Predicting Dynamics of Ultra-Large Complex Systems by Inferring Governing Equations](https://arxiv.org/abs/2604.00599)
...
### [47] [Spectral Compact Training: Pre-Training Large Language Models via Permanent Truncated SVD and Stiefel QR Retraction](https://arxiv.org/abs/2604.00733)
...
### [49] [Scalable Pretraining of Large Mixture of Experts Language Models on Aurora Super Computer](https://arxiv.org/abs/2604.00785)
...
### [50] [Routing-Free Mixture-of-Experts](https://arxiv.org/abs/2604.00801)
...
### [53] [Transfer learning for nonparametric Bayesian networks](https://arxiv.org/abs/2604.01021)
...
### [55] [Screening Is Enough](https://arxiv.org/abs/2604.01178)
*Ken M. Nakanishi*
...
### [56] [MIRANDA: MId-feature RANk-adversarial Domain Adaptation toward climate change-robust ecological forecasting with deep learning](https://arxiv.org/abs/2604.00800)
...
### [57] [The Recipe Matters More Than the Kitchen:Mathematical Foundations of the AI Weather Prediction Pipeline](https://arxiv.org/abs/2604.01215)
...
### [58] [Cost-Penalized Fitness in FMA-Orchestrated Mixture of Experts: Experimental Evidence for Molecular Memory in Domain Adaptation](https://arxiv.org/abs/2604.00812)
*Martin Jaraiz*
...
### [59] [LAtent Phase Inference from Short time sequences using SHallow REcurrent Decoders (LAPIS-SHRED)](https://arxiv.org/abs/2604.01216)
...
### [60] [Optimal Brain Decomposition for Accurate LLM Low-Rank Approximation](https://arxiv.org/abs/2604.00821)
...
### [61] [Policy Improvement Reinforcement Learning](https://arxiv.org/abs/2604.00860)
...
### [62] [Differentially Private Manifold Denoising](https://arxiv.org/abs/2604.00942)
...
### [63] [EmbedPart: Embedding-Driven Graph Partitioning for Scalable Graph Neural Network Training](https://arxiv.org/abs/2604.01000)
...
### [64] [Reconsidering Dependency Networks from an Information Geometry Perspective](https://arxiv.org/abs/2604.01117)
...
### [65] [Reasoning Shift: How Context Silently Shortens LLM Reasoning](https://arxiv.org/abs/2604.01161)
*Gleb Rodionov*
