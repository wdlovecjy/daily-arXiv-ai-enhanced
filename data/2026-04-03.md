...
### [2] [Test-Time Scaling Makes Overtraining Compute-Optimal](https://arxiv.org/abs/2604.01411)
...
### [3] [DDCL-INCRT: A Self-Organising Transformer with Hierarchical Prototype Structure (Theoretical Foundations)](https://arxiv.org/abs/2604.01880)
...
### [9] [Benchmark Problems and Benchmark Datasets for the evaluation of Machine and Deep Learning methods on Photoplethysmography signals: the D4 report from the QUMPHY project](https://arxiv.org/abs/2604.01398)
...
### [10] [Matching Accuracy, Different Geometry: Evolution Strategies vs GRPO in LLM Post-Training](https://arxiv.org/abs/2604.01499)
...
### [11] [Beyond Logit Adjustment: A Residual Decomposition Framework for Long-Tailed Reranking](https://arxiv.org/abs/2604.01506)
...
### [12] [Variational LSTM with Augmented Inputs: Nonlinear Response History Metamodeling with Aleatoric and Epistemic Uncertainty](https://arxiv.org/abs/2604.01587)
...
### [13] [Optimizing EEG Graph Structure for Seizure Detection: An Information Bottleneck and Self-Supervised Learning Approach](https://arxiv.org/abs/2604.01595)
...
### [14] [Pseudo-Quantized Actor-Critic Algorithm for Robustness to Noisy Temporal Difference Error](https://arxiv.org/abs/2604.01613)
*Taisuke Kobayashi*
...
### [15] [MiCA Learns More Knowledge Than LoRA and Full Fine-Tuning](https://arxiv.org/abs/2604.01694)
...
### [16] [Bridging Deep Learning and Integer Linear Programming: A Predictive-to-Prescriptive Framework for Supply Chain Analytics](https://arxiv.org/abs/2604.01775)
...
### [17] [Graph Neural Operator Towards Edge Deployability and Portability for Sparse-to-Dense, Real-Time Virtual Sensing on Irregular Grids](https://arxiv.org/abs/2604.01802)
...
### [18] [Physics Informed Reinforcement Learning with Gibbs Priors for Topology Control in Power Grids](https://arxiv.org/abs/2604.01830)
...
### [19] [CANDI: Curated Test-Time Adaptation for Multivariate Time-Series Anomaly Detection Under Distribution Shift](https://arxiv.org/abs/2604.01845)
...
### [20] [Towards Intrinsically Calibrated Uncertainty Quantification in Industrial Data-Driven Models via Diffusion Sampler](https://arxiv.org/abs/2604.01870)
...
### [21] [Robust Graph Representation Learning via Adaptive Spectral Contrast](https://arxiv.org/abs/2604.01878)
...
### [22] [LI-DSN: A Layer-wise Interactive Dual-Stream Network for EEG Decoding](https://arxiv.org/abs/2604.01889)
...
### [23] [Feature Weighting Improves Pool-Based Sequential Active Learning for Regression](https://arxiv.org/abs/2604.02019)
*Dongrui Wu*
...
### [24] [AA-SVD : Anchored and Adaptive SVD for Large Language Model Compression](https://arxiv.org/abs/2604.02119)
...
### [25] [Neural network methods for two-dimensional finite-source reflector design](https://arxiv.org/abs/2604.02184)
...
### [26] [Model-Based Reinforcement Learning for Control under Time-Varying Dynamics](https://arxiv.org/abs/2604.02260)
...
### [27] [SKILL0: In-Context Agentic Reinforcement Learning for Skill Internalization](https://arxiv.org/abs/2604.02268)
...
### [28] [Unifying Group-Relative and Self-Distillation Policy Optimization via Sample Routing](https://arxiv.org/abs/2604.02288)
...
### [29] [Taming the Exponential: A Fast Softmax Surrogate for Integer-Native Edge Inference](https://arxiv.org/abs/2604.02292)
...
### [30] [Batched Contextual Reinforcement: A Task-Scaling Law for Efficient Reasoning](https://arxiv.org/abs/2604.02322)
...
### [31] [The Digital Twin Counterfactual Framework: A Validation Architecture for Simulated Potential Outcomes](https://arxiv.org/abs/2604.01325)
*Olav Laudy*
...
### [32] [Semantic Modeling for World-Centered Architectures](https://arxiv.org/abs/2604.01359)
...
### [33] [Crashing Waves vs. Rising Tides: Preliminary Findings on AI Automation from Thousands of Worker Evaluations of Labor Market Tasks](https://arxiv.org/abs/2604.01363)
...
### [34] [CogBias: Measuring and Mitigating Cognitive Bias in Large Language Models](https://arxiv.org/abs/2604.01366)
...
### [35] [Leveraging the Value of Information in POMDP Planning](https://arxiv.org/abs/2604.01434)
...
### [36] [ClawSafety: "Safe" LLMs, Unsafe Agents](https://arxiv.org/abs/2604.01438)
...
### [37] [When AI Gets it Wong: Reliability and Risk in AI-Assisted Medication Decision Systems](https://arxiv.org/abs/2604.01449)
...
### [38] [Reducing Hallucinations in LLM-based Scientific Literature Analysis Using Peer Context Outlier Detection](https://arxiv.org/abs/2604.01461)
...
### [39] [A Self-Evolving Agentic Framework for Metasurface Inverse Design](https://arxiv.org/abs/2604.01480)
...
### [40] [AgentSocialBench: Evaluating Privacy Risks in Human-Centered Agentic Social Networks](https://arxiv.org/abs/2604.01487)
...
### [41] [A Role-Based LLM Framework for Structured Information Extraction from Healthy Food Policies](https://arxiv.org/abs/2604.01529)
...
### [46] [CRaFT: Circuit-Guided Refusal Feature Selection via Cross-Layer Transcoders](https://arxiv.org/abs/2604.01604)
...
### [47] [From Multi-Agent to Single-Agent: When Is Skill Distillation Beneficial?](https://arxiv.org/abs/2604.01608)
...
### [48] [Analysis of LLM Performance on AWS Bedrock: Receipt-item Categorisation Case Study](https://arxiv.org/abs/2604.01615)
...
### [56] [Probabilistic classification from possibilistic data: computing Kullback-Leibler projection with a possibility distribution](https://arxiv.org/abs/2604.01939)
...
### [57] [Qiana: A First-Order Formalism to Quantify over Contexts and Formulas with Temporality](https://arxiv.org/abs/2604.01952)
...
### [59] [MTI: A Behavior-Based Temperament Profiling System for AI Agents](https://arxiv.org/abs/2604.02145)
*Jihoon Jeong*
...
### [60] [TRU: Targeted Reverse Update for Efficient Multimodal Recommendation Unlearning](https://arxiv.org/abs/2604.02183)
...
### [62] [The Self Driving Portfolio: Agentic Architecture for Institutional Asset Management](https://arxiv.org/abs/2604.02279)
...
### [64] [Non-monotonicity in Conformal Risk Control](https://arxiv.org/abs/2604.01502)
...
### [65] [Random Coordinate Descent on the Wasserstein Space of Probability Measures](https://arxiv.org/abs/2604.01606)
*Yewei Xu,Qin Li*
...
### [66] [Learning in Prophet Inequalities with Noisy Observations](https://arxiv.org/abs/2604.01789)
...
### [68] [BVFLMSP : Bayesian Vertical Federated Learning for Multimodal Survival with Privacy](https://arxiv.org/abs/2604.02248)
...
### [69] [Opponent-Adjusted Evaluation of NFL Pass Blocking and Pass Rushing Performance](https://arxiv.org/abs/2604.01491)
...
### [70] [Correlation analysis of the dispersion of SARS-CoV-2 in Mexico](https://arxiv.org/abs/2604.01735)
...
### [71] [Country-wide, high-resolution monitoring of forest browning with Sentinel-2](https://arxiv.org/abs/2604.02074)
...
### [72] [Possible, Yes; Ignorant, Perhaps: A Scorecard for Possibilistic Forecasts](https://arxiv.org/abs/2604.02187)
*John R. Lawson*
...
### [73] [Interpretable Battery Aging without Extra Tests via Neural-Assisted Physics-based Modelling](https://arxiv.org/abs/2604.01229)
...
### [74] [Breaking Near-Field Communication Barriers: Focused, Curved, or Airy Beamforming?](https://arxiv.org/abs/2604.01704)
...
### [75] [Phase-Shifted Pilot Design for NOMA-Empowered Uplink ISAC Systems](https://arxiv.org/abs/2604.01721)
...
### [76] [Channel Measurements and Modeling based on Composite Environmental Factor for Urban Street-Canyon Intersections](https://arxiv.org/abs/2604.01767)
...
### [77] [MIMO Capacity Enhancement by Grating Walls: A Physics-Based Proof of Principle](https://arxiv.org/abs/2604.01786)
...
### [78] [Empirical and Statistical Characterisation of 28 GHz mmWave Propagation in Office Environments](https://arxiv.org/abs/2604.01814)
...
### [79] [Grey-Box Bayesian Optimization for ISAC in Fluid-Antenna Assisted Air-Ground Network](https://arxiv.org/abs/2604.02181)
...
### [80] [Evaluation of gNB Monostatic Sensing for UAV Use Case](https://arxiv.org/abs/2604.02205)
