...
### [1] [Statistical Inference for Explainable Boosting Machines](https://arxiv.org/abs/2601.18857)
...
### [2] [Implicit Q-Learning and SARSA: Liberating Policy Control from Step-Size Calibration](https://arxiv.org/abs/2601.18907)
...
### [3] [Collaborative Compressors in Distributed Mean Estimation with Limited Communication Budget](https://arxiv.org/abs/2601.18950)
...
### [4] [Regularized $f$-Divergence Kernel Tests](https://arxiv.org/abs/2601.19755)
...
### [12] [Balancing Sustainability And Performance: The Role Of Small-Scale Llms In Agentic Artificial Intelligence Systems](https://arxiv.org/abs/2601.19311)
...
### [13] [SETA: Statistical Fault Attribution for Compound AI Systems](https://arxiv.org/abs/2601.19337)
...
### [14] [PROTEUS: SLA-Aware Routing via Lagrangian RL for Multi-LLM Serving Systems](https://arxiv.org/abs/2601.19402)
...
### [15] [Benchmarks Saturate When The Model Gets Smarter Than The Judge](https://arxiv.org/abs/2601.19532)
...
### [16] [Learning Adaptive Parallel Execution for Efficient Code Localization](https://arxiv.org/abs/2601.19568)
...
### [18] [GAVEL: Towards rule-based safety through activation monitoring](https://arxiv.org/abs/2601.19768)
...
### [19] [CASTER: Breaking the Cost-Performance Barrier in Multi-Agent Orchestration via Context-Aware Strategy for Task Efficient Routing](https://arxiv.org/abs/2601.19793)
...
### [20] [Routing End User Queries to Enterprise Databases](https://arxiv.org/abs/2601.19825)
...
### [21] [Exponentially Consistent Low-Complexity Outlier Hypothesis Testing for Continuous Sequences](https://arxiv.org/abs/2601.19248)
*Lina Zhu,Lin Zhou*
...
### [22] [Stacked Intelligent Metasurfaces-Based Electromagnetic Wave Domain Interference-Free Precoding](https://arxiv.org/abs/2601.19313)
...
### [23] [Cooperative Double IRS aided Secure Communication for MIMO-OFDM Systems](https://arxiv.org/abs/2601.19366)
...
### [24] [AoI-Driven Queue Management and Power Control in V2V Networks: A GNN-Enhanced MARL Approach](https://arxiv.org/abs/2601.19372)
...
### [26] [Design of RIS-aided mMTC+ Networks for Rate Maximization under the Finite Blocklength Regime with Imperfect Channel Knowledge](https://arxiv.org/abs/2601.19523)
...
### [28] [Robust Design of Reconfigurable Intelligent Surfaces for Parameter Estimation in MTC](https://arxiv.org/abs/2601.19590)
...
### [29] [Cell-Free MIMO in Space: Cooperative Satellite Transmission with Multi-Antenna Ground Users](https://arxiv.org/abs/2601.19656)
...
### [30] [Maximum A Posteriori Probability Channel Tracking with an Intelligent Transmitting Surface](https://arxiv.org/abs/2601.19660)
...
### [31] [NavFormer: IGRF Forecasting in Moving Coordinate Frames](https://arxiv.org/abs/2601.18800)
...
### [32] [Latent Structural Similarity Networks for Unsupervised Discovery in Multivariate Time Series](https://arxiv.org/abs/2601.18803)
*Olusegun Owoeye*
...
### [33] [Time series forecasting with Hahn Kolmogorov-Arnold networks](https://arxiv.org/abs/2601.18837)
...
### [34] [FSD-CAP: Fractional Subgraph Diffusion with Class-Aware Propagation for Graph Feature Imputation](https://arxiv.org/abs/2601.18938)
...
### [35] [The Geometric Reasoner: Manifold-Informed Latent Foresight Search for Long-Context Reasoning](https://arxiv.org/abs/2601.18832)
...
### [36] [Vector-Valued Distributional Reinforcement Learning Policy Evaluation: A Hilbert Space Embedding Approach](https://arxiv.org/abs/2601.18952)
...
### [38] [Analysis of Control Bellman Residual Minimization for Markov Decision Problem](https://arxiv.org/abs/2601.18840)
...
### [42] [Intersectional Fairness via Mixed-Integer Optimization](https://arxiv.org/abs/2601.19595)
...
### [45] [Bi-Level Online Provisioning and Scheduling with Switching Costs and Cross-Level Constraints](https://arxiv.org/abs/2601.18936)
...
### [46] [A Few Bad Neurons: Isolating and Surgically Correcting Sycophancy](https://arxiv.org/abs/2601.18939)
...
### [47] [Accelerated training of Gaussian processes using banded square exponential covariances](https://arxiv.org/abs/2601.19007)
...
### [48] [Towards Self-Optimizing Electron Microscope: Robust Tuning of Aberration Coefficients via Physics-Aware Multi-Objective Bayesian Optimization](https://arxiv.org/abs/2601.18972)
...
### [49] [Attention-Enhanced Graph Filtering for False Data Injection Attack Detection and Localization](https://arxiv.org/abs/2601.18981)
...
### [50] [Save the Good Prefix: Precise Error Penalization via Process-Supervised RL to Enhance LLM Reasoning](https://arxiv.org/abs/2601.18984)
...
### [51] [Randomization Boosts KV Caching, Learning Balances Query Load: A Joint Perspective](https://arxiv.org/abs/2601.18999)
...
### [52] [Is Finer Better? The Limits of Microscaling Formats in Large Language Models](https://arxiv.org/abs/2601.19026)
...
### [53] [Unravelling the (In)compatibility of Statistical-Parity and Equalized-Odds](https://arxiv.org/abs/2601.19035)
...
### [54] [Speed is Confidence](https://arxiv.org/abs/2601.19085)
*Joshua V. Dillon*
...
### [55] [EPAS: Efficient Training with Progressive Activation Sharing](https://arxiv.org/abs/2601.19089)
...
### [56] [Native LLM and MLLM Inference at Scale on Apple Silicon](https://arxiv.org/abs/2601.19139)
*Wayner Barrios*
...
### [57] [A Scalable Inter-edge Correlation Modeling in CopulaGNN for Link Sign Prediction](https://arxiv.org/abs/2601.19175)
...
### [59] [Decoupled Split Learning via Auxiliary Loss](https://arxiv.org/abs/2601.19261)
...
### [61] [Robust Uncertainty Estimation under Distribution Shift via Difference Reconstruction](https://arxiv.org/abs/2601.19341)
...
### [66] [From Atoms to Chains: Divergence-Guided Reasoning Curriculum for Unlabeled LLM Domain Adaptation](https://arxiv.org/abs/2601.19588)
...
### [67] [GraphSB: Boosting Imbalanced Node Classification on Graphs through Structural Balance](https://arxiv.org/abs/2601.19352)
...
### [68] [Explicit Multi-head Attention for Inter-head Interaction in Large Language Models](https://arxiv.org/abs/2601.19611)
...
### [69] [Safe Exploration via Policy Priors](https://arxiv.org/abs/2601.19612)
...
### [73] [Fixed Aggregation Features Can Rival GNNs](https://arxiv.org/abs/2601.19449)
...
### [74] [The Geometric Mechanics of Contrastive Representation Learning: Alignment Potentials, Entropic Dispersion, and Cross-Modal Divergence](https://arxiv.org/abs/2601.19597)
...
### [75] [LoPRo: Enhancing Low-Rank Quantization via Permuted Block-Wise Rotation](https://arxiv.org/abs/2601.19675)
...
### [76] [Rethinking Divisive Hierarchical Clustering from a Distributional Perspective](https://arxiv.org/abs/2601.19718)
...
### [77] [Improving Policy Exploitation in Online Reinforcement Learning with Instant Retrospect Action](https://arxiv.org/abs/2601.19720)
...
### [78] [The Effect of Architecture During Continual Learning](https://arxiv.org/abs/2601.19766)
...
### [79] [Component-Aware Pruning Framework for Neural Network Controllers via Gradient-Based Importance Estimation](https://arxiv.org/abs/2601.19794)
...
### [80] [Calibration without Ground Truth](https://arxiv.org/abs/2601.19862)
...
### [81] [Post-LayerNorm Is Back: Stable, ExpressivE, and Deep](https://arxiv.org/abs/2601.19895)
*Chen Chen,Lai Wei*
...
### [82] [Embedding Birth-Death Processes within a Dynamic Stochastic Block Model](https://arxiv.org/abs/2601.19277)
...
### [83] [Adaptive L-tests for high dimensional independence](https://arxiv.org/abs/2601.19688)
