...
### [4] [Adaptive Semi-Supervised Training of P300 ERP-BCI Speller System with Minimum Calibration Effort](https://arxiv.org/abs/2602.15955)
...
### [5] [Feature-based morphological analysis of shape graph data](https://arxiv.org/abs/2602.16120)
...
### [6] [Distributed physics-informed neural networks via domain decomposition for fast flow reconstruction](https://arxiv.org/abs/2602.15883)
...
### [7] [Fast Online Learning with Gaussian Prior-Driven Hierarchical Unimodal Thompson Sampling](https://arxiv.org/abs/2602.15972)
...
### [8] [Anatomy of Capability Emergence: Scale-Invariant Representation Collapse and Top-Down Reorganization in Neural Networks](https://arxiv.org/abs/2602.15997)
*Jayadev Billa*
...
### [9] [Geometry-Aware Uncertainty Quantification via Conformal Prediction on Manifolds](https://arxiv.org/abs/2602.16015)
...
### [10] [Learning with Locally Private Examples by Inverse Weierstrass Private Stochastic Gradient Descent](https://arxiv.org/abs/2602.16436)
...
### [13] [Sequential Membership Inference Attacks](https://arxiv.org/abs/2602.16596)
...
### [15] [Muon with Spectral Guidance: Efficient Optimization for Scientific Machine Learning](https://arxiv.org/abs/2602.16167)
...
### [16] [Deep TPC: Temporal-Prior Conditioning for Time Series Forecasting](https://arxiv.org/abs/2602.16188)
...
### [17] [Rethinking Input Domains in Physics-Informed Neural Networks via Geometric Compactification Mappings](https://arxiv.org/abs/2602.16193)
...
### [19] [Geometric Neural Operators via Lie Group-Constrained Latent Dynamics](https://arxiv.org/abs/2602.16209)
...
### [20] [Graph neural network for colliding particles with an application to sea ice floe modeling](https://arxiv.org/abs/2602.16213)
*Ruibiao Zhu*
...
### [21] [Linked Data Classification using Neurochaos Learning](https://arxiv.org/abs/2602.16204)
...
### [22] [UCTECG-Net: Uncertainty-aware Convolution Transformer ECG Network for Arrhythmia Detection](https://arxiv.org/abs/2602.16216)
...
### [23] [A Graph Meta-Network for Learning on Kolmogorov-Arnold Networks](https://arxiv.org/abs/2602.16316)
...
### [24] [Multi-Class Boundary Extraction from Implicit Representations](https://arxiv.org/abs/2602.16217)
...
### [25] [Intra-Fairness Dynamics: The Bias Spillover Effect in Targeted LLM Alignment](https://arxiv.org/abs/2602.16438)
...
### [26] [Hardware-accelerated graph neural networks: an alternative approach for neuromorphic event-based audio classification and keyword spotting on SoC FPGA](https://arxiv.org/abs/2602.16442)
...
### [27] [SEMixer: Semantics Enhanced MLP-Mixer for Multiscale Mixing and Long-term Time Series Forecasting](https://arxiv.org/abs/2602.16220)
...
### [28] [AIFL: A Global Daily Streamflow Forecasting Model Using Deterministic LSTM Pre-trained on ERA5-Land and Fine-tuned on IFS](https://arxiv.org/abs/2602.16579)
...
### [29] [Prediction of Major Solar Flares Using Interpretable Class-dependent Reward Framework with Active Region Magnetograms and Domain Knowledge](https://arxiv.org/abs/2602.16264)
...
### [30] [Almost Sure Convergence of Differential Temporal Difference Learning for Average Reward Markov Decision Processes](https://arxiv.org/abs/2602.16629)
...
### [31] [Fast KV Compaction via Attention Matching](https://arxiv.org/abs/2602.16284)
...
### [32] [Explainability for Fault Detection System in Chemical Processes](https://arxiv.org/abs/2602.16341)
...
### [33] [Optical Inversion and Spectral Unmixing of Spectroscopic Photoacoustic Images with Physics-Informed Neural Networks](https://arxiv.org/abs/2602.16357)
...
### [34] [Improved Bounds for Reward-Agnostic and Reward-Free Exploration](https://arxiv.org/abs/2602.16363)
...
### [35] [Easy Data Unlearning Bench](https://arxiv.org/abs/2602.16400)
...
### [36] [Beyond SGD, Without SVD: Proximal Subspace Iteration LoRA with Diagonal Fractional K-FAC](https://arxiv.org/abs/2602.16456)
...
### [37] [HPMixer: Hierarchical Patching for Multivariate Time Series Forecasting](https://arxiv.org/abs/2602.16468)
...
### [38] [FEKAN: Feature-Enriched Kolmogorov-Arnold Networks](https://arxiv.org/abs/2602.16530)
...
### [39] [Transfer Learning of Linear Regression with Multiple Pretrained Models: Benefiting from More Pretrained Models via Overparameterization Debiasing](https://arxiv.org/abs/2602.16531)
...
### [40] [Vulnerability Analysis of Safe Reinforcement Learning via Inverse Constrained Reinforcement Learning](https://arxiv.org/abs/2602.16543)
...
### [41] [A Scalable Approach to Solving Simulation-Based Network Security Games](https://arxiv.org/abs/2602.16564)
...
### [42] [Predicting The Cop Number Using Machine Learning](https://arxiv.org/abs/2602.16600)
...
### [43] [Optimizer choice matters for the emergence of Neural Collapse](https://arxiv.org/abs/2602.16642)
...
### [44] [Factorization Machine with Quadratic-Optimization Annealing for RNA Inverse Folding and Evaluation of Binary-Integer Encoding and Nucleotide Assignment](https://arxiv.org/abs/2602.16643)
...
### [45] [Protecting the Undeleted in Machine Unlearning](https://arxiv.org/abs/2602.16697)
...
### [46] [Knowledge-Embedded Latent Projection for Robust Representation Learning](https://arxiv.org/abs/2602.16709)
...
### [47] [Optimization Instability in Autonomous Agentic Workflows for Clinical Symptom Detection](https://arxiv.org/abs/2602.16037)
...
### [48] [Learning Personalized Agents from Human Feedback](https://arxiv.org/abs/2602.16173)
...
### [49] [Revolutionizing Long-Term Memory in AI: New Horizons with High-Capacity and High-Speed Storage](https://arxiv.org/abs/2602.16192)
...
### [50] [Toward Scalable Verifiable Reward: Proxy State-Based Evaluation for Multi-turn Tool-Calling LLM Agents](https://arxiv.org/abs/2602.16246)
...
### [51] [Multi-agent cooperation through in-context co-player inference](https://arxiv.org/abs/2602.16301)
...
### [52] [Verifiable Semantics for Agent-to-Agent Communication](https://arxiv.org/abs/2602.16424)
...
### [53] [Causally-Guided Automated Feature Engineering with Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2602.16435)
...
### [54] [Leveraging Large Language Models for Causal Discovery: a Constraint-based, Argumentation-driven Approach](https://arxiv.org/abs/2602.16481)
...
### [55] [Creating a digital poet](https://arxiv.org/abs/2602.16578)
...
### [56] [Towards a Science of AI Agent Reliability](https://arxiv.org/abs/2602.16666)
...
### [60] [Machine Learning in Epidemiology](https://arxiv.org/abs/2602.16352)
...
### [61] [Learning Preference from Observed Rankings](https://arxiv.org/abs/2602.16476)
...
### [62] [Functional Decomposition and Shapley Interactions for Interpreting Survival Models](https://arxiv.org/abs/2602.16505)
...
### [63] [Surrogate-Based Prevalence Measurement for Large-Scale A/B Testing](https://arxiv.org/abs/2602.16111)
...
### [64] [Phase Transitions in Collective Damage of Civil Structures under Natural Hazards](https://arxiv.org/abs/2602.16195)
...
### [65] [Physical Activity Trajectories Preceding Incident Major Depressive Disorder Diagnosis Using Consumer Wearable Devices in the All of Us Research Program: Case-Control Study](https://arxiv.org/abs/2602.16583)
...
### [66] [Design and Analysis Strategies for Pooling in High Throughput Screening: Application to the Search for a New Anti-Microbial](https://arxiv.org/abs/2602.16616)
...
### [67] [Newton-Direction-Based ReLU-Thresholding Methods for Nonnegative Sparse Signal Recovery](https://arxiv.org/abs/2602.15880)
...
### [68] [NeuroSleep: Neuromorphic Event-Driven Single-Channel EEG Sleep Staging for Edge-Efficient Sensing](https://arxiv.org/abs/2602.15888)
...
### [69] [Advancing Industry 4.0: Multimodal Sensor Fusion for AI-Based Fault Detection in 3D Printing](https://arxiv.org/abs/2602.16108)
...
### [70] [Real time fault detection in 3D printers using Convolutional Neural Networks and acoustic signals](https://arxiv.org/abs/2602.16118)
...
### [71] [Impact of Preprocessing on Neural Network-Based RSS/AoA Positioning](https://arxiv.org/abs/2602.16271)
...
### [72] [Joint beamforming and mode optimization for multi-functional STAR-RIS-aided integrated sensing and communication networks](https://arxiv.org/abs/2602.16383)
...
### [73] [Reconstruction of Piecewise-Constant Sparse Signals for Modulo Sampling](https://arxiv.org/abs/2602.16418)
...
### [74] [Proof of Concept: Local TX Real-Time Phase Calibration in MIMO Systems](https://arxiv.org/abs/2602.16441)
...
### [75] [Failure-Aware Access Point Selection for Resilient Cell-Free Massive MIMO Networks](https://arxiv.org/abs/2602.16546)
...
### [76] [WindDensity-MBIR: Model-Based Iterative Reconstruction for Wind Tunnel 3D Density Estimation](https://arxiv.org/abs/2602.16621)
