...
### [1] [Unlocking the Energy-Saving Potential in O-RAN Cell-Free Massive MIMO by Joint Orchestration of Radio, Wireless Fronthaul, and Cloud Resources](https://arxiv.org/abs/2604.04073)
...
### [2] [Joint Shape-Position Optimization Enhanced 2D DOA Estimation in Movable Antenna Systems](https://arxiv.org/abs/2604.04132)
...
### [3] [Cell-Free Massive MIMO for Joint Communication and Proactive Monitoring](https://arxiv.org/abs/2604.04210)
...
### [4] [In-Tunnel Single-Anchor Localization Exploiting Near-Field and Radio-Reflective Road Markings](https://arxiv.org/abs/2604.04217)
...
### [5] [RAVEN: Radar Adaptive Vision Encoders for Efficient Chirp-wise Object Detection and Segmentation](https://arxiv.org/abs/2604.04490)
...
### [6] [Simultaneous Unicast and Multicast Transmissions in Stacked Intelligent Metasurfaces-assisted HAPS Wireless Networks: Performance Analysis and Optimization](https://arxiv.org/abs/2604.04684)
...
### [7] [Performance Analysis of STAR-RIS-Assisted NOMA Wireless Systems with Realistic Indoor Outdoor THz Channel Models](https://arxiv.org/abs/2604.04702)
*Ngoc Phuc Le,Mohamed-Slim Alouini*
...
### [8] [Multi-Scaled Unscented Kalman Filter](https://arxiv.org/abs/2604.04792)
...
### [9] [Debiased Machine Learning for Conformal Prediction of Counterfactual Outcomes Under Runtime Confounding](https://arxiv.org/abs/2604.03772)
...
### [10] [Noisy Nonreciprocal Pairwise Comparisons: Scale Variation, Noise Calibration, and Admissible Ranking Regions](https://arxiv.org/abs/2604.04588)
*Jean-Pierre Magnot*
...
### [11] [The Long-Range Memory and the Fractal Dimension: a Case Study for Alcântara](https://arxiv.org/abs/2604.03355)
...
Abstract: This study aimed to analyze the time series behavior of the Southern Oscillation Index through techniques using Fast Fourier Transform, computing the autocorrelation function, and the calculation of the Hurst coefficient. The methodology of Hurst exponent calculation uses different lags, which are computed in the time series of Southern Oscillation Index. The persistent behavior in the time series can be characterized by calculating the Hurst exponent, seeking for more behavioral information, such as the existence of persistence and/or terms of long-range memory in the series.
  The results show a persistence of the climate in terms of long-memory Southern Oscillation Index time series, which can help to understand complex dynamic behavior in climate effects at global-scale level and specifically its influence in northeastern Brazil, in the region of the Alcântara Launch Center. The R package \texttt{tseriesChaos} was used in the analysis of the Southern Oscillation Index time series, estimating the largest Lyapunov exponent, which indicates the existence of chaotic behavior in time series.
  The resampling technique was used in a permutation test between the surface wind data in the São Luís airport, Maranhão State, and the Southern Oscillation Index. The permutation test results showed that the time series of monthly average wind speed in the São Luís airport is correlated with the variability of Southern Oscillation Index, statistically significant at the 5\% confidence level. The results also indicate the possibility of using autoregressive models to represent average meteorological variables in behavioral analysis, as well as trends in the climate, more specifically a possible climatic influence of El Niño--Southern Oscillation on wind strength in the Alcântara Launch Center.

</details>


### [12] [Two-Sample Testing for Multivariate Cross-Correlation Functions with Applications to Gut-Brain Reward Learning](https://arxiv.org/abs/2604.04156)
...
### [13] [Integrating Artificial Intelligence, Physics, and Internet of Things: A Framework for Cultural Heritage Conservation](https://arxiv.org/abs/2604.03233)
...
### [15] [Apparent Age Estimation: Challenges and Outcomes](https://arxiv.org/abs/2604.03335)
...
### [16] [Towards Intelligent Energy Security: A Unified Spatio-Temporal and Graph Learning Framework for Scalable Electricity Theft Detection in Smart Grids](https://arxiv.org/abs/2604.03344)
...
### [17] [From Model-Based Screening to Data-Driven Surrogates: A Multi-Stage Workflow for Exploring Stochastic Agent-Based Models](https://arxiv.org/abs/2604.03350)
...
### [18] [Choosing the Right Regularizer for Applied ML: Simulation Benchmarks of Popular Scikit-learn Regularization Frameworks](https://arxiv.org/abs/2604.03541)
...
### [19] [A Bayesian Information-Theoretic Approach to Data Attribution](https://arxiv.org/abs/2604.03858)
...
### [20] [Autoencoder-Based Parameter Estimation for Superposed Multi-Component Damped Sinusoidal Signals](https://arxiv.org/abs/2604.03985)
...
### [21] [Adaptive Threshold-Driven Continuous Greedy Method for Scalable Submodular Optimization](https://arxiv.org/abs/2604.03419)
...
### [22] [Relative Density Ratio Optimization for Stable and Statistically Consistent Model Alignment](https://arxiv.org/abs/2604.04410)
...
### [23] [MetaSAEs: Joint Training with a Decomposability Penalty Produces More Atomic Sparse Autoencoder Latents](https://arxiv.org/abs/2604.03436)
*Matthew Levinson*
...
### [24] [The Infinite-Dimensional Nature of Spectroscopy and Why Models Succeed, Fail, and Mislead](https://arxiv.org/abs/2604.04717)
...
### [25] [Olmo Hybrid: From Theory to Practice and Back](https://arxiv.org/abs/2604.03444)
...
### [26] [Super Agents and Confounders: Influence of surrounding agents on vehicle trajectory prediction](https://arxiv.org/abs/2604.03463)
...
### [27] [Investigating Data Interventions for Subgroup Fairness: An ICU Case Study](https://arxiv.org/abs/2604.03478)
...
### [28] [Simple yet Effective: Low-Rank Spatial Attention for Neural Operators](https://arxiv.org/abs/2604.03582)
...
### [29] [Evaluation of Bagging Predictors with Kernel Density Estimation and Bagging Score](https://arxiv.org/abs/2604.03599)
...
### [30] [Delayed Homomorphic Reinforcement Learning for Environments with Delayed Feedback](https://arxiv.org/abs/2604.03641)
...
### [31] [Automated Conjecture Resolution with Formal Verification](https://arxiv.org/abs/2604.03789)
...
### [32] [k-Maximum Inner Product Attention for Graph Transformers and the Expressive Power of GraphGPS The Expressive Power of GraphGPS](https://arxiv.org/abs/2604.03815)
...
### [33] [Collapse-Free Prototype Readout Layer for Transformer Encoders](https://arxiv.org/abs/2604.03850)
...
### [34] [Understanding When Poisson Log-Normal Models Outperform Penalized Poisson Regression for Microbiome Count Data](https://arxiv.org/abs/2604.03853)
...
### [35] [Where to Steer: Input-Dependent Layer Selection for Steering Improves LLM Alignment](https://arxiv.org/abs/2604.03867)
...
### [36] [Spatiotemporal Interpolation of GEDI Biomass with Calibrated Uncertainty](https://arxiv.org/abs/2604.03874)
...
### [37] [BWTA: Accurate and Efficient Binarized Transformer by Algorithm-Hardware Co-design](https://arxiv.org/abs/2604.03957)
...
### [38] [Multirate Stein Variational Gradient Descent for Efficient Bayesian Sampling](https://arxiv.org/abs/2604.03981)
*Arash Sarshar*
...
### [39] [Geometric Limits of Knowledge Distillation: A Minimum-Width Theorem via Superposition Theory](https://arxiv.org/abs/2604.04037)
...
### [41] [Restless Bandits with Individual Penalty Constraints: A New Near-Optimal Index Policy and How to Learn It](https://arxiv.org/abs/2604.04101)
...
### [42] [Physical Sensitivity Kernels Can Emerge in Data-Driven Forward Models: Evidence From Surface-Wave Dispersion](https://arxiv.org/abs/2604.04107)
...
### [44] [Towards Agentic Defect Reasoning: A Graph-Assisted Retrieval Framework for Laser Powder Bed Fusion](https://arxiv.org/abs/2604.04208)
...
### [45] [Three Phases of Expert Routing: How Load Balance Evolves During Mixture-of-Experts Training](https://arxiv.org/abs/2604.04230)
...
### [46] [Subspace Control: Turning Constrained Model Steering into Controllable Spectral Optimization](https://arxiv.org/abs/2604.04231)
...
### [47] [Good Rankings, Wrong Probabilities: A Calibration Audit of Multimodal Cancer Survival Models](https://arxiv.org/abs/2604.04239)
*Sajad Ghawami*
...
### [51] [Is Prompt Selection Necessary for Task-Free Online Continual Learning?](https://arxiv.org/abs/2604.04420)
...
### [52] [Estimating Central, Peripheral, and Temporal Visual Contributions to Human Decision Making in Atari Games](https://arxiv.org/abs/2604.04439)
...
### [53] [TinyNina: A Resource-Efficient Edge-AI Framework for Sustainable Air Quality Monitoring via Intra-Image Satellite Super-Resolution](https://arxiv.org/abs/2604.04445)
...
### [54] [MAVEN: A Mesh-Aware Volumetric Encoding Network for Simulating 3D Flexible Deformation](https://arxiv.org/abs/2604.04474)
...
### [55] [SLaB: Sparse-Lowrank-Binary Decomposition for Efficient Large Language Models](https://arxiv.org/abs/2604.04493)
...
### [56] [GAIN: Multiplicative Modulation for Domain Adaptation](https://arxiv.org/abs/2604.04516)
...
### [57] [FlashSAC: Fast and Stable Off-Policy Reinforcement Learning for High-Dimensional Robot Control](https://arxiv.org/abs/2604.04539)
...
### [58] [Dynamic Free-Rider Detection in Federated Learning via Simulated Attack Patterns](https://arxiv.org/abs/2604.04611)
*Motoki Nakamura*
...
### [59] [Batch Loss Score for Dynamic Data Pruning](https://arxiv.org/abs/2604.04681)
...
### [60] [Explainable Machine Learning for Sepsis Outcome Prediction Using a Novel Romanian Electronic Health Record Dataset](https://arxiv.org/abs/2604.04698)
...
### [61] [MUXQ: Mixed-to-Uniform Precision MatriX Quantization via Low-Rank Outlier Decomposition](https://arxiv.org/abs/2604.04701)
...
### [62] [Sampling Parallelism for Fast and Efficient Bayesian Learning](https://arxiv.org/abs/2604.04736)
...
### [63] [Darkness Visible: Reading the Exception Handler of a Language Model](https://arxiv.org/abs/2604.04756)
*Peter Balogh*
...
### [64] [Are Latent Reasoning Models Easily Interpretable?](https://arxiv.org/abs/2604.04902)
...
### [65] [Structural Segmentation of the Minimum Set Cover Problem: Exploiting Universe Decomposability for Metaheuristic Optimization](https://arxiv.org/abs/2604.03234)
...
### [66] [Toward Full Autonomous Laboratory Instrumentation Control with Large Language Models](https://arxiv.org/abs/2604.03286)
...
### [67] [Evaluating Artificial Intelligence Through a Christian Understanding of Human Flourishing](https://arxiv.org/abs/2604.03356)
...
### [68] [VERT: Reliable LLM Judges for Radiology Report Evaluation](https://arxiv.org/abs/2604.03376)
...
### [69] [Hume's Representational Conditions for Causal Judgment: What Bayesian Formalization Abstracted Away](https://arxiv.org/abs/2604.03387)
*Yiling Wu*
...
### [70] [TABQAWORLD: Optimizing Multimodal Reasoning for Multi-Turn Table Question Answering](https://arxiv.org/abs/2604.03393)
...
### [71] [Contextual Control without Memory Growth in a Context-Switching Task](https://arxiv.org/abs/2604.03479)
*Song-Ju Kim*
...
### [72] [Beyond Predefined Schemas: TRACE-KG for Context-Enriched Knowledge Graphs from Complex Documents](https://arxiv.org/abs/2604.03496)
...
### [73] [Structural Rigidity and the 57-Token Predictive Window: A Physical Framework for Inference-Layer Governability in Large Language Models](https://arxiv.org/abs/2604.03524)
*Gregory M. Ruddell*
...
### [74] [Explainable Model Routing for Agentic Workflows](https://arxiv.org/abs/2604.03527)
...
### [75] [Automated Analysis of Global AI Safety Initiatives: A Taxonomy-Driven LLM Approach](https://arxiv.org/abs/2604.03533)
...
### [76] [When Do Hallucinations Arise? A Graph Perspective on the Evolution of Path Reuse and Path Compression](https://arxiv.org/abs/2604.03557)
...
### [77] [When Adaptive Rewards Hurt: Causal Probing and the Switching-Stability Dilemma in LLM-Guided LEO Satellite Scheduling](https://arxiv.org/abs/2604.03562)
*Yuanhang Li*
...
### [78] [Rashomon Memory: Towards Argumentation-Driven Retrieval for Multi-Perspective Agent Memory](https://arxiv.org/abs/2604.03588)
...
### [79] [Entropy and Attention Dynamics in Small Language Models: A Trace-Level Structural Analysis on the TruthfulQA Benchmark](https://arxiv.org/abs/2604.03589)
...
### [80] [Single-agent vs. Multi-agents for Automated Video Analysis of On-Screen Collaborative Learning Behaviors](https://arxiv.org/abs/2604.03631)
...
### [81] [PRAISE: Prefix-Based Rollout Reuse in Agentic Search Training](https://arxiv.org/abs/2604.03675)
...
### [83] [Quantifying Trust: Financial Risk Management for Trustworthy AI Agents](https://arxiv.org/abs/2604.03976)
...
### [84] [Profile-Then-Reason: Bounded Semantic Complexity for Tool-Augmented Language Agents](https://arxiv.org/abs/2604.04131)
*Paulo Akira F. Enabe*
...
### [85] [Readable Minds: Emergent Theory-of-Mind-Like Behavior in LLM Poker Agents](https://arxiv.org/abs/2604.04157)
...
### [86] [Comparative reversal learning reveals rigid adaptation in LLMs under non-stationary uncertainty](https://arxiv.org/abs/2604.04182)
...
### [87] [Schema-Aware Planning and Hybrid Knowledge Toolset for Reliable Knowledge Graph Triple Verification](https://arxiv.org/abs/2604.04190)
...
### [88] [Don't Blink: Evidence Collapse during Multimodal Reasoning](https://arxiv.org/abs/2604.04207)
...
### [89] [TimeSeek: Temporal Reliability of Agentic Forecasters](https://arxiv.org/abs/2604.04220)
...
### [90] [Pedagogical Safety in Educational Reinforcement Learning: Formalizing and Detecting Reward Hacking in AI Tutoring Systems](https://arxiv.org/abs/2604.04237)
...
### [91] [Combee: Scaling Prompt Learning for Self-Improving Language Model Agents](https://arxiv.org/abs/2604.04247)
...
### [92] [MC-CPO: Mastery-Conditioned Constrained Policy Optimization](https://arxiv.org/abs/2604.04251)
*Oluseyi Olukola,Nick Rahimi*
...
### [93] [Beyond Fluency: Toward Reliable Trajectories in Agentic IR](https://arxiv.org/abs/2604.04269)
...
### [94] [Preservation Is Not Enough for Width Growth: Regime-Sensitive Selection of Dense LM Warm Starts](https://arxiv.org/abs/2604.04281)
*Eren Unlu*
...
### [95] [PanLUNA: An Efficient and Robust Query-Unified Multimodal Model for Edge Biosignal Intelligence](https://arxiv.org/abs/2604.04297)
...
### [96] [Implementing surrogate goals for safer bargaining in LLM-based agents](https://arxiv.org/abs/2604.04341)
...
### [97] [Domain-Contextualized Inference: A Computable Graph Architecture for Explicit-Domain Reasoning](https://arxiv.org/abs/2604.04344)
...
### [98] [Decocted Experience Improves Test-Time Inference in LLM Agents](https://arxiv.org/abs/2604.04373)
...
### [99] [Gradual Cognitive Externalization: A Framework for Understanding How Ambient Intelligence Externalizes Human Cognition](https://arxiv.org/abs/2604.04387)
*Zhimin Zhao*
...
### [100] [ShieldNet: Network-Level Guardrails against Emerging Supply-Chain Injections in Agentic Systems](https://arxiv.org/abs/2604.04426)
...
### [101] [Empirical Characterization of Rationale Stability Under Controlled Perturbations for Explainable Pattern Recognition](https://arxiv.org/abs/2604.04456)
...
### [102] [Memory Intelligence Agent](https://arxiv.org/abs/2604.04503)
...
### [103] [SuperLocalMemory V3.3: The Living Brain -- Biologically-Inspired Forgetting, Cognitive Quantization, and Multi-Channel Retrieval for Zero-LLM Agent Memory Systems](https://arxiv.org/abs/2604.04514)
...
### [104] [Greedy and Transformer-Based Multi-Port Selection for Slow Fluid Antenna Multiple Access](https://arxiv.org/abs/2604.04589)
...
### [105] [Same World, Differently Given: History-Dependent Perceptual Reorganization in Artificial Agents](https://arxiv.org/abs/2604.04637)
*Hongju Pae*
...
### [106] [Springdrift: An Auditable Persistent Runtime for LLM Agents with Case-Based Memory, Normative Safety, and Ambient Self-Perception](https://arxiv.org/abs/2604.04660)
*Seamus Brady*
...
### [107] [On the "Causality" Step in Policy Gradient Derivations: A Pedagogical Reconciliation of Full Return and Reward-to-Go](https://arxiv.org/abs/2604.04686)
*Nima H. Siboni*
...
### [108] [AI Assistance Reduces Persistence and Hurts Independent Performance](https://arxiv.org/abs/2604.04721)
...
### [109] [ANX: Protocol-First Design for AI Agent Interaction with a Supporting 3EX Decoupled Architecture](https://arxiv.org/abs/2604.04820)
*Xu Mingze*
...
### [110] [Incompleteness of AI Safety Verification via Kolmogorov Complexity](https://arxiv.org/abs/2604.04876)
*Munawar Hasan*
...
### [111] [Learning, Potential, and Retention: An Approach for Evaluating Adaptive AI-Enabled Medical Devices](https://arxiv.org/abs/2604.04878)
