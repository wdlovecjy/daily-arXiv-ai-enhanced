...
### [3] [Sensing-Assisted Adaptive Beam Probing with Calibrated Multimodal Priors and Uncertainty-Aware Scheduling](https://arxiv.org/abs/2603.24024)
...
### [6] [Towards Semantic-based Agent Communication Networks: Vision, Technologies, and Challenges](https://arxiv.org/abs/2603.24328)
...
### [8] [The Mass Agreement Score: A Point-centric Measure of Cluster Size Consistency](https://arxiv.org/abs/2603.23581)
...
### [9] [Federated fairness-aware classification under differential privacy](https://arxiv.org/abs/2603.24392)
*Gengyu Xue,Yi Yu*
...
### [10] [Neural Network Models for Contextual Regression](https://arxiv.org/abs/2603.24400)
...
### [11] [Continuous-Time Learning of Probability Distributions: A Case Study in a Digital Trial of Young Children with Type 1 Diabetes](https://arxiv.org/abs/2603.24427)
...
### [12] [Trust Region Constrained Bayesian Optimization with Penalized Constraint Handling](https://arxiv.org/abs/2603.24567)
...
### [13] [Wafer-Level Etch Spatial Profiling for Process Monitoring from Time-Series with Time-LLM](https://arxiv.org/abs/2603.23576)
...
### [14] [Can LLM Agents Be CFOs? A Benchmark for Resource Allocation in Dynamic Enterprise Environments](https://arxiv.org/abs/2603.23638)
...
### [15] [GTO Wizard Benchmark](https://arxiv.org/abs/2603.23660)
...
### [16] [Efficient Benchmarking of AI Agents](https://arxiv.org/abs/2603.23749)
*Franck Ndzomga*
...
### [17] [VehicleMemBench: An Executable Benchmark for Multi-User Long-Term Memory in In-Vehicle Agents](https://arxiv.org/abs/2603.23840)
...
### [19] [Implicit Turn-Wise Policy Optimization for Proactive User-LLM Interaction](https://arxiv.org/abs/2603.23550)
...
### [20] [Upper Entropy for 2-Monotone Lower Probabilities](https://arxiv.org/abs/2603.23558)
...
### [21] [AscendOptimizer: Episodic Agent for Ascend NPU Operator Optimization](https://arxiv.org/abs/2603.23566)
...
### [22] [Causal Reconstruction of Sentiment Signals from Sparse News Data](https://arxiv.org/abs/2603.23568)
...
### [23] [Dual-Criterion Curriculum Learning: Application to Temporal Data](https://arxiv.org/abs/2603.23573)
...
### [24] [Deep Neural Regression Collapse](https://arxiv.org/abs/2603.23805)
...
### [26] [Optimal Variance-Dependent Regret Bounds for Infinite-Horizon MDPs](https://arxiv.org/abs/2603.23926)
...
### [27] [On the Use of Bagging for Local Intrinsic Dimensionality Estimation](https://arxiv.org/abs/2603.24384)
...
### [28] [Residual Attention Physics-Informed Neural Networks for Robust Multiphysics Simulation of Steady-State Electrothermal Energy Systems](https://arxiv.org/abs/2603.23578)
...
### [29] [MetaKube: An Experience-Aware LLM Framework for Kubernetes Failure Diagnosis](https://arxiv.org/abs/2603.23580)
...
### [30] [LineMVGNN: Anti-Money Laundering with Line-Graph-Assisted Multi-View Graph Neural Networks](https://arxiv.org/abs/2603.23584)
...
### [31] [Boost Like a (Var)Pro: Trust-Region Gradient Boosting via Variable Projection](https://arxiv.org/abs/2603.23658)
...
### [32] [BXRL: Behavior-Explainable Reinforcement Learning](https://arxiv.org/abs/2603.23738)
...
### [33] [Kronecker-Structured Nonparametric Spatiotemporal Point Processes](https://arxiv.org/abs/2603.23746)
...
### [34] [Lightweight Fairness for LLM-Based Recommendations via Kernelized Projection and Gated Adapters](https://arxiv.org/abs/2603.23780)
...
### [35] [Mitigating Many-Shot Jailbreaking](https://arxiv.org/abs/2504.09604)
...
### [36] [Resolving gradient pathology in physics-informed epidemiological models](https://arxiv.org/abs/2603.23799)
...
### [37] [Evidence for Limited Metacognition in LLMs](https://arxiv.org/abs/2509.21545)
...
### [38] [Circuit Complexity of Hierarchical Knowledge Tracing and Implications for Log-Precision Transformers](https://arxiv.org/abs/2603.23823)
...
### [39] [Symbolic--KAN: Kolmogorov-Arnold Networks with Discrete Symbolic Structure for Interpretable Learning](https://arxiv.org/abs/2603.23854)
...
### [40] [Off-Policy Safe Reinforcement Learning with Constrained Optimistic Exploration](https://arxiv.org/abs/2603.23889)
...
### [41] [GRMLR: Knowledge-Enhanced Small-Data Learning for Deep-Sea Cold Seep Stage Inference](https://arxiv.org/abs/2603.23961)
...
### [42] [Wireless communication empowers online scheduling of partially-observable transportation multi-robot systems in a smart factory](https://arxiv.org/abs/2603.23967)
...
### [43] [Diet Your LLM: Dimension-wise Global Pruning of LLMs via Merging Task-specific Importance Score](https://arxiv.org/abs/2603.23985)
...
### [44] [Stochastic Dimension-Free Zeroth-Order Estimator for High-Dimensional and High-Order PINNs](https://arxiv.org/abs/2603.24002)
...
### [45] [MoE-Sieve: Routing-Guided LoRA for Efficient MoE Fine-Tuning](https://arxiv.org/abs/2603.24044)
*Andrea Manzoni*
...
### [46] [The impact of sensor placement on graph-neural-network-based leakage detection](https://arxiv.org/abs/2603.24076)
...
### [47] [Towards Effective Experiential Learning: Dual Guidance for Utilization and Internalization](https://arxiv.org/abs/2603.24093)
...
### [48] [Mixed-signal implementation of feedback-control optimizer for single-layer Spiking Neural Networks](https://arxiv.org/abs/2603.24113)
...
### [49] [On Gossip Algorithms for Machine Learning with Pairwise Objectives](https://arxiv.org/abs/2603.24128)
...
### [50] [Cost-Sensitive Neighborhood Aggregation for Heterophilous Graphs: When Does Per-Edge Routing Help?](https://arxiv.org/abs/2603.24291)
*Eyal Weiss*
...
### [51] [Efficient Controller Learning from Human Preferences and Numerical Data Via Multi-Modal Surrogate Models](https://arxiv.org/abs/2603.24138)
...
### [52] [UI-Voyager: A Self-Evolving GUI Agent Learning via Failed Experience](https://arxiv.org/abs/2603.24533)
...
### [53] [Identification of NMF by choosing maximum-volume basis vectors](https://arxiv.org/abs/2603.24227)
...
### [54] [Forecasting with Guidance: Representation-Level Supervision for Time Series Forecasting](https://arxiv.org/abs/2603.24262)
...
### [55] [Language-Assisted Image Clustering Guided by Discriminative Relational Signals and Adaptive Semantic Centers](https://arxiv.org/abs/2603.24275)
...
### [56] [CoordLight: Learning Decentralized Coordination for Network-Wide Traffic Signal Control](https://arxiv.org/abs/2603.24366)
...
### [57] [Uniform Laws of Large Numbers in Product Spaces](https://arxiv.org/abs/2603.24493)
