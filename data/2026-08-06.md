...
### [2] [Dual IMU System for Accurate Gastrointestinal Motility Tracking](https://arxiv.org/abs/2608.04319)
...
### [3] [GPU-Resident CUDA Acceleration for OCUDU 5G PHY and O-RAN Fronthaul: Architecture and Preliminary Performance](https://arxiv.org/abs/2608.04338)
...
### [4] [Outage Analysis of Platoon-Head Selection for Vehicle Platooning in V2X Networks](https://arxiv.org/abs/2608.04383)
*Junhyeong Kim*
...
### [5] [Near-Field Velocity Estimation and Doppler-Aware Localization in OFDM Massive MIMO](https://arxiv.org/abs/2608.05133)
...
### [6] [ArborEnum: Decision Tree Rashomon Sets over Continuous Features](https://arxiv.org/abs/2608.04310)
...
### [7] [An Explainable LLM Agent Layer for Open-World Anomaly Detection in Oil Wells](https://arxiv.org/abs/2608.04041)
...
### [8] [Discretization and Statistical Consistency of Functional Flow Matching](https://arxiv.org/abs/2608.04531)
*Lennon J. Shikhman*
...
### [9] [Tactus: Open-Vocabulary Object Recognition from Low-Cost Pressure Arrays](https://arxiv.org/abs/2608.04043)
*Abdul Basit Tonmoy*
...
### [10] [Unscented KalmanNet: a hybrid deep learning filter with calibrated posterior covariance for nonlinear state estimation](https://arxiv.org/abs/2608.04201)
...
### [11] [Random features for Grassmannian kernel approximation with bounded rank-one projections](https://arxiv.org/abs/2608.04227)
...
### [12] [LaPrune: Controllable Differentiable Sparsity at Million Scale](https://arxiv.org/abs/2608.04057)
...
### [13] [SJEPA: Learning Elegant Latent Dynamics with Hybrid Symbolic-Neural Predictors](https://arxiv.org/abs/2608.04060)
*Yongchao Huang*
...
### [14] [SSTQ:Privacy-Preserving Vector Quantization via Subsampled Stochastic TurboQuant](https://arxiv.org/abs/2608.05127)
...
### [15] [Spatiotemporal Graph Transformer for Traffic Intelligence in Edge Computing](https://arxiv.org/abs/2608.04075)
...
### [16] [LiNC: Lightweight Noise Correction via Per-Sample Trust and Gaussian Mixture Modeling](https://arxiv.org/abs/2608.04147)
...
### [17] [MINT: Tensor Decomposition on Stacked Recurrence Matrices for Time Series Data Mining](https://arxiv.org/abs/2608.04157)
...
### [18] [Understanding Fault Tolerance of Adversarially Robust Pruned Models](https://arxiv.org/abs/2608.04173)
...
### [19] [TS2TabPFN: Time Series Classification and Extrinsic Regression through Feature Extraction and a Tabular Foundation Model](https://arxiv.org/abs/2608.04174)
...
### [20] [A Comparative Study of Feature Selection Methods for EHR Diagnosis Codes in Opioid Use Disorder Prediction](https://arxiv.org/abs/2608.04180)
...
### [22] [Attention-Only White-Box Transformer via LeJEPA-Based Self-Supervised Pretraining](https://arxiv.org/abs/2608.04213)
...
### [23] [Physics-informed reduced-order modelling with equivariant spectral submanifolds](https://arxiv.org/abs/2608.04239)
*Georg Maierhofer*
...
### [24] [Adaptive Finite-Budget Training for CVaR Risk-Aware Q-Learning](https://arxiv.org/abs/2608.04305)
...
### [25] [Cost-Aware Multi-Objective Bandits: Theory and Application to Budgeted LLM Configuration Evaluation](https://arxiv.org/abs/2608.04333)
...
### [26] [ATLAS: Adaptive Topological Learning with Abstract Successors for Continual Learning](https://arxiv.org/abs/2608.04334)
...
### [27] [Manipulation-Proof Oblivious Audits against Deceptive Model Providers](https://arxiv.org/abs/2608.04365)
...
### [28] [Elbow-Based MoE Routing: A Training-Free Inference Time Plugin for Expert Selection](https://arxiv.org/abs/2608.04401)
...
### [29] [Training-Free Hashing-Based Attention via Binary Principal Components](https://arxiv.org/abs/2608.04405)
...
### [30] [MESH: Memory-Efficient Sinkhorn Optimization for Mixture-of-Experts Training](https://arxiv.org/abs/2608.04407)
*Masato Fujitake*
...
### [31] [Robustness Emerges Early in Training Dynamics, but Is Not Preserved](https://arxiv.org/abs/2608.04442)
...
### [32] [Learning Compression Rules for Network Traffic](https://arxiv.org/abs/2608.04545)
...
### [33] [Rethinking Reservoir Pruning: A Dynamical Perspective for Echo State Networks](https://arxiv.org/abs/2608.04593)
...
### [34] [Why Ranking Anomaly Detection Algorithms Isn't as Reliable as You May Think](https://arxiv.org/abs/2608.04613)
...
### [35] [Differentiating Through Dual Prices: End-to-End Policy Learning Under Capacity Constraints](https://arxiv.org/abs/2608.04669)
...
### [36] [Diverse and Plausible Algorithmic Recourse via Tractable Recourse Distributions](https://arxiv.org/abs/2608.04677)
...
### [37] [Benchmarking Deep Learning Models for Dense Event Classification of Offshore Wind Infrastructure in Sentinel-1 Time Series](https://arxiv.org/abs/2608.04706)
...
### [38] [Attention, Anomalies! Handling Attention Layers in Unsupervised Federated Outlier Detection](https://arxiv.org/abs/2608.04753)
...
### [39] [MGSB: Manifold Gated Signature Branch Pressure-Domain Baseline Architecture for Two-Phase Pipeline Flows Under Distributional Shift](https://arxiv.org/abs/2608.04805)
...
### [40] [Robust Control under Stationary Ambiguity](https://arxiv.org/abs/2608.04832)
...
### [41] [Training Crossroads for Recurrent Vision Transformers: Recurrence, Neural ODEs, and Deep Supervision](https://arxiv.org/abs/2608.04879)
...
### [42] [SVI-DAG: A Structured Variational Inference Approach to Bayesian Causal Discovery](https://arxiv.org/abs/2608.04930)
*Shrenik Zinage*
...
### [43] [Optimal Training-Time Scaling in Gradual Adaptation](https://arxiv.org/abs/2608.04927)
...
### [44] [Capability-Gated Planning: Cost-to-Goal Discovery and the Limits of Myopic Experiment Selection](https://arxiv.org/abs/2608.05085)
...
### [45] [MALT: Lightweight Curvature-Aware Muon via Diagonal Preconditioning](https://arxiv.org/abs/2608.05088)
...
### [46] [BnBERT-iPET: Sparse Few-Shot Language Modeling for Bengali via Lottery Ticket Pruning](https://arxiv.org/abs/2608.05104)
...
### [47] [Reward Structure Shapes the Interaction Between Episodic Exploration and Neural Memory in Reinforcement Learning](https://arxiv.org/abs/2608.05111)
...
### [48] [The Loss Does Not See the Basis, but Adam Does](https://arxiv.org/abs/2608.05136)
*Devender Singh*
...
### [49] [The LLM Proposes, the Executive Disposes: A Self-Verifying Agent Instrument that Dissociates Commitment Drift from Binding Drift in Long-Horizon Agents](https://arxiv.org/abs/2608.04066)
*Mohsen Arjmandi*
...
### [50] [BrainBench: Benchmarking Large Language Models for Comprehensive EEG Understanding](https://arxiv.org/abs/2608.04156)
...
### [51] [Adversarially Robust Abductive Fusion of Pre-trained Transformer-based Perception Models](https://arxiv.org/abs/2608.04190)
...
### [52] [Interoceptive Attention as Dynamic Homeostatic Prioritization in a Foraging Agent](https://arxiv.org/abs/2608.04232)
...
### [53] [SafeCommit: Certifying When Memory-Grounded Agents May Safely Act](https://arxiv.org/abs/2608.04289)
...
### [54] [CARGO-VL: Counterfactual Arbitration with Risk-Constrained Group Optimization for Vision-Language Models](https://arxiv.org/abs/2608.04509)
...
### [55] [Leak-Resistant Unlearning: A New Benchmark for Evaluating Multi-Hop Reasoning Consistency and Recovery Robustness](https://arxiv.org/abs/2608.04519)
...
### [56] [What Is a Skill Worth? Structure-Aware Shapley Valuation of Agent Skills](https://arxiv.org/abs/2608.04562)
...
### [57] [Joint UAV Flight and Opportunistic Routing under Reinforcement Learning for Delay-Tolerant Networks](https://arxiv.org/abs/2608.04590)
...
### [58] [Calibrating Artificial Guilt: Neurally Grounded Reward Shaping for Prosocial Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2608.04663)
...
### [59] [Diagnosing Tool-Selection Reasoning in LLM Agents with Canary Tools](https://arxiv.org/abs/2608.04719)
...
### [60] [When Prompts Become Pixels: Prompt-Region Grounding for Multimodal Reasoning](https://arxiv.org/abs/2608.04726)
...
### [61] [Chain-of-Thought Monitoring Can Be Unreliable in Implicit-Influence Settings](https://arxiv.org/abs/2608.04735)
...
### [62] [NSF-HRPT: Neural Semantic Field meets Hierarchical Risk Perception Tree for Safety-Critical Scenario Assessment](https://arxiv.org/abs/2608.04776)
...
### [63] [ContextWeave: A Real-World Workflow Benchmark](https://arxiv.org/abs/2608.04830)
...
### [64] [When Shared Rollouts Fail in Defensive Driving Evaluation: A NAVSIM Score Basis Audit](https://arxiv.org/abs/2608.04896)
...
### [65] [WorldCycle: Self-Verifiable Reinforcement Learning for Long-Horizon Video World Models](https://arxiv.org/abs/2608.04964)
...
### [66] [Short-term load forecasting under EU-AI Act Requirements in Safety-Critical Environments: Results from a 41-day live challenge on the aggregated German transmission-grid load](https://arxiv.org/abs/2608.05018)
...
### [67] [From Score Matrices to Football-Aware Match-State Simulation: An Auditable LLM Harness for Exact-Score Reranking](https://arxiv.org/abs/2608.05030)
*Shaopeng Liang*
...
### [68] [Item Response Theory for AI Safety](https://arxiv.org/abs/2608.05086)
...
### [69] [Hierarchical Graph Memory for LLM Agents with Path-level Localization and Rewrite](https://arxiv.org/abs/2608.05095)
...
### [70] [ABSeeker: Training Long-Horizon Search Agents via Answer-Backtracked Credit Assignment](https://arxiv.org/abs/2608.05102)
...
### [71] [OctoLong: Mid-Training On Cross-Repository Code Contexts Enhances Long-Context Modeling](https://arxiv.org/abs/2608.05141)
...
### [72] [Statistical learning theory and Occam's razor: Regularization](https://arxiv.org/abs/2608.04049)
*Tom F. Sterkenburg*
...
### [73] [Automatic Statistical Test for Rationally Expressible Algorithms by Selective Inference, with Applications to Feature Selection](https://arxiv.org/abs/2608.04667)
