...
### [1] [The Impact of a Gridded Streamflow Measure on Drought Variation in the Conterminous United States](https://arxiv.org/abs/2609.10275)
...
### [2] [3D Protraction Technique for Anchor-Free, Range-Free Wireless Localization in Industrial Warehouses via Multi-Level Binary Reachability](https://arxiv.org/abs/2609.09330)
...
### [7] [Probabilistic Symbol-Level Precoding based Affine Frequency Division Multiplexing Transmission](https://arxiv.org/abs/2609.09644)
...
### [8] [A Fully Wave-Domain Wideband MU MIMO OFDM Transmitter via Stacked Intelligent Metasurfaces](https://arxiv.org/abs/2609.09727)
...
### [9] [Sequential Transmit Covariance Optimization for Wireless Tracking Exploiting Observation History](https://arxiv.org/abs/2609.10124)
...
### [10] [Low-Complexity Maximum Likelihood Detection for Type-Based Over-the-Air Computation](https://arxiv.org/abs/2609.10136)
...
### [11] [Distributed ToA Localization of Acoustic Sources with Unknown Time of Emission via Operator Splitting](https://arxiv.org/abs/2609.10182)
...
### [12] [Covariance-Aware MM-PGD for Mixed Near-/Far-Field Activity Detection](https://arxiv.org/abs/2609.10207)
...
### [13] [Shaping Delay-Doppler Ambiguity in Practical OFDM-ISAC](https://arxiv.org/abs/2609.10300)
...
### [14] [Robust Continuous Human Activity Recognition Using Deep Learning and Distributed Radar Sensors](https://arxiv.org/abs/2609.10419)
...
### [15] [A Subsampled Davis-Kahan Bound for Large-Scale Eigenspace Estimation](https://arxiv.org/abs/2609.09211)
*Huan Qing*
...
### [16] [CAST: Canonical Approximate Schur Tree for Approximate Cholesky on Graphs](https://arxiv.org/abs/2609.09255)
...
### [17] [Tensor Network Moral Graph Recovery of Discrete Probability Distributions](https://arxiv.org/abs/2609.09258)
...
### [18] [Recovery Theory for Projected Power Iterations in Permutation Synchronization](https://arxiv.org/abs/2609.09502)
...
### [19] [Why Learning Rediscovers the Closed-Form Diagonal Regularizer](https://arxiv.org/abs/2609.09656)
...
### [20] [A Unifying Perspective on Probabilities as Model Predictions](https://arxiv.org/abs/2609.09855)
*Benedikt Höltgen*
...
### [21] [Optimal Value Inference for Reinforcement Learning](https://arxiv.org/abs/2609.09981)
...
### [22] [Subagents vs Agent Skills: Executing Reusable Knowledge for Long-Horizon Agentic Tasks](https://arxiv.org/abs/2609.09233)
...
### [23] [Gradland: On Phenomenal Experience, Differentiated Across Many Dimensions](https://arxiv.org/abs/2609.09306)
*David Balduzzi*
...
### [25] [ContractEval: Query-Conditioned Execution Matching for Procedural Instruction Conformance](https://arxiv.org/abs/2609.09458)
...
### [26] [RobustSGPO: Search-Space Control for Agent Harness Evolution](https://arxiv.org/abs/2609.09646)
...
### [27] [Black-Box Red Teaming of Agentic AI: A Taxonomy-Driven Framework for Automated Risk Discovery](https://arxiv.org/abs/2609.09647)
...
### [28] [RESCUE-BENCH: Towards Relation-Aware Multi-Party Emotional Support Conversation Systems](https://arxiv.org/abs/2609.09657)
...
### [29] [PRAGMA: Evaluating Personalized Guidance with Memory Alignment in Lifelong Conversations](https://arxiv.org/abs/2609.09664)
...
### [30] [Safe to Stop? Risk-Constrained Stopping for Sequential Clinical Diagnosis Agents](https://arxiv.org/abs/2609.09678)
...
### [31] [Decision Shifts, Lost Label Functionality, and an Inconclusive Grounding Audit in Correctness-Gated Multi-Teacher Distillation](https://arxiv.org/abs/2609.09702)
*Xiaofei Feng*
...
### [32] [Which Tokens Should SFT Actually Learn? A Token-Trimming Perspective on Mathematical Reasoning](https://arxiv.org/abs/2609.09707)
...
### [33] [Can Artificial Intelligence Support Healthcare and Mental Health Through Early Cyberbullying Detection ? The Impact of Emotion-Aware AI on Proactive Online Safety](https://arxiv.org/abs/2609.09735)
...
### [34] [LexAgentHallu: A Hierarchical Benchmark for Profiling Hallucinations in Legal Agents](https://arxiv.org/abs/2609.09754)
...
### [35] [Proof-Carrying Cognition: Closing the Verification Gap with Reality-Settled Reward](https://arxiv.org/abs/2609.09776)
...
### [36] [Shifting Relational Paradigms for Affective Computing: Affective Resonance, Vitality Affects, and Vocal Interaction Fields](https://arxiv.org/abs/2609.09864)
...
### [38] [Structural Process Supervision for Latent Chain-of-Thought Reasoning](https://arxiv.org/abs/2609.09928)
...
### [39] [Belief-State Engine: Augmenting LLMs for Principled Planning Under Partial Observability](https://arxiv.org/abs/2609.10036)
...
### [41] [Beyond Surface Imitation: Contrastive Modeling for Reasoning Path Alignment in Multimodal In-Context Learning](https://arxiv.org/abs/2609.10177)
...
### [42] [What Should an Agent Forget? Separating What Is Stored from What Is Used](https://arxiv.org/abs/2609.10263)
*Yuhang Li,Yuchen Li*
...
### [43] [From Symbolic Perception to Logical Deduction: A Framework for Guiding Language Models in Geometric Reasoning](https://arxiv.org/abs/2609.10335)
...
### [44] [ConvMem: Convolutional Memory for Long-Context Reasoning](https://arxiv.org/abs/2609.10441)
...
### [45] [Physics-informed neural networks by Gradient-Guided Gaussian Adaptive Sampling (3GAS-PINNs)](https://arxiv.org/abs/2609.09162)
...
### [46] [Scaling Post-Training Ternarisation to Qwen3-8B Capability Retention, Reproduction, Lossless Packing, and Packed Execution](https://arxiv.org/abs/2609.09240)
...
### [47] [Distribution-Consistent Inference for Dynamic Sparse Mixture-of-Experts](https://arxiv.org/abs/2609.09241)
...
### [48] [DiffLUT-Net: Differentiable Training of FPGA LUT Networks with Learnable Connectivity](https://arxiv.org/abs/2609.09254)
...
### [49] [XAI-Refine: An Automated Explanation-Knowledge Loop for Brain-Age Prediction](https://arxiv.org/abs/2609.09388)
...
### [50] [Applying foundation model embeddings towards urban livability evaluation](https://arxiv.org/abs/2609.09429)
...
### [51] [SCCM : Stream Cruise Control Method for Automated Drift Detection and Adaptation](https://arxiv.org/abs/2609.09432)
...
### [52] [Tensor-Train Weak SINDy: Identifying High-Dimensional Nonlinear Dynamics](https://arxiv.org/abs/2609.09434)
...
### [53] [Muon-C: Operator-Aligned Muon for Convolutional Kernels](https://arxiv.org/abs/2609.09676)
...
### [54] [Beyond Conventional Federated Learning via High-Order Regularization](https://arxiv.org/abs/2609.09904)
...
### [55] [Uncertainty-Aware Sea-Ice Type Mapping with Multiple Ice Charts](https://arxiv.org/abs/2609.09451)
...
### [56] [Building the Harness Automatically: Self-Play in Code Distills a Text Harness for Black-Box Optimization](https://arxiv.org/abs/2609.09468)
...
### [57] [A Statistical Approach to Estimating Sample Size of Machine Learning Models](https://arxiv.org/abs/2609.09547)
...
### [58] [Robust Industrial Cyber Physical Classification Using Neuromorphic Temporal Embeddings and Hybrid SNN XGBoost Under Machine Unlearning Attacks](https://arxiv.org/abs/2609.09564)
...
### [59] [Positional task conditioning for scalable defect detection across product families in large product catalogs](https://arxiv.org/abs/2609.09567)
...
### [60] [EEGBind: Detecting Source-Level Interictal Epileptiform Discharges via EEG-Centric Multimodal Binding](https://arxiv.org/abs/2609.09728)
...
### [62] [Privacy-Preserving Split Learning for Federated LLM Fine-Tuning](https://arxiv.org/abs/2609.09794)
...
### [63] [A practical DIRECT-type algorithm for medium-scale black-box global optimization](https://arxiv.org/abs/2609.09796)
...
### [64] [TempTPI: Informer-Based trajectory prediction for maritime vessels](https://arxiv.org/abs/2609.09840)
...
### [65] [Forward-Free LLM Depth Pruning via Weight Redundancy](https://arxiv.org/abs/2609.09883)
...
### [66] [Meta-LinEXP3: Online-within-Online Learning for Adversarial Linear Contextual Bandits](https://arxiv.org/abs/2609.09907)
...
### [67] [A Kernel-Based Modular Discriminant Analysis Framework for Small-Sample Learning](https://arxiv.org/abs/2609.09910)
*Lingxiao Qu,Yan Pei*
...
### [68] [Development and Validation of a Physics-Guided Machine Learning Extrapolation Framework Using a Classical Transient Diffusion Benchmark](https://arxiv.org/abs/2609.09912)
...
### [69] [Deep Neural Networks for Learning Intent from sEMG Signals to Support Hardware Devices for Post-Stroke Neurorehabilitation](https://arxiv.org/abs/2609.09971)
...
### [71] [Storage-Scalable Progressive Semantic Communication via Knowledge-Base Reuse](https://arxiv.org/abs/2609.10112)
