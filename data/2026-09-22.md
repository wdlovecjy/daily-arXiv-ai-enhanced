...
### [1] [Locally Private Inference for Riemannian Stochastic Optimization](https://arxiv.org/abs/2609.22642)
...
### [2] [Conformal Robustness in Prediction-Driven Decision-Making](https://arxiv.org/abs/2609.23170)
...
### [3] [Bayesian Deck-of-cards-based Ordinal Regression with Sequential Preference Elicitation](https://arxiv.org/abs/2609.23212)
...
### [4] [OSCAR: Order-aware Scoring and Calibration for AI Rankings](https://arxiv.org/abs/2609.24128)
...
### [5] [TEMPER: Temporal Encoder-Masked Probabilistic Ensemble Regressor for Time-Series Forecasting](https://arxiv.org/abs/2609.23701)
...
### [6] [Exponential Family Synthetic Controls](https://arxiv.org/abs/2609.23970)
...
### [7] [Causal Bayesian Optimization: Foundations, Methods, and Applications](https://arxiv.org/abs/2609.24112)
...
### [8] [Model-Agnostic Feature Selection via LOCO-Guided Adaptive Minipatch Sampling](https://arxiv.org/abs/2609.24126)
...
### [9] [JAREX: An Acquisition Function for Multi-Objective Algorithmic Process Characterization](https://arxiv.org/abs/2609.24954)
...
### [10] [When Is Availability-Aware Training Worth It? A Benchmark and Empirical Study of Interruption-Resilient Optimization Under Predictable Compute Schedules](https://arxiv.org/abs/2609.22087)
*Subhadip Mitra*
...
### [11] [DC-CLM: Extending the WECC Composite Load Model for AI Data Center Dynamics](https://arxiv.org/abs/2609.22093)
...
### [12] [Beyond the Raw Waveform: Fusing Visual Representations of EDA for Stress Detection](https://arxiv.org/abs/2609.22095)
...
### [13] [Fluid Antenna Channel Reconstruction with Non-Negative Least Square Detector](https://arxiv.org/abs/2609.22137)
...
### [14] [HFEMCNet: A Compact Hybrid Frequency Enriched Multi Channel Network for Automatic Modulation Classification](https://arxiv.org/abs/2609.22139)
...
### [18] [Dynamic Mode Decomposition by Tensor Evolution for Source Depth](https://arxiv.org/abs/2609.22266)
...
### [19] [Machine Learning for Underwater Optical Wireless Communication Systems: A Comprehensive Survey](https://arxiv.org/abs/2609.22294)
...
### [20] [OTFS-Enabled Delayed SINR-Feedback Power Control for Reliable and Fair High-Mobility UAV Communications](https://arxiv.org/abs/2609.22309)
...
### [21] [Differentiable Synthesis and Yield Optimization of Cross-Coupled Resonator Filters](https://arxiv.org/abs/2609.22310)
*Orion Georgiou*
...
### [22] [Data-Aided Bayesian Learning for CSI Estimation over Doubly-Selective DCO-OTFS MIMO VLC Channels with Affine-Precoded Superimposed Training Sequences](https://arxiv.org/abs/2609.22312)
...
### [23] [Integrated Sensing and Communications: A Tutorial on Mathematical Foundations, Signal Processing and System Design for 6G](https://arxiv.org/abs/2609.22314)
*Sabit Ekin*
...
### [24] [Transparentize A Shallow Cryosphere: High-Resolution Subsurface Imaging using UAV-Borne GPR A review and prospective](https://arxiv.org/abs/2609.22326)
...
### [25] [Exact Dynamic Range--Robustness Tradeoff for Chinese Remainder Theorem under Non-Uniformly Bounded Remainder Errors](https://arxiv.org/abs/2609.22615)
...
### [26] [Electrodermal Activity (EDA) for Stress Detection: A Comprehensive Survey and Benchmark](https://arxiv.org/abs/2609.22622)
...
### [27] [TiamiTwin: A Digital Twin for Bistatic ISAC Drone Sensing, Validated Against Measurements](https://arxiv.org/abs/2609.22709)
...
### [28] [Full-Frame OFDM-ISAC: Joint Constellation, Pilot, and Receive-Filter Design](https://arxiv.org/abs/2609.22994)
...
### [29] [A Portable Multichannel Kilohertz Current Stimulator for Selective Peripheral Transcutaneous Stimulation](https://arxiv.org/abs/2609.23075)
...
### [30] [Pre- and Post-Exercise Monitoring of Physiological Skin States in Sportsmen Using 77 GHz FMCW Radar and Wavelet Scattering Transform](https://arxiv.org/abs/2609.23158)
...
### [31] [X-LIBS: Interpretable Soil Classification Using Explainable AI and Laser-Induced Breakdown Spectroscopy](https://arxiv.org/abs/2609.23204)
...
### [32] [Fiber-Topology-Assisted Indoor Positioning Under UWB Degradation with Fixed-Lag Factor Graphs](https://arxiv.org/abs/2609.23568)
...
### [33] [Fast Graph Laplacian Estimation using Effective Resistance](https://arxiv.org/abs/2609.23668)
...
### [34] [From Ideal Motion to Flight-Executable Communications: LLM-Evolved Multi-UAV Deployment for Cell-Free Massive MIMO](https://arxiv.org/abs/2609.23992)
...
### [35] [Sensing While Communicating: Active Online Spectrum Cartography via Air-Ground Cooperation](https://arxiv.org/abs/2609.24119)
...
### [36] [Joint Channel Estimation, Detection, and Resource Allocation for OTFS-RSMA](https://arxiv.org/abs/2609.24121)
...
### [37] [Supervised Device Charting with CSI Measurements from Commercial 5G NR User Equipments](https://arxiv.org/abs/2609.24213)
...
### [38] [Learning to Maximize Energy Efficiency in 6G in-X Subnetworks](https://arxiv.org/abs/2609.24263)
*Ramoni Adeogun*
...
### [39] [Neural Kalman Filtering for Unknown Dynamics: Task-Aware Learning with a Koopman Backbone](https://arxiv.org/abs/2609.24763)
...
### [40] [PRQuant: Permutation Residual Quantization for Low-Overhead Inference](https://arxiv.org/abs/2609.22106)
...
### [41] [Correcting Learning-based Perception for Safety](https://arxiv.org/abs/2609.22108)
...
### [42] [A Shared Learning Rate Is Not a Neutral Control in Selective On-Policy Distillation](https://arxiv.org/abs/2609.22109)
*Chencheng Zhu*
...
### [43] [Toward Fairness in Machine Learning Models for Predicting Treatment Retention and Premature Discontinuation in Medication for Opioid Use Disorder](https://arxiv.org/abs/2609.22113)
...
### [44] [ZoAQ: Adaptive Zeroth-Order Querying via Query-Reuse Coupling](https://arxiv.org/abs/2609.22115)
...
### [45] [Success Leaves Detours: Learning Executable Walkthroughs for Long-Horizon Agents](https://arxiv.org/abs/2609.22120)
...
### [46] [Modelling daily activity patterns from mobile phone location data via deep representation learning](https://arxiv.org/abs/2609.22121)
...
### [47] [Rank Portability Does Not Imply Feasibility Portability: Target-Specific Evaluation of Joint Hardware Constraints](https://arxiv.org/abs/2609.22122)
*Wesley Shu*
...
### [48] [StationPDE: Station-Oriented Surface PDE Learning for Multi-Station Multivariate Weather Forecasting](https://arxiv.org/abs/2609.22123)
...
### [49] [Weak Ties, Strong Signals: Efficient Training Data Detection in Diffusion LLMs via Independent Token Sampling](https://arxiv.org/abs/2609.22145)
...
### [50] [GRRR: The Geometry of Reshaping, Rotation, and Routing in Decoder LLM post-training](https://arxiv.org/abs/2609.22146)
...
### [51] [SafeTune: A Unified Faithful Library for Auditing and Repairing Safety Drift in Fine-Tuned LLMs](https://arxiv.org/abs/2609.22153)
...
### [52] [From Latent Biomarkers to Clinical Rules: Embedding-Guided Rule Mining and Attribution-Based Translation for Interpretable Tabular Learning](https://arxiv.org/abs/2609.22155)
...
### [53] [The Limits of Speculation: Bounding Speculative Decoding in Mixture-of-Experts](https://arxiv.org/abs/2609.22156)
...
### [54] [PAGE: Partition-Aware Gated KV-Cache Eviction](https://arxiv.org/abs/2609.22157)
...
### [55] [Uncertainty and Business-Aware Remaining Useful Life Estimation for Semiconductor Manufacturing](https://arxiv.org/abs/2609.22160)
...
### [56] [TARGet: Topology-Aware Fusion-based Radio Frequency Circuit Functional Modeling using Graph Neural Networks](https://arxiv.org/abs/2609.22165)
...
### [57] [Clustering-Based Collective Anomaly Detection in IoT Systems: A Graph Neural Network Approach](https://arxiv.org/abs/2609.22166)
...
### [58] [Role-Aware Morgan Fingerprints for Reaction Yield Prediction](https://arxiv.org/abs/2609.22167)
...
### [59] [Classification with Abstention Under Class-Conditional Error Constraints](https://arxiv.org/abs/2609.22632)
...
### [60] [Monotone-Constrained Diffusion Models for Long-Horizon Production Forecasting](https://arxiv.org/abs/2609.22643)
...
### [61] [On attention heads and bilinear forms](https://arxiv.org/abs/2609.22990)
*Andrew O'Desky*
...
### [62] [Beyond Task Completion: Training Capable and Safe Computer-Use Agents](https://arxiv.org/abs/2609.22178)
...
### [63] [Decoupled Causal Discovery](https://arxiv.org/abs/2609.23535)
...
### [64] [Gaussian Process Decorrelation for Spatiotemporal Deep Learning-Based Snow Water Equivalent Prediction](https://arxiv.org/abs/2609.22182)
...
### [65] [CleanScore: Black-Box Benchmark Audits with Negative Controls and Sensitivity Bounds](https://arxiv.org/abs/2609.22183)
...
### [66] [A Distributional Optimisation Perspective on Combining Models in Deep Learning](https://arxiv.org/abs/2609.24328)
...
### [67] [Adaptive Physics-Informed Neural Networks for the Blasius Boundary-Layer Problem](https://arxiv.org/abs/2609.22185)
...
### [68] [A Pinch of SFT, A Dash of RL: When Reinforcement Learning Helps Long-Horizon Advertising Agents](https://arxiv.org/abs/2609.22194)
...
### [69] [EvoRank: LLM-Guided Evolution of Multi-Objective Learning-to-Rank Pipelines](https://arxiv.org/abs/2609.22196)
...
### [70] [Dissecting Hierarchical Reasoning Models: A Mechanistic Study](https://arxiv.org/abs/2609.22197)
...
### [71] [Improving Parameter Utilization by Sharing Neural Experts Across Layers in Transformers](https://arxiv.org/abs/2609.22199)
...
### [72] [Prediction of Nonlinear Oscillations in a Jumping Quarter-Car Model Using Reservoir Computing](https://arxiv.org/abs/2609.22205)
...
### [76] [Universal Observatory Graphs for Distributed Sky Coverage and Artificial Intelligence Based Interplanetary Routing](https://arxiv.org/abs/2609.22244)
...
### [77] [CHART: A Harness-Rotation Curriculum for Harness-Robust Search Agents](https://arxiv.org/abs/2609.22247)
...
### [78] [CAMFT: Conflict-Aware Mergeable Fine-Tuning for Large Language Models](https://arxiv.org/abs/2609.22253)
...
### [79] [AirGC-CD: Gaussian-Circulant Precoding for Exactly Debiasable PAPR Reduction in Over-the-Air Federated Learning](https://arxiv.org/abs/2609.23084)
...
### [80] [Ask for Any Appliance: A Prompt-Programmable Foundation Model for Non-Intrusive Load Monitoring](https://arxiv.org/abs/2609.23146)
...
### [81] [Strategy Accumulation and Guided Execution for Automated LLM Fine-Tuning](https://arxiv.org/abs/2609.22257)
...
### [82] [Efficient Mixture-of-Experts with Speculative Decoding via Expert Coactivation](https://arxiv.org/abs/2609.22471)
...
### [83] [COREM: Cosine-Relation Momentum Reshaping with Stateful Writeback](https://arxiv.org/abs/2609.22487)
...
### [84] [The Ups and Downs of Backprop Weights](https://arxiv.org/abs/2609.22554)
...
### [85] [Benchmarking Hybrid Deep Learning Architectures for Predictive Maintenance in Industry 4.0](https://arxiv.org/abs/2609.22583)
...
### [86] [Augmenting PID Control with Deep Reinforcement Learning: A Hybrid Approach to the Industrial Benchmark](https://arxiv.org/abs/2609.22584)
...
### [87] [TWIG: A Time-Causal Wavelet Operator for Autoregressive Forecasting on Irregular Graphs](https://arxiv.org/abs/2609.22585)
...
### [88] [User-Level Handover Decision Making Based on Machine Learning Approaches](https://arxiv.org/abs/2609.22593)
...
### [89] [Concurrency-Aware Process Model Forecasting with Causal Nets](https://arxiv.org/abs/2609.22614)
...
### [90] [Autonomous Model Lifecycle Management for Digital Twin-Based Manufacturing Control](https://arxiv.org/abs/2609.22701)
...
### [95] [A Hybrid Attention Model Learning Unified Time-aware Patch Representation for Irregular Multivariate Time Series Forecasting](https://arxiv.org/abs/2609.22836)
...
### [96] [Testing the Construct Validity of a Functional Valence Axis in LLM Agents](https://arxiv.org/abs/2609.22850)
...
### [97] [Causilo Technical Report](https://arxiv.org/abs/2609.22866)
...
### [98] [Towards Full Pipeline FP8 Reinforcement Learning for LLMs](https://arxiv.org/abs/2609.22870)
...
### [99] [Merge++: Universal Merge Refinement Through Data-Free Checkpoint Inversion](https://arxiv.org/abs/2609.22886)
...
### [102] [Optimizers for Diffusion Models: A Controlled Benchmark](https://arxiv.org/abs/2609.23055)
...
### [103] [Neural Spectral Capacity: Measuring and Designing Architectures from Network Specification Alone](https://arxiv.org/abs/2609.23087)
...
### [104] [Perplexity Cost Understates What Activation Quantisation Breaks](https://arxiv.org/abs/2609.23125)
...
### [105] [Neural Residual Modeling for Scientific Data Compression under Guaranteed Error Bounds](https://arxiv.org/abs/2609.23185)
...
### [106] [Why Ghost Outputs Teach: A Kernel-Based Understanding of Subliminal Learning](https://arxiv.org/abs/2609.23260)
...
### [107] [A Patient World Model for Early Forecasting of Digital Health Campaign Outcomes: Capabilities and Limits](https://arxiv.org/abs/2609.23333)
*Yunlong Wang*
...
### [108] [The Evidence Ladder for Reinforcement Learning in Healthcare: From Retrospective Policies to Trusted Interventions](https://arxiv.org/abs/2609.23374)
*Yunfan Zhao*
...
### [109] [Discovering Physical Representation Languages](https://arxiv.org/abs/2609.23381)
...
### [110] [Blind Thermodynamic Ontology Discovery from Anonymous Experiments](https://arxiv.org/abs/2609.23387)
*Linzhe Zhang,Changming Xu*
...
### [111] [TRACE: Tractable Routing Autoencoder for Clinical ECG](https://arxiv.org/abs/2609.23460)
...
### [112] [ITSY: Causal Discovery From Irregular Time-Series Data](https://arxiv.org/abs/2609.23516)
...
### [113] [Preserving Geometric Integrity in Graph Prompting via Measure-Constrained Optimal Transport](https://arxiv.org/abs/2609.23547)
...
### [114] [Physics-residual machine learning predicts oxygen-evolution catalyst activity beyond the training range from sparse polarization measurements](https://arxiv.org/abs/2609.23549)
...
### [115] [Global Ranks Survive, Selected Heads Shift: BOS-Sink Topology under 4-bit Weight-Only Quantization](https://arxiv.org/abs/2609.23585)
...
### [116] [Cost-Aware Reinforcement Learning with Action Masking and Projection for Battery Energy Storage Dispatch under Suppressed-Spread Market Shifts](https://arxiv.org/abs/2609.23590)
*Kuanlin Chen,Chen-Wei Kuo,Cheng-En Ou*
...
### [117] [Bilinear Optimization Divergence: Diagnosing Factor-Constrained LoRA Continual Learning](https://arxiv.org/abs/2609.23594)
...
### [118] [ETH-TraceBench: A Large-Scale Event-Stream Benchmark for Ethereum DeFi under Temporal, Protocol, and Contract Shift](https://arxiv.org/abs/2609.23659)
...
### [119] [One Patch, Three Roles: What Is Actually Coupled in Autoregressive Time-Series Forecasting?](https://arxiv.org/abs/2609.23686)
...
### [120] [A multi-temporal dataset for mapping burned areas in the Brazilian Cerrado using time series of remote sensing imagery](https://arxiv.org/abs/2609.23687)
...
### [121] [Statistical Convergence of Transformer Encoder-Accelerated Robust Reinforcement Learning](https://arxiv.org/abs/2609.23775)
...
### [122] [Falling Trees: A Model Class for Interpretable Risk Prioritization](https://arxiv.org/abs/2609.23780)
...
### [123] [Actionable Insights from Observational Data: The Case of Advanced Classes in K-12 Education](https://arxiv.org/abs/2609.23836)
...
### [124] [GLR-MM: Graph-Based Global-Local Reconstruction for Robust Multimodal Chest X-ray and EHR Representation Learning under Missing Modalities](https://arxiv.org/abs/2609.23876)
...
### [125] [PROSE: A Theory of Optimal Stopping with Perishable Evidence for Peer Selection in Intermittently Connected Decentralised Learning](https://arxiv.org/abs/2609.23845)
...
### [126] [Misaligned Clinical Risk Classification and Cost Asymmetry in Open-Weight Large Language Models](https://arxiv.org/abs/2609.23999)
...
### [127] [FlashBoB: I/O-Efficient Exact Backward-over-Backward for Softmax Attention](https://arxiv.org/abs/2609.24089)
...
### [128] [Opinion Leader Dynamics: How Sparse Attention Shapes Token Clustering](https://arxiv.org/abs/2609.24202)
...
### [129] [GDN Tree-Scan: Served Tree Verification for Recurrent-Hybrid Language Models](https://arxiv.org/abs/2609.23900)
*Zhiyuan Ma*
...
### [130] [KV-COBRA: KV Cache Compression via Co-Optimized Bit-Rank Allocation](https://arxiv.org/abs/2609.24298)
...
### [131] [The Undetected Damage of Quantization on Retrieval and How to Fix It](https://arxiv.org/abs/2609.24322)
...
### [132] [Artificial Structure Function Search: Preserving Artificial Functional Connectivity for Structured Pruning](https://arxiv.org/abs/2609.24401)
...
### [133] [WPBench: A Comprehensive Benchmark for Wind Power Forecasting](https://arxiv.org/abs/2609.24444)
...
### [134] [Graph-to-Grid (G2G): Continuous-Coordinate Feature Painting for Soccer Pass Surfaces](https://arxiv.org/abs/2609.24040)
...
### [135] [Lifted Bellman Linear Programming for Offline Reinforcement Learning](https://arxiv.org/abs/2609.24489)
...
### [136] [Q-DEQ: Discrete Solving and Quantization for Deep Equilibrium Models in Time Series Forecasting under Edge Deployment Coding Constraints](https://arxiv.org/abs/2609.24042)
...
### [137] [On Emergent Capabilities and Model Merging](https://arxiv.org/abs/2609.24504)
...
### [138] [Overlay\_dx - Automating forecasting evaluation](https://arxiv.org/abs/2609.24586)
...
### [139] [GraphToolbox: A Configurable Python Framework for Graph Neural Network Forecasting](https://arxiv.org/abs/2609.24609)
...
### [140] [Mind or Message? Auditing Theory of Mind in Multi-Agent Social Simulation](https://arxiv.org/abs/2609.24146)
...
### [141] [Enhancing Transformer Representations of Symbolic ODE Expressions](https://arxiv.org/abs/2609.24746)
...
### [142] [When Tomorrow Becomes Today: Self-Evolving Policies for Agentic Time-Series Forecasting](https://arxiv.org/abs/2609.24862)
...
### [143] [H-Spec: Parallel Speculative Decoding Without a Drafter-Side KV Cache](https://arxiv.org/abs/2609.24197)
...
### [144] [Rare Event Estimation via Iterative Unalignment](https://arxiv.org/abs/2609.24969)
...
### [145] [Displacement Geometry Captures Platonic Shared Reality Across Models and Modalities](https://arxiv.org/abs/2609.24209)
...
### [146] [RRSI: Regularized Recursive Self-Improvement of Agent Harnesses](https://arxiv.org/abs/2609.24972)
...
### [147] [SupportCal: Label-Free Calibration of Post-Trained LLMs via Reference Support and Corroboration](https://arxiv.org/abs/2609.24303)
...
### [148] [Prescriptive SVD-Inspired Attention via Spectral Energy Retention](https://arxiv.org/abs/2609.24370)
...
### [149] [Machine Learning-Based Prediction of Childhood Stunting in Bangladesh: Fairness and Temporal Robustness Assessment](https://arxiv.org/abs/2609.24386)
...
### [150] [NAVIR: Neuromorphic Audio-Visual Speech Recognition for Robust Human-Robot Interaction on Edge Hardware](https://arxiv.org/abs/2609.24391)
...
### [151] [Climate Variability Modulates the Impact of Price Spikes on Food Insecurity](https://arxiv.org/abs/2609.24394)
...
### [152] [Probabilistic Modelling of Operational Design Domains, A New Approach for Testing AI Systems](https://arxiv.org/abs/2609.24397)
...
### [153] [Comparing Latent Concept Formation in State Space Models and Transformers via Sparse Autoencoders](https://arxiv.org/abs/2609.24440)
...
### [154] [MUSE: Dependency-Aware Adaptation of a Frozen Vision Backbone for Multivariate Time Series Forecasting](https://arxiv.org/abs/2609.24441)
...
### [155] [RAILS: Retrieval-Augmented Incremental LLM Clustering at Scale](https://arxiv.org/abs/2609.24464)
...
### [156] [A Temporal Knowledge Graph for Music Festival Lineup Forecasting](https://arxiv.org/abs/2609.24467)
...
### [157] [Guaranteed Low-Rank Tensor Recovery from Modewise Measurements via Normalized Block-Weighted Riemannian Gradient Descent](https://arxiv.org/abs/2609.24679)
...
### [158] [Complex KDA: Understanding and Enhancing the Expressivity of Kimi Delta Attention](https://arxiv.org/abs/2609.24797)
...
### [159] [Learning Prognostic Variables for AI Convective Parameterizations via Symbolic Distillation](https://arxiv.org/abs/2609.24882)
...
### [160] [Learning Physics from an Imperfect Ancestor](https://arxiv.org/abs/2609.24947)
...
### [161] [Critical-State RL: Diagnosing Trainable States for Multi-Turn Tool Use](https://arxiv.org/abs/2609.24985)
...
### [168] [Agreement Overstates Evidence: Error Dependence in LLM Judge Consensus](https://arxiv.org/abs/2609.22512)
...
### [169] [IntLawNER: A Named Entity Recognition Dataset and Benchmark in International Law](https://arxiv.org/abs/2609.22529)
...
### [170] [MAWILE: Multi-Axis Workbench for Inspecting LLM Evaluators](https://arxiv.org/abs/2609.22599)
...
### [171] [GaitVista: Reliability-Aware AI Measurement toward Accessible Longitudinal Gait Assessment](https://arxiv.org/abs/2609.22619)
...
### [172] [Splitting Documents at Lower Cost: Multi-Split Boundary Decisions for LLM-Based Page Stream Segmentation](https://arxiv.org/abs/2609.22620)
...
### [173] [Text, Pixels, or Both? Evaluating Input Representations for Multimodal Document QA](https://arxiv.org/abs/2609.22628)
*Nikhil Reddy Pottanigari,Sepideh Kharaghani,Saverio Vadacchino,Alejandro Posada,Ying Zhang*
...
### [174] [Self-Organizing Agent Teams Learn to Reason Together](https://arxiv.org/abs/2609.22682)
...
### [175] [Toward Auditable and Calibrated AI for Dementia-Related Crash Severity Prediction: A Selective Deferral Framework to Support Human Review](https://arxiv.org/abs/2609.22694)
...
### [176] [A Survey on the Linear Representation Hypothesis](https://arxiv.org/abs/2609.22695)
...
### [177] [Building Trustworthy Mental Health Benchmarks on Bluesky: A Validation-Aware Weak-Supervision Framework](https://arxiv.org/abs/2609.22696)
...
### [178] [Hapi: A Multivariable Land-Surface Transformer for Medium-Range Hydrological Forecasting at Continental Scale](https://arxiv.org/abs/2609.22702)
...
### [179] [CTSpinoPelvic1K: spine, pelvis, ribs and femora in one coordinate frame, annotated for lumbosacral transitional anatomy](https://arxiv.org/abs/2609.22760)
...
### [180] [From Research Frontier to Laboratory Bench: Design of a Four-Tier Experimental Teaching System for Multimodal Medical Image Intelligent Diagnosis](https://arxiv.org/abs/2609.22790)
...
### [181] [When Should a VLM Look? Paying Only for Visual Calls That Were Needed and Used](https://arxiv.org/abs/2609.22910)
...
### [182] [Beyond Linear Context: Graph-Guided Evidence Navigation for Long-Novel Reasoning with a Local 9B Language Model](https://arxiv.org/abs/2609.22939)
*Wenji Fu*
...
### [183] [A Compact Stance-Indexed Anterior-Posterior COP Representation for Parkinson's Disease Classification from Plantar VGRF](https://arxiv.org/abs/2609.22956)
...
### [184] [R-GEAN: Regimen-Guided Edit Action Network for Within-Admission Medication Change Prediction](https://arxiv.org/abs/2609.22959)
...
### [185] [OptiSkill: A Hierarchical and Evolving SkillBank for LLM-Based Optimization Modeling](https://arxiv.org/abs/2609.22987)
...
### [186] [Spatial-Interactor: Learning Spatial Reasoning through Interaction with the Observable Physical World](https://arxiv.org/abs/2609.23038)
...
### [187] [Event Signature Transfer: Model-Agnostic Forecast Scenario Construction from Historical Events](https://arxiv.org/abs/2609.23074)
...
### [188] [CraftBench-UE: Deterministic Evaluation for Coding Agents in Unreal Engine](https://arxiv.org/abs/2609.23142)
...
### [189] [Expansion Counts under Standard A* Tie-Breaking Strategies on the Final Plateau](https://arxiv.org/abs/2609.23293)
*Alex Fukunaga*
...
### [190] [AgentBetta: Verification-Driven Adaptive Configuration of an AI Nano-Agent through Selective Expansion and Verified Contraction](https://arxiv.org/abs/2609.23512)
*Md. Ashraful Babu*
...
### [191] [Are Human-Aligned Models Models of Humans? A Turing-Test Gap in Preference Alignment](https://arxiv.org/abs/2609.23640)
...
### [192] [WorkWorlds: An Infrastructure for Evaluating AI Agents on Workplace Tasks](https://arxiv.org/abs/2609.23806)
...
### [193] [Explainable Recommendations at Scale: LLM Rationales for YouTube Music Artist Discovery](https://arxiv.org/abs/2609.23877)
...
### [194] [Agents That Edit Documents: Measuring Agentic PDF Forgery Against a Non-Agentic Control](https://arxiv.org/abs/2609.23953)
...
### [195] [Divergent strategies and convergent outcomes in autonomous materials discovery](https://arxiv.org/abs/2609.23957)
*Jihan Kim*
...
### [196] [LEAP-NBV: Lightweight Edge Active-Perception for Foundation-Model Next-Best-View Planning](https://arxiv.org/abs/2609.23974)
...
### [197] [FinInteract: Benchmarking Clarification and Intent Integration in Ambiguous Financial Question Answering](https://arxiv.org/abs/2609.24002)
...
### [198] [Synthesizing Reactive Character Behaviors for Continuous Games via Programmatic Policy Search](https://arxiv.org/abs/2609.24025)
...
### [199] [When More Evidence Hurts: Publication-Bias Drift and Principled Stopping for Biomedical Causal Search](https://arxiv.org/abs/2609.24101)
...
### [200] [CREDO: Variance-Guided Rubric Evolution for Replay-Corrected Credit Assignment](https://arxiv.org/abs/2609.24174)
*Xuchun Hu*
...
### [201] [SKstars at SHROOM: Visions Agreement-Guided Ensembling of Zero-Shot and LoRA-Adapted Vision--Language Models](https://arxiv.org/abs/2609.24198)
...
### [202] [Recovering Lost Details: Multi-Scale Frequency Compensation for Long-Term Time Series Forecasting](https://arxiv.org/abs/2609.24229)
...
### [203] [How Many Pixels Is a Digit Worth? Place-Aware Coordinate Entropy for GUI Agent Confidence Estimation](https://arxiv.org/abs/2609.24277)
...
### [204] [When and How Should an Agent Clarify? CIGAsk: Teaching LLMs to Clarify via Counterfactual Information Gain](https://arxiv.org/abs/2609.24290)
*Yunxiang Li,Xixin Wu,Helen Meng*
...
### [205] [Predicting Postprandial Glycemic Response from Meal Images, Clinical Variables, and Gut Microbiome Information](https://arxiv.org/abs/2609.24453)
...
### [206] [Ascent: An Agentic System over the Model Context Protocol for Real-World Clinical Data Analysis](https://arxiv.org/abs/2609.24620)
...
### [207] [Custom Named Entity Recognition and Topic Classification for Global Health Publications](https://arxiv.org/abs/2609.24625)
...
### [208] [DUMA-Bench: A Dual-Control Multi-Agent Benchmark for Evaluating LLM Agent Security](https://arxiv.org/abs/2609.24662)
...
### [209] [TimeLitmus: A Diagnostic Benchmark for Cross-Modal Understanding and Explanation Faithfulness in Event-Conditioned Time-Series Prediction](https://arxiv.org/abs/2609.24677)
...
### [210] [Epi-Logic: A Conceptual Framework for Epistemic Runtime Control, Schema Validity Checking, and Controlled Accommodation in Autonomous AI Agents](https://arxiv.org/abs/2609.24755)
*Boris Wetzk*
...
### [211] [Construting Reverse Thinking: Developing Large Language Models' Reverse Thingking Ability](https://arxiv.org/abs/2609.24760)
...
### [212] [Partner-Specific Affective Precision in Social Active Inference](https://arxiv.org/abs/2609.24876)
...
### [213] [Et Tu, Brute? Economic Misalignment in Personal AI Agents](https://arxiv.org/abs/2609.24927)
...
### [214] [Emergent Collusion in Long-Horizon LLM Agent Interaction](https://arxiv.org/abs/2609.24967)
...
### [215] [Adapting Pairs Trading to Gambling Markets A Case Study of the U.S. Presidential Election](https://arxiv.org/abs/2609.22639)
...
### [216] [Auditing Bayesian Graph Alignment: Diagnostic Comparisons and Reference Failure](https://arxiv.org/abs/2609.23232)
...
### [217] [Fear Moves Markets: Sentiment-Augmented POMP for Volatility Modeling of Bitcoin Returns](https://arxiv.org/abs/2609.23250)
...
### [218] [Transporting summary measures of relative effects from randomised trials to the treated patient population: an application to breast cancer endocrine therapy](https://arxiv.org/abs/2609.24305)
...
### [219] [Overcoming Model Misspecification in Bayesian Inference of Molecular Signalling Networks](https://arxiv.org/abs/2609.24590)
