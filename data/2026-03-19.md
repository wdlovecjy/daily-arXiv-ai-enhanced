...
### [1] [Model Selection via Focused Information Criteria for Complex Data in Ecology and Evolution](https://arxiv.org/abs/2603.16896)
...
### [2] [How Proxy Race Distorts Regression-Based Fairness Audits](https://arxiv.org/abs/2603.17106)
...
### [3] [Multivariate GARCH and portfolio variance prediction: A forecast reconciliation perspective](https://arxiv.org/abs/2603.17463)
...
### [4] [Transformers are Bayesian Networks](https://arxiv.org/abs/2603.17063)
*Gregory Coppola*
...
### [8] [VeriGrey: Greybox Agent Validation](https://arxiv.org/abs/2603.17639)
...
### [9] [Facts as First Class Objects: Knowledge Objects for Persistent LLM Memory](https://arxiv.org/abs/2603.17781)
...
### [10] [Governed Memory: A Production Architecture for Multi-Agent Workflows](https://arxiv.org/abs/2603.17787)
*Hamed Taheri*
...
### [11] [AgentFactory: A Self-Evolving Framework Through Executable Subagent Accumulation and Reuse](https://arxiv.org/abs/2603.18000)
...
### [12] [Gaussian Process Limit Reveals Structural Benefits of Graph Transformers](https://arxiv.org/abs/2603.17569)
...
### [13] [A Noise Sensitivity Exponent Controls Large Statistical-to-Computational Gaps in Single- and Multi-Index Models](https://arxiv.org/abs/2603.17896)
...
### [14] [Multi-Agent Reinforcement Learning for Dynamic Pricing: Balancing Profitability,Stability and Fairness](https://arxiv.org/abs/2603.16888)
...
### [15] [From Language to Action in Arabic: Reliable Structured Tool Calling via Data-Centric Fine-Tuning](https://arxiv.org/abs/2603.16901)
...
### [16] [HoloByte: Continuous Hyperspherical Distillation for Tokenizer-Free Modeling](https://arxiv.org/abs/2603.16917)
*Vladimer Khasia*
...
### [17] [MHPO: Modulated Hazard-aware Policy Optimization for Stable Reinforcement Learning](https://arxiv.org/abs/2603.16929)
...
### [18] [Minimum-Action Learning: Energy-Constrained Symbolic Model Selection for Physical Law Identification from Noisy Data](https://arxiv.org/abs/2603.16951)
*Martin G. Frasch*
...
### [22] [Classifier Pooling for Modern Ordinal Classification](https://arxiv.org/abs/2603.17278)
...
### [23] [Beyond Outliers: A Data-Free Layer-wise Mixed-Precision Quantization Approach Driven by Numerical and Structural Dual-Sensitivity](https://arxiv.org/abs/2603.17354)
...
### [24] [Efficient Exploration at Scale](https://arxiv.org/abs/2603.17378)
...
### [25] [The Phasor Transformer: Resolving Attention Bottlenecks on the Unit Circle](https://arxiv.org/abs/2603.17433)
*Dibakar Sigdel*
...
### [26] [TimeAPN: Adaptive Amplitude-Phase Non-Stationarity Normalization for Time Series Forecasting](https://arxiv.org/abs/2603.17436)
...
### [27] [Baguan-TS: A Sequence-Native In-Context Learning Model for Time Series Forecasting with Covariates](https://arxiv.org/abs/2603.17439)
...
### [28] [Auto-Unrolled Proximal Gradient Descent: An AutoML Approach to Interpretable Waveform Optimization](https://arxiv.org/abs/2603.17478)
*Ahmet Kaplan*
...
### [29] [QuantFL: Sustainable Federated Learning for Edge IoT via Pre-Trained Model Quantisation](https://arxiv.org/abs/2603.17507)
...
### [30] [Efficient Soft Actor-Critic with LLM-Based Action-Level Guidance for Continuous Control](https://arxiv.org/abs/2603.17468)
...
### [31] [AirDDE: Multifactor Neural Delay Differential Equations for Air Quality Forecasting](https://arxiv.org/abs/2603.17529)
...
### [32] [CLeAN: Continual Learning Adaptive Normalization in Dynamic Environments](https://arxiv.org/abs/2603.17548)
...
### [33] [Unsupervised Symbolic Anomaly Detection](https://arxiv.org/abs/2603.17575)
...
### [34] [Objective Mispricing Detection for Shortlisting Undervalued Football Players via Market Dynamics and News Signals](https://arxiv.org/abs/2603.17687)
...
### [35] [Conditional Inverse Learning of Time-Varying Reproduction Numbers Inference](https://arxiv.org/abs/2603.17549)
...
### [36] [Can Blindfolded LLMs Still Trade? An Anonymization-First Framework for Portfolio Optimization](https://arxiv.org/abs/2603.17692)
...
### [37] [Attention Sinks Induce Gradient Sinks](https://arxiv.org/abs/2603.17771)
...
### [38] [RangeAD: Fast On-Model Anomaly Detection](https://arxiv.org/abs/2603.17795)
...
### [39] [Dropout Robustness and Cognitive Profiling of Transformer Models via Stochastic Inference](https://arxiv.org/abs/2603.17811)
...
### [40] [End-to-end data-driven prediction of urban airflow and pollutant dispersion](https://arxiv.org/abs/2603.17606)
...
### [41] [CARE: Covariance-Aware and Rank-Enhanced Decomposition for Enabling Multi-Head Latent Attention](https://arxiv.org/abs/2603.17946)
...
### [43] [Predicting Trajectories of Long COVID in Adult Women: The Critical Role of Causal Disentanglement](https://arxiv.org/abs/2603.17722)
...
### [44] [Federated Distributional Reinforcement Learning with Distributional Critic Regularization](https://arxiv.org/abs/2603.17820)
...
### [45] [Discovering Decoupled Functional Modules in Large Language Models](https://arxiv.org/abs/2603.17823)
...
### [46] [RHYME-XT: A Neural Operator for Spatiotemporal Control Systems](https://arxiv.org/abs/2603.17867)
...
### [47] [Only relative ranks matter in weight-clustered large language models](https://arxiv.org/abs/2603.17917)
...
### [48] [Physical Layer Security for FAS-Aided Short-Packet Systems: A Variable Block-Correlation Approach](https://arxiv.org/abs/2603.17224)
...
### [49] [WiSLAT: A Simultaneous Device Localization and Target Tracking Method for Wi-Fi Systems](https://arxiv.org/abs/2603.17283)
...
### [50] [Near-Field NLOS Localization via Position-Unknown HRIS:From Self-Localization to Target Positioning](https://arxiv.org/abs/2603.17297)
...
### [51] [A Joint Graph-Cut Channel Estimation Method for Multi-user Holographic MIMO](https://arxiv.org/abs/2603.17369)
...
### [52] [Fully 3D-Printed Wideband Metasurface Folded Reflectarray Antenna](https://arxiv.org/abs/2603.17526)
...
### [53] [Hybrid Beamforming via Programmable Unitary RF Networks](https://arxiv.org/abs/2603.17616)
...
### [54] [Optimizing Antenna Coding for Pixel Antenna Empowered SISO-OFDM Systems](https://arxiv.org/abs/2603.17658)
...
### [55] [Fairness-Aware Beamforming for Polarimetric ISAC Systems with Polarization-Reconfigurable Antennas](https://arxiv.org/abs/2603.17762)
