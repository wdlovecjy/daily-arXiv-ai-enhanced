...
### [3] [Surprisal-Rényi Free Energy](https://arxiv.org/abs/2603.03405)
...
### [4] [Observationally Informed Adaptive Causal Experimental Design](https://arxiv.org/abs/2603.03785)
...
### [5] [Invariance-Based Dynamic Regret Minimization](https://arxiv.org/abs/2603.03843)
...
### [6] [Exploiting Subgradient Sparsity in Max-Plus Neural Networks](https://arxiv.org/abs/2603.04133)
...
### [7] [Stable and Steerable Sparse Autoencoders with Weight Regularization](https://arxiv.org/abs/2603.04198)
...
### [9] [AOI: Turning Failed Trajectories into Training Signals for Autonomous Cloud Diagnosis](https://arxiv.org/abs/2603.03378)
...
### [10] [Towards Improved Sentence Representations using Token Graphs](https://arxiv.org/abs/2603.03389)
...
### [11] [A Short Note on a Variant of the Squint Algorithm](https://arxiv.org/abs/2603.03409)
*Haipeng Luo*
...
### [12] [[Re] FairDICE: A Gap Between Theory And Practice](https://arxiv.org/abs/2603.03454)
...
### [13] [Half the Nonlinearity Is Wasted: Measuring and Reallocating the Transformer's MLP Budget](https://arxiv.org/abs/2603.03459)
*Peter Balogh*
...
### [14] [Graph Hopfield Networks: Energy-Based Node Classification with Associative Memory](https://arxiv.org/abs/2603.03464)
...
### [15] [When Small Variations Become Big Failures: Reliability Challenges in Compute-in-Memory Neural Accelerators](https://arxiv.org/abs/2603.03491)
...
### [17] [Extending Neural Operators: Robust Handling of Functions Beyond the Training Set](https://arxiv.org/abs/2603.03621)
...
### [18] [mlx-snn: Spiking Neural Networks on Apple Silicon via MLX](https://arxiv.org/abs/2603.03529)
*Jiahao Qin*
...
### [19] [PTOPOFL: Privacy-Preserving Personalised Federated Learning via Persistent Homology](https://arxiv.org/abs/2603.04323)
...
### [20] [Trade-offs in Ensembling, Merging and Routing Among Parameter-Efficient Experts](https://arxiv.org/abs/2603.03535)
...
### [21] [NuMuon: Nuclear-Norm-Constrained Muon for Compressible LLM Training](https://arxiv.org/abs/2603.03597)
...
### [22] [Why Are Linear RNNs More Parallelizable?](https://arxiv.org/abs/2603.03612)
...
### [23] [Freezing of Gait Prediction using Proactive Agent that Learns from Selected Experience and DDQN Algorithm](https://arxiv.org/abs/2603.03651)
...
### [24] [Graph Negative Feedback Bias Correction Framework for Adaptive Heterophily Modeling](https://arxiv.org/abs/2603.03662)
...
### [28] [Structure-Aware Distributed Backdoor Attacks in Federated Learning](https://arxiv.org/abs/2603.03865)
...
### [29] [GIPO: Gaussian Importance Sampling Policy Optimization](https://arxiv.org/abs/2603.03955)
...
### [30] [TFWaveFormer: Temporal-Frequency Collaborative Multi-level Wavelet Transformer for Dynamic Link Prediction](https://arxiv.org/abs/2603.03963)
...
### [31] [Large-Margin Hyperdimensional Computing: A Learning-Theoretical Perspective](https://arxiv.org/abs/2603.03830)
...
### [32] [k-hop Fairness: Addressing Disparities in Graph Link Prediction Beyond First-Order Neighborhoods](https://arxiv.org/abs/2603.03867)
...
### [33] [Data-Aware Random Feature Kernel for Transformers](https://arxiv.org/abs/2603.04127)
...
### [34] [Unbiased Dynamic Pruning for Efficient Group-Based Policy Optimization](https://arxiv.org/abs/2603.04135)
...
### [35] [Noise-aware Client Selection for carbon-efficient Federated Learning via Gradient Norm Thresholding](https://arxiv.org/abs/2603.04194)
...
### [36] [Online Learning for Multi-Layer Hierarchical Inference under Partial and Policy-Dependent Feedback](https://arxiv.org/abs/2603.04247)
...
### [37] [Causality Elicitation from Large Language Models](https://arxiv.org/abs/2603.04276)
...
### [38] [Activation Outliers in Transformer Quantization: Reproduction, Statistical Analysis, and Deployment Tradeoffs](https://arxiv.org/abs/2603.04308)
...
### [39] [Specialization of softmax attention heads: insights from the high-dimensional single-location model](https://arxiv.org/abs/2603.03993)
...
### [40] [CRESTomics: Analyzing Carotid Plaques in the CREST-2 Trial with a New Additive Classification Model](https://arxiv.org/abs/2603.04309)
...
### [41] [What Does Flow Matching Bring To TD Learning?](https://arxiv.org/abs/2603.04333)
...
### [42] [On the Learnability of Offline Model-Based Optimization: A Ranking Perspective](https://arxiv.org/abs/2603.04000)
...
### [43] [Efficient Refusal Ablation in LLM through Optimal Transport](https://arxiv.org/abs/2603.04355)
...
### [44] [Dissecting Quantization Error: A Concentration-Alignment Perspective](https://arxiv.org/abs/2603.04359)
...
### [45] [mlx-vis: GPU-Accelerated Dimensionality Reduction and Visualization on Apple Silicon](https://arxiv.org/abs/2603.04035)
*Han Xiao*
...
### [46] [Robustness of Agentic AI Systems via Adversarially-Aligned Jacobian Regularization](https://arxiv.org/abs/2603.04378)
...
### [47] [Tuning Just Enough: Lightweight Backdoor Attacks on Multi-Encoder Diffusion Models](https://arxiv.org/abs/2603.04064)
...
### [49] [A Multi-Agent Framework for Interpreting Multivariate Physiological Time Series](https://arxiv.org/abs/2603.04142)
...
### [50] [REDNET-ML: A Multi-Sensor Machine Learning Pipeline for Harmful Algal Bloom Risk Detection Along the Omani Coast](https://arxiv.org/abs/2603.04181)
*Ameer Alhashemi*
...
### [53] [Accurate and Efficient Hybrid-Ensemble Atmospheric Data Assimilation in Latent Space with Uncertainty Quantification](https://arxiv.org/abs/2603.04395)
...
### [54] [Enhancing Mortality Forecasting with Ensemble Learning: A Shapley-Based Approach](https://arxiv.org/abs/2603.03789)
...
### [55] [State-dependent marginal emission factors with autoregressive components](https://arxiv.org/abs/2603.04260)
...
### [56] [Probabilistic Occupancy Grid for Radio-Based SLAM](https://arxiv.org/abs/2603.03559)
...
### [57] [Non-Orthogonal HARQ-CC over SDR: A GNU Radio-Based Implementation](https://arxiv.org/abs/2603.03746)
...
### [58] [Transmit Pinching-Antenna Systems (T-PASS): Connecting Wired to Wireless Communications](https://arxiv.org/abs/2603.03809)
...
### [59] [Constellation Selection and Power Control for OFDM-based ISAC: From Theory to Prototype](https://arxiv.org/abs/2603.03895)
...
### [60] [Low-Altitude Agentic Networks for Optical Wireless Communication and Sensing: An Oceanic Scenario](https://arxiv.org/abs/2603.04042)
...
### [61] [Physics Informed Deep Unfolded Full Waveform Inversion for Edema Detection](https://arxiv.org/abs/2603.04070)
...
### [62] [A Digital Twin of the FPGA Digital Signal Processing Chain for MKIDs Readout: Root-Cause Analysis and Mitigation of Spurs](https://arxiv.org/abs/2603.04087)
...
### [63] [Unseen Cost of Space Computing: Quantifying LEO Battery Aging via Physics-Driven Modeling](https://arxiv.org/abs/2603.04372)
...
### [64] [Asymmetric Goal Drift in Coding Agents Under Value Conflict](https://arxiv.org/abs/2603.03456)
...
### [65] [Build, Judge, Optimize: A Blueprint for Continuous Improvement of Multi-Agent Consumer Assistants](https://arxiv.org/abs/2603.03565)
...
### [66] [AI4S-SDS: A Neuro-Symbolic Solvent Design System via Sparse MCTS and Differentiable Physics Alignment](https://arxiv.org/abs/2603.03686)
*Jiangyu Chen*
...
### [67] [A Rubric-Supervised Critic from Sparse Real-World Outcomes](https://arxiv.org/abs/2603.03800)
...
### [68] [Phi-4-reasoning-vision-15B Technical Report](https://arxiv.org/abs/2603.03975)
...
### [69] [$τ$-Knowledge: Evaluating Conversational Agents over Unstructured Knowledge](https://arxiv.org/abs/2603.04370)
...
### [70] [A Dual-Helix Governance Approach Towards Reliable Agentic AI for WebGIS Development](https://arxiv.org/abs/2603.04390)
