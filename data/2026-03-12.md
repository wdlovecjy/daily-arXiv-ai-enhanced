...
### [6] [FAME: Formal Abstract Minimal Explanation for Neural Networks](https://arxiv.org/abs/2603.10661)
...
### [8] [Nurture-First Agent Development: Building Domain-Expert AI Agents Through Conversational Knowledge Crystallization](https://arxiv.org/abs/2603.10808)
*Linghao Zhang*
...
### [9] [Bayesian Hierarchical Models and the Maximum Entropy Principle](https://arxiv.org/abs/2603.10252)
*Brendon J. Brewer*
...
### [10] [MultiwayPAM: Multiway Partitioning Around Medoids for LLM-as-a-Judge Score Analysis](https://arxiv.org/abs/2603.10287)
...
### [11] [On The Complexity of Best-Arm Identification in Non-Stationary Linear Bandits](https://arxiv.org/abs/2603.10346)
...
### [12] [Adaptive Active Learning for Regression via Reinforcement Learning](https://arxiv.org/abs/2603.10435)
...
### [13] [Kernel Tests of Equivalence](https://arxiv.org/abs/2603.10886)
*Xing Liu,Axel Gandy*
...
### [14] [Bayesian Optimization with Gaussian Processes to Accelerate Stationary Point Searches](https://arxiv.org/abs/2603.10992)
*Rohit Goswami*
...
### [15] [In-Situ Timing Diagnosis of PDN and Configuration-Upset-Induced Routing Delay Degradation in SRAM-based FPGAs](https://arxiv.org/abs/2603.10222)
*Mostafa Darvishi*
...
### [16] [Spyglass: Directional Spectrum Sensing with Single-shot AoA Estimation and Virtual Arrays](https://arxiv.org/abs/2603.10421)
...
### [17] [Path Planning for Sound Speed Profile Estimation](https://arxiv.org/abs/2603.10585)
...
### [18] [Flexible Multi-Target Angular Emulation for Over-the-Air Testing of Large-Scale ISAC Base Stations: Principle and Experimental Verification](https://arxiv.org/abs/2603.10629)
...
### [19] [Human Presence Detection via Wi-Fi Range-Filtered Doppler Spectrum on Commodity Laptops](https://arxiv.org/abs/2603.10845)
...
### [20] [Phase Selection and Analysis for Multi-frequency Multi-user RIS Systems Employing Subsurfaces](https://arxiv.org/abs/2603.10901)
...
### [21] [Distortion Is Not Noise: On the Limits of the Kappa Model for Monostatic ISAC](https://arxiv.org/abs/2603.10958)
...
### [23] [Cluster-Aware Attention-Based Deep Reinforcement Learning for Pickup and Delivery Problems](https://arxiv.org/abs/2603.10053)
...
### [24] [Rethinking Adam for Time Series Forecasting: A Simple Heuristic to Improve Optimization under Distribution Shifts](https://arxiv.org/abs/2603.10095)
...
### [25] [HTMuon: Improving Muon via Heavy-Tailed Spectral Correction](https://arxiv.org/abs/2603.10067)
...
### [26] [Designing Service Systems from Textual Evidence](https://arxiv.org/abs/2603.10400)
...
### [27] [Improving Search Agent with One Line of Code](https://arxiv.org/abs/2603.10069)
...
### [28] [Dissecting Chronos: Sparse Autoencoders Reveal Causal Feature Hierarchies in Time Series Foundation Models](https://arxiv.org/abs/2603.10071)
*Anurag Mishra*
...
### [29] [Beyond Accuracy: Reliability and Uncertainty Estimation in Convolutional Neural Networks](https://arxiv.org/abs/2603.10731)
...
### [31] [Large Spikes in Stochastic Gradient Descent: A Large-Deviations View](https://arxiv.org/abs/2603.10079)
...
### [32] [Digging Deeper: Learning Multi-Level Concept Hierarchies](https://arxiv.org/abs/2603.10084)
...
### [33] [Prioritizing Gradient Sign Over Modulus: An Importance-Aware Framework for Wireless Federated Learning](https://arxiv.org/abs/2603.10763)
...
### [34] [Hardware Efficient Approximate Convolution with Tunable Error Tolerance for CNNs](https://arxiv.org/abs/2603.10100)
...
### [35] [Lost in the Middle at Birth: An Exact Theory of Transformer Position Bias](https://arxiv.org/abs/2603.10123)
*Borun D Chowdhury*
...
### [36] [Mashup Learning: Faster Finetuning by Remixing Past Checkpoints](https://arxiv.org/abs/2603.10156)
...
### [37] [ReMix: Reinforcement routing for mixtures of LoRAs in LLM finetuning](https://arxiv.org/abs/2603.10160)
...
### [38] [Estimating condition number with Graph Neural Networks](https://arxiv.org/abs/2603.10277)
...
### [39] [Causal Concept Graphs in LLM Latent Space for Stepwise Reasoning](https://arxiv.org/abs/2603.10377)
...
### [40] [GaLoRA: Parameter-Efficient Graph-Aware LLMs for Node Classification](https://arxiv.org/abs/2603.10298)
...
### [42] [Data-Driven Integration Kernels for Interpretable Nonlocal Operator Learning](https://arxiv.org/abs/2603.10305)
...
### [43] [Domain-Adaptive Health Indicator Learning with Degradation-Stage Synchronized Sampling and Cross-Domain Autoencoder](https://arxiv.org/abs/2603.10430)
...
### [44] [The Curse and Blessing of Mean Bias in FP4-Quantized LLM Training](https://arxiv.org/abs/2603.10444)
...
### [45] [UAV-MARL: Multi-Agent Reinforcement Learning for Time-Critical and Dynamic Medical Supply Delivery](https://arxiv.org/abs/2603.10528)
...
### [47] [World Model for Battery Degradation Prediction Under Non-Stationary Aging](https://arxiv.org/abs/2603.10527)
...
### [48] [Safe RLHF Beyond Expectation: Stochastic Dominance for Universal Spectral Risk Control](https://arxiv.org/abs/2603.10938)
...
### [49] [Neural Field Thermal Tomography: A Differentiable Physics Framework for Non-Destructive Evaluation](https://arxiv.org/abs/2603.11045)
...
### [50] [Learning to Score: Tuning Cluster Schedulers through Reinforcement Learning](https://arxiv.org/abs/2603.10545)
...
### [51] [A Bipartite Graph Approach to U.S.-China Cross-Market Return Forecasting](https://arxiv.org/abs/2603.10559)
...
### [54] [Spatio-Temporal Attention Graph Neural Network: Explaining Causalities With Attention](https://arxiv.org/abs/2603.10676)
...
### [55] [Dynamics-Informed Deep Learning for Predicting Extreme Events](https://arxiv.org/abs/2603.10777)
...
### [56] [Evaluating randomized smoothing as a defense against adversarial attacks in trajectory prediction](https://arxiv.org/abs/2603.10821)
...
### [57] [6ABOS: An Open-Source Atmospheric Correction Framework for the EnMAP Hyperspectral Mission Based on 6S](https://arxiv.org/abs/2603.10856)
...
### [58] [Ranking Reasoning LLMs under Test-Time Scaling](https://arxiv.org/abs/2603.10960)
...
### [59] [Bio-Inspired Self-Supervised Learning for Wrist-worn IMU Signals](https://arxiv.org/abs/2603.10961)
...
### [60] [TOSSS: a CVE-based Software Security Benchmark for Large Language Models](https://arxiv.org/abs/2603.10969)
...
### [61] [Federated Learning-driven Beam Management in LEO 6G Non-Terrestrial Networks](https://arxiv.org/abs/2603.10983)
...
### [62] [The Discrete Charm of the MLP: Binary Routing of Continuous Signals in Transformer Feed-Forward Layers](https://arxiv.org/abs/2603.10985)
*Peter Balogh*
...
### [63] [MCMC Informed Neural Emulators for Uncertainty Quantification in Dynamical Systems](https://arxiv.org/abs/2603.10987)
...
### [64] [Cross-Species Transfer Learning for Electrophysiology-to-Transcriptomics Mapping in Cortical GABAergic Interneurons](https://arxiv.org/abs/2603.11000)
...
### [65] [Leech Lattice Vector Quantization for Efficient LLM Compression](https://arxiv.org/abs/2603.11021)
