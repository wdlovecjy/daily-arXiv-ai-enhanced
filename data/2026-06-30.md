...
### [1] [Hybrid AI-Physics Framework for Post-Earthquake Structural Damage Diagnosis with Sparse Sensing](https://arxiv.org/abs/2606.28605)
*Xiao Liang*
...
### [2] [Cross-channel Specific Emitter Identification and Verification via Signal Envelope](https://arxiv.org/abs/2606.28801)
...
### [3] [A Survey of Physical-layer Authentication Enhanced by Emerging Spatial Domain Technologies](https://arxiv.org/abs/2606.28807)
...
### [4] [PASS-Assisted RSMA under Imperfect SIC: Joint Antenna Activation and Resource Allocation](https://arxiv.org/abs/2606.28921)
...
### [5] [Communication-Centric RIS-Assisted ISAC: Signal Modeling and BER Analysis](https://arxiv.org/abs/2606.28924)
...
### [6] [Two-Dimensional Method-of-Moments Analysis of TMz and TEz Scattering from PEC Cylinders](https://arxiv.org/abs/2606.29000)
*Sabrina Saima*
...
### [7] [Neural Augmentation of MIMO-OFDM Receivers for Universal LLR Reconstruction](https://arxiv.org/abs/2606.29345)
...
### [8] [Fast Wireless Foundation Models with Early-Exits](https://arxiv.org/abs/2606.29640)
...
### [9] [Effective Depth in Joint Source-Channel Coding: An Implicit Equilibrium Analysis](https://arxiv.org/abs/2606.29737)
...
### [10] [Joint Outage Detection and Compensation for Self-Healing 5G RAN via Deep Reinforcement Learning](https://arxiv.org/abs/2606.30031)
*Sajjad Hussain*
...
### [11] [GPU-Accelerated Real-Time Software Defined Radio-Based Orthogonal Time Frequency Space Network-Coded Cooperation System: Hardware Implementation](https://arxiv.org/abs/2606.30565)
...
### [12] [On the Necessity of a Liquid Substrate for Mesh Intelligence](https://arxiv.org/abs/2606.28413)
*Hongwei Xu*
...
### [15] [Singular Learning and Occam's Razor in Deep Monomial Networks](https://arxiv.org/abs/2606.28464)
...
### [17] [NIVA: A Multimodal Foundation Model for Actionable Earth System Intelligence](https://arxiv.org/abs/2606.28546)
...
### [18] [Improving Coherence in Hierarchical Time Series Forecasting using Structured Temporal Fusion](https://arxiv.org/abs/2606.28553)
*Ruchi Pakhle*
...
### [19] [Replica Symmetry Breaking and Algorithmic Thresholds in Empirical Risk Minimization under Multi-Index Model](https://arxiv.org/abs/2606.28573)
...
### [22] [Hybrid Active-Online Learning Framework for Label-Efficient Concept Drift Adaptation in Optical Network Failure Detection](https://arxiv.org/abs/2606.30322)
...
### [23] [Dead-Direction Conditioners: Gauge-Equivariant Preconditioning for Deep Networks](https://arxiv.org/abs/2606.29176)
...
### [24] [Entropy-Regularized Reinforcement Learning for Linear-Quadratic Stackelberg Differential Games in Regime-Switching Diffusion Models](https://arxiv.org/abs/2606.28671)
...
### [25] [Bayesian Best-Arm Identification with Abstention: A Polynomial-to-Exponential Phase Transition](https://arxiv.org/abs/2606.29203)
...
### [26] [A Mathematical Optimization Approach for Expert-Informed Bayesian Best Subset Selection](https://arxiv.org/abs/2606.29516)
...
### [27] [Hierarchical Decision Making with Structured Policies: A Principled Design via Inverse Optimization](https://arxiv.org/abs/2606.28764)
...
### [28] [Not All Objectives Are Born Equal: Priority-Constrained Descent for Hierarchical Multi-Objective Optimization](https://arxiv.org/abs/2606.29521)
...
### [29] [Optimizer Memory Makes Shuffle Order a First-Order Source of Fine-Tuning Noise](https://arxiv.org/abs/2606.29554)
*John Sweeney*
...
### [31] [How AI settled the complexity of the oldest SGD algorithm](https://arxiv.org/abs/2606.29593)
...
### [32] [What Drives the Inlier-Memorization Effect? A Theory of Outlier Detection via Early Training Dynamics](https://arxiv.org/abs/2606.29791)
...
### [33] [Decision-Value Attribution in Predict-then-Optimize Systems](https://arxiv.org/abs/2606.29878)
...
### [35] [When Is a Draft Accepted? A Theory of Acceptance in Speculative Decoding](https://arxiv.org/abs/2606.30265)
*Aaryam Sharma*
...
### [36] [ITSPACE: Monotone Gaussian Optimal Transport Updates](https://arxiv.org/abs/2606.30523)
...
### [38] [Multi-Agent Routing as Set-Valued Prediction: A WildChat Benchmark and Cost-Aware Evaluation](https://arxiv.org/abs/2606.28925)
...
### [39] [DLR: Zero-Inference-Cost Latent Residuals for Low-Rank Pre-Training](https://arxiv.org/abs/2606.28932)
...
### [40] [Modification-Considering Value Learning for Reward Hacking Mitigation in RL](https://arxiv.org/abs/2606.28955)
...
### [41] [Statistically Indistinguishable, Operationally Distinct: A Formal Barrier for Tabular Foundation Models](https://arxiv.org/abs/2606.29091)
...
### [42] [How Token Influence Decays with Distance: A Green-Function View of Trained Language Models](https://arxiv.org/abs/2606.29139)
...
### [43] [On the Nonlinearity of Learning Rate Scaling for LLM Training](https://arxiv.org/abs/2606.29158)
...
### [44] [Invariant Reasoning Directions in Latent Trajectories of Language Models](https://arxiv.org/abs/2606.29164)
...
### [45] [Symbolic Mechanistic Data Attribution: Tracing Training Influence to Learned Behavioral Policies](https://arxiv.org/abs/2606.29171)
...
### [46] [Nonlinear mixture model motivated subspace clustering](https://arxiv.org/abs/2606.29261)
*Ivica Kopriva*
...
### [47] [SP-CACW: Convergence-Aware Client Weighting for Selfish Personalized Learning](https://arxiv.org/abs/2606.29322)
...
### [48] [AMR: Adaptive Modality Routing for Multimodal Polyglot Speaker Identification](https://arxiv.org/abs/2606.29335)
...
### [49] [Reliability, Faithfulness, and the Limits of Post-hoc Explanations of Opaque Scientific Models](https://arxiv.org/abs/2606.29346)
*Nick Oh,Helen Jin*
...
### [50] [Adaptive Financial Transformer with Regime-Gated Attention for Stock Return Prediction](https://arxiv.org/abs/2606.29347)
*Dishan Sarkar*
...
### [51] [Temporal Posed and Spontaneous Gesture Recognition from Electromyography in the Rock-Paper-Scissors Game](https://arxiv.org/abs/2606.29423)
...
### [52] [Randomized neural operator for parametric PDEs with fast training and conformal uncertainty quantification](https://arxiv.org/abs/2606.29440)
...
### [53] [CRAFT: Counterfactual Credit Assignment from Free Sibling Rollouts for Self-Distilled Agentic Reinforcement Learning](https://arxiv.org/abs/2606.29476)
...
### [54] [Reinforcement Learning in Super Mario Bros: Curriculum, Pedagogy, and Optimal Level Design in World 1-1](https://arxiv.org/abs/2606.29511)
...
### [55] [Speculative Pre-Positioning: Decoding Stateful Sessions to the Next Decision Point Off the Critical Path](https://arxiv.org/abs/2606.29565)
*Victor Norgren*
...
### [56] [The Joint Effect of Quantization and Sampling Temperature on LLM Safety Alignment: A Factorial Analysis](https://arxiv.org/abs/2606.29581)
...
### [57] [STEMGym: Benchmarking Sequential Decision-Making under Dose Budgets in Autonomous Electron Microscopy](https://arxiv.org/abs/2606.29592)
...
### [58] [t-STEP: An interpretable model for Total Electron Content predictions and irregularities estimations](https://arxiv.org/abs/2606.29644)
...
### [59] [Fuzzing Large Language Models to Elicit Hidden Behaviours](https://arxiv.org/abs/2606.29646)
...
### [60] [Learning as Observable Matrix Dynamics: Diffusive Relaxations versus Phase Transitions](https://arxiv.org/abs/2606.29679)
*Igor Halperin*
...
### [61] [CAREBench: A Child-Safety Risk Benchmark for Language Models](https://arxiv.org/abs/2606.29685)
...
### [62] [IG-Lens: Exact Additive Probability Attribution Across Transformer Layers via Telescoping Integrated Gradients](https://arxiv.org/abs/2606.29693)
*Duc Anh Nguyen*
...
### [63] [A Diagnostic Framework and Multi-Evaluator Audit of Evaluator-Driven Preference Dynamics in Self-Adapting LLM Agents](https://arxiv.org/abs/2606.29719)
*Liu Zewen*
...
### [64] [The Hidden Cost of Resampling: How Imbalance Correction Degrades Probability Calibration in Tree Ensembles](https://arxiv.org/abs/2606.29720)
*Zewen Liu*
...
### [65] [Redefining Maritime Anomaly Detection via Equation-Grounded Synthetic Anomalies](https://arxiv.org/abs/2606.29721)
...
### [66] [ScaleAware-JEPA: Latent Representation for Discovery in Multiscale Physical Fields](https://arxiv.org/abs/2606.29723)
*Guang-Xing Li*
...
### [67] [PS-PPO: Prefix-Sampling PPO for Critic-Free RLHF](https://arxiv.org/abs/2606.29758)
...
### [68] [GLIP: Graph and LLM Joint Pretraining for Graph-Level Tasks](https://arxiv.org/abs/2606.29773)
...
### [69] [MemLeak: Diagnosing Information Leaks in Multimodal Agent Memory](https://arxiv.org/abs/2606.29788)
...
### [70] [Accelerating Q-learning through Efficient Value-Sharing across Actions](https://arxiv.org/abs/2606.29806)
...
### [71] [The Forgetting-Retention Dilemma: Certified Unlearning Theory in Continual Learning](https://arxiv.org/abs/2606.29832)
...
### [72] [Theory of Continual Learning Against Data Poisoning Attacks](https://arxiv.org/abs/2606.29841)
...
### [73] [Comparing Chatbot Performance Enhanced with Persistent Homology](https://arxiv.org/abs/2606.29857)
...
### [74] [RoAd-RL: A Unified Library and Benchmark for Robust Adversarial Reinforcement Learning](https://arxiv.org/abs/2606.29867)
...
### [75] [Golden Hour Divide: Trauma Care Accessibility and Resource Vulnerability in Sri Lanka](https://arxiv.org/abs/2606.29889)
...
### [76] [EVAF: A Test-Retest Protocol for Selective Parametric Consolidation](https://arxiv.org/abs/2606.29916)
*Haoliang Han*
...
### [77] [Bandwidth Selection in Kernel Density Estimation for Model Calibration](https://arxiv.org/abs/2606.29925)
...
### [78] [Exploiting Local Flatness for Efficient Out-of-Distribution Detection](https://arxiv.org/abs/2606.29952)
...
### [79] [T3R: Deeper Test-Time Adaptation for Graph Neural Networks via Gradient Rotation](https://arxiv.org/abs/2606.30011)
...
### [80] [Heads, Not Backbones: Output Heads Dominate Architectures on Fat-Tailed Returns](https://arxiv.org/abs/2606.30037)
...
### [81] [Predictive Objectives Discard Exogenous Control-Relevant Features: A Controlled Mechanistic Study](https://arxiv.org/abs/2606.30068)
*Ayan Pendharkar*
...
### [82] [Online Data Selection for Instruction Tuning via Gaussian Processes](https://arxiv.org/abs/2606.30077)
...
### [83] [Robust Strategic Classification under Decision-Dependent Cost Uncertainty](https://arxiv.org/abs/2606.30136)
...
### [84] [DreamForge-World 0.1 Preview: A Low-Compute Real-Time Controllable World Model](https://arxiv.org/abs/2606.30292)
...
### [85] [Toward an Energy-Optimized Operation of Data Centers Located in Wind Farms Using Reinforcement Learning](https://arxiv.org/abs/2606.30316)
...
### [86] [DRIFT: Difficulty Routing Self-DIstillation with Rhythm-Gated Exploration and Success BuFfer Training](https://arxiv.org/abs/2606.30345)
...
### [87] [On the Vulnerability of Parameter-Level Defenses to Model Merging](https://arxiv.org/abs/2606.30360)
...
### [88] [Predict, Reuse, and Repair: Accelerating Dynamic Sparse Attention for Long-Context LLM Decoding](https://arxiv.org/abs/2606.30389)
...
### [89] [Experience Augmented Policy Optimization for LLM Reasoning](https://arxiv.org/abs/2606.30420)
...
### [90] [Proofs of Ownership for Machine Learning Models](https://arxiv.org/abs/2606.30423)
...
### [91] [Transformer Architectures as Complete Bayes Processes: A Formal Proof in the Measure-Theoretic Kernel Framework](https://arxiv.org/abs/2606.30440)
*Haobo Yang*
...
### [92] [TraceLab: Characterizing Coding Agent Workloads for LLM Serving](https://arxiv.org/abs/2606.30560)
...
### [93] [Discovering Collaboration from Novelty: Random Network Distillation for Clustered Federated Learning](https://arxiv.org/abs/2606.30499)
...
### [94] [Attractor States Emerge in Multi-Turn LLM Conversations](https://arxiv.org/abs/2606.30571)
...
### [95] [SWE-INTERACT: Reimagining SWE Benchmarks as User-Driven Long-Horizon Coding Sessions](https://arxiv.org/abs/2606.30573)
...
### [96] [One-Step Gradient Delay is Not a Barrier for Large-Scale Asynchronous Pipeline Parallel LLM Pretraining](https://arxiv.org/abs/2606.30634)
...
### [97] [A Bayesian latent Gaussian process framework for aerodynamic uncertainty quantification](https://arxiv.org/abs/2606.28871)
...
### [98] [Connectivity Estimation using Stochastic Graph Heat Modelling](https://arxiv.org/abs/2606.29098)
...
### [99] [Gradient boosting with vector-valued leafs](https://arxiv.org/abs/2606.29326)
*David Cortes*
...
### [100] [Bidirectional Autoregressive Latent Diffusion for Forward and Inverse Magnetohydrodynamics](https://arxiv.org/abs/2606.29620)
*Alexander Scheinker*
...
### [101] [Adjusted Wasserstein distances for bridging empirical and true distributions with applications to MDS](https://arxiv.org/abs/2606.29665)
...
### [102] [Highly Data Parallelizable Estimation of the Sliced-Wasserstein Distance Using Cumulative Distribution Functions](https://arxiv.org/abs/2606.30310)
...
### [103] [Extrapolating from Regularised Solutions for Solving Ill-Conditioned Linear Systems in Machine Learning](https://arxiv.org/abs/2606.30328)
...
### [104] [SGD Provably Prioritizes a Shortcut Spurious Feature in the XOR Model](https://arxiv.org/abs/2606.30444)
...
### [106] [Bayesian Joint Estimation of the Hurst Parameter and Volatility with Applications to Fractional Option Pricing](https://arxiv.org/abs/2606.28522)
...
### [107] [Methods to address measurement error in both Outcome and Covariates](https://arxiv.org/abs/2606.28810)
...
### [108] [Critique of "Use of roster charts in the investigation and prosecution of nurses ..." by John O' Quigley](https://arxiv.org/abs/2606.29394)
*Richard D. Gill*
...
### [109] [Probing the Stochastic Machine: Engaging with LLMs in Statistics Curricula Through Veridical Data Science](https://arxiv.org/abs/2606.29754)
*Tian Zheng*
...
### [110] [Data and Evaluation Closed-Loop for Model Capability Enhancement](https://arxiv.org/abs/2606.28471)
...
### [111] [IMCBench: A benchmark for multimodal LLMs in Image-grounded Medical Conversations](https://arxiv.org/abs/2606.28556)
...
### [112] [Primary ICD Category Prediction using LLM-based Probing](https://arxiv.org/abs/2606.28798)
...
### [113] [BV-Blend: Uncertainty-Weighted Historical Baselines for Stable Critic-Free RL with Verifiable Rewards](https://arxiv.org/abs/2606.28707)
...
### [114] [TrajRS: Towards Certified Robustness in Pedestrian Trajectory Prediction](https://arxiv.org/abs/2606.28716)
...
### [115] [Agentic Abstention: Do Agents Know When to Stop Instead of Act?](https://arxiv.org/abs/2606.28733)
...
### [116] [Agent Safety Is Action Alignment](https://arxiv.org/abs/2606.28739)
*Shawn Li,Yue Zhao*
...
### [117] [Self-Supervised Theorem Discovery in a Formal Axiomatic System](https://arxiv.org/abs/2606.28747)
...
### [118] [HyphaeDB: A Living Knowledge Topology for Agent-First Memory](https://arxiv.org/abs/2606.28781)
*Krishna Halaharvi*
...
### [119] [Memory as an Attack Surface in LLM Agents: A Study on Multiple-Choice Question Answering](https://arxiv.org/abs/2606.29030)
...
### [120] [Low-cost concept-based localized explanations: How far can we get with training-free approaches?](https://arxiv.org/abs/2606.29069)
...
### [121] [Managing the Human Fallback: Skill Investment Under Improving AI and Worker Mobility](https://arxiv.org/abs/2606.29111)
...
### [122] [Characterizing Large Language Model Agentic Workflows: A Study on N8n Ecosystem](https://arxiv.org/abs/2606.29116)
...
### [123] [HiComm: Hierarchical Communication for Multi-agent Reinforcement Learning](https://arxiv.org/abs/2606.29126)
...
### [124] [Pooled Leaderboards Hide System-Specific Winners: A Reporting-Protocol Audit of Offline Root-Cause Analysis Benchmarks](https://arxiv.org/abs/2606.29159)
...
### [125] [Measuring Graph-to-Graph Semantic Similarity in Knowledge Graphs: An Empirical Evaluation of Knowledge Graph Embeddings](https://arxiv.org/abs/2606.29180)
...
### [126] [PolicyGuard: A Dialogue-Grounded Sub-Agent Verifier for Policy Adherence in LLM Agents](https://arxiv.org/abs/2606.29225)
...
### [127] [The Complexity Ceiling Benchmark: A Multi-Domain Evaluation of Sequential Reasoning Under Depth Scaling](https://arxiv.org/abs/2606.29278)
...
### [128] [LLM-Guided Planning for Multi-hop Reasoning over Multimodal Nuclear Regulatory Documents](https://arxiv.org/abs/2606.29399)
...
### [129] [Mixture of Debaters: Learn to Debate at Architectural Level in Multi-Agent Reasoning](https://arxiv.org/abs/2606.29425)
...
### [130] [Faults in Our Formal Benchmarking: Dataset Defects and Evaluation Failures in Lean Theorem Proving](https://arxiv.org/abs/2606.29493)
...
### [131] [Cognitive World Models for Process-Level Social Influence Evaluation](https://arxiv.org/abs/2606.29495)
...
### [132] [UCOB: Learning to Utilize and Evolve Agentic Skills via Credit-Aware On-Policy Bidirectional Self-Distillation](https://arxiv.org/abs/2606.29502)
...
### [133] [OSWorld2.0: Benchmarking Computer Use Agents on Long-Horizon Real-World Tasks](https://arxiv.org/abs/2606.29537)
...
### [134] [SCARCE: Scalable Cascade Analysis for Rare-event Characterisation via Embeddings](https://arxiv.org/abs/2606.29623)
...
### [135] [SFBench: The SciFy Scientific Feasibility Benchmark](https://arxiv.org/abs/2606.29630)
...
### [136] [Budgeted Act-or-Defer Multi-Agent LLM Deliberation with Local Reliability Bounds](https://arxiv.org/abs/2606.29654)
...
### [137] [Safety from Honesty in a Disinterested AI Predictor](https://arxiv.org/abs/2606.29657)
...
### [138] [Diversity is the Strength of the AI Crowd](https://arxiv.org/abs/2606.29661)
...
### [139] [Sample-Efficient Learning of Probabilistic Causes for Reachability in Markov Decision Processes with Probabilistic Guarantees](https://arxiv.org/abs/2606.29681)
...
### [140] [Toward Secure and Reliable PDDL Formalization of Large Language Models with Planner-in-the-Loop Feedback](https://arxiv.org/abs/2606.29700)
...
### [141] [DeepTrans Studio: Turning Expert Interventions into Shared Team Knowledge in Agentic Translation Workflows](https://arxiv.org/abs/2606.29727)
...
### [142] [CLQT: A Closed-Loop, Cost-Aware, Strategy-Consistent Benchmark for Diagnostic Evaluation of LLM Portfolio-Management Agents](https://arxiv.org/abs/2606.29771)
...
### [143] [The CRISTAL Method: Neurosymbolic analysis from AI-synthesized world models](https://arxiv.org/abs/2606.29799)
...
### [144] [Beyond Triplet Plausibility: Relation Set Completion in Knowledge Graphs](https://arxiv.org/abs/2606.29860)
...
### [145] [AI Training Manager: Bounded Closed-Loop Control of Adaptive Training Recipes](https://arxiv.org/abs/2606.29871)
...
### [146] [SafePyramid: A Hierarchical Benchmark for In-context Policy Guardrailing](https://arxiv.org/abs/2606.29887)
...
### [147] [A causal modeling perspective on decision theory](https://arxiv.org/abs/2606.29911)
*Arvid Sjölander*
...
### [148] [First-Order Temporal Logic Tensor Networks](https://arxiv.org/abs/2606.29972)
...
### [151] [Propagation of~Interval Belief Structures and~Imprecise Copulas for~Neural Network Verification](https://arxiv.org/abs/2606.30105)
...
### [152] [Structural Certification for Reliable Physical Design with Language Models](https://arxiv.org/abs/2606.30107)
...
### [153] [Open Problems in Constitutional Preference Reconstruction](https://arxiv.org/abs/2606.30116)
...
### [154] [MirrorCode: AI can rebuild entire programs from behavior alone](https://arxiv.org/abs/2606.30182)
...
### [155] [From Detecting Agency to Doing Work: Self-Caused Credit Builds a Durable Behavioral Self in a Minimal Spiking Agent](https://arxiv.org/abs/2606.30191)
*Haoliang Han*
...
### [156] [The Many-Body Problem of the Data Centre](https://arxiv.org/abs/2606.30206)
...
### [157] [BayesEvolve: Explicit Belief States for Autonomous Scientific Discovery](https://arxiv.org/abs/2606.30335)
...
### [158] [Using Large Language Models as Low-Cost Statistical Estimators for Human-Response Data](https://arxiv.org/abs/2606.30372)
*Haobo Yang*
...
### [159] [Whose Side Is Your Agent On? Multi-Party Principal Loyalty in LLM Agents](https://arxiv.org/abs/2606.30383)
*Bojie Li,Noah Shi*
...
### [160] [Entity Binding Failures in Tool-Augmented Agents](https://arxiv.org/abs/2606.30531)
...
### [161] [Latent Actions from Factorized Transition Effects under Agent Ambiguity](https://arxiv.org/abs/2606.30544)
...
### [162] [Linguistic Firewall: Geometry as Defense in Multi-Agent Systems Routing](https://arxiv.org/abs/2606.30555)
...
### [163] [The Human Creativity Benchmark](https://arxiv.org/abs/2606.30561)
...
### [164] [DOPD: Dual On-policy Distillation](https://arxiv.org/abs/2606.30626)
...
### [165] [Self-Evolving World Models for LLM Agent Planning](https://arxiv.org/abs/2606.30639)
